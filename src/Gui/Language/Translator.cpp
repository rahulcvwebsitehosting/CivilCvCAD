...
/** \defgroup i18n Internationalization with CivilCvCAD
 *  \ingroup GUI
 *
 * The internationalization of CivilCvCAD makes heavy use of the internationalization
 * support of Qt. For more details refer to your Qt documentation.
 *
 * \section stepbystep_language Step by step
 * To integrate a new language into CivilCvCAD or one of its application modules
 ...
 * The .qm file should now be integrated into the GUI library (either of CivilCvCAD
