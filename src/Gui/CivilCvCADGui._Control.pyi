...
"""Typed public method signatures for the ``CivilCvCADGui._Control`` PyCXX type."""

from __future__ import annotations

from collections.abc import Sequence

from CivilCvCADGui import Document, _TaskDialog

class _Control:
    """Global task-panel control surface for the CivilCvCAD GUI."""
