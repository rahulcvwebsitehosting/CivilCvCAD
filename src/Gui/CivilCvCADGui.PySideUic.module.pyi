...
"""Typed public signatures for the ``CivilCvCADGui.PySideUic`` helper module.

This source-adjacent stub file carries the PySide UI-loading convenience
helpers that CivilCvCAD exposes from the GUI layer.
"""
...
def createCustomWidget(
    ...
    """Create one CivilCvCAD custom widget by class name."""
    ...
