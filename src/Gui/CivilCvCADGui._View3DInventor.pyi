...
"""Typed public method signatures for the ``CivilCvCADGui._View3DInventor`` PyCXX type."""
...
from CivilCvCAD import DocumentObject, Placement, Rotation, Vector
from CivilCvCADGui import _MDIView, _View3DInventorViewer
...
class _View3DInventor:
    """Primary 3D Inventor view wrapper used by the CivilCvCAD GUI."""
