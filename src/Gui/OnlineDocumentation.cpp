...
{
    PyObject* module = PyImport_ImportModule("civilcvcad.civilcvcad_doc");
    if (!module) {
        throw Py::Exception();
    }
...
QByteArray PythonOnlineHelp::fileNotFound() const
{
    ...
    QString contentType = QStringLiteral(
        ...
        "<tr bgcolor=\"#7799ee\">"
        "<td valign=bottom>&nbsp;<br>"
        "<font color=\"#ffffff\" face=\"helvetica, arial\">&nbsp;<br><big><big><strong>CivilCvCAD "
...
QByteArray PythonOnlineHelp::loadFailed(const QString& error) const
{
    ...
    QString contentType
        = QStringLiteral(
              ...
              "arial\">&nbsp;<br><big><big><strong>CivilCvCAD "
              "Documentation</strong></big></big></font></td>"
              "<td align=right valign=bottom>"
              "<font color=\"#ffffff\" face=\"helvetica, arial\">&nbsp;</font></td></tr></table>"
              "<p><p>"
