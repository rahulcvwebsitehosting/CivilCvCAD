 ...
 * framework of CivilCvCAD within the framework provided by Qt. This class
 * extends QUiLoader by the creation of CivilCvCAD specific widgets.
 * @author Werner Mayer
 */
...
public:
     ...
     * interfere with CivilCvCAD's functionality. Only way to avoid such behaviour
     ...
     * construction.
     *
     * @see https://github.com/CivilCvCAD/CivilCvCAD/issues/8708
     */
