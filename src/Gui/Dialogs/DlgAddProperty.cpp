...
) const
{
    ...
    const App::Document* document = civilcvcad_cast<App::Document*>(container);
    const App::DocumentObject* object = civilcvcad_cast<App::DocumentObject*>(container);
    if (document) {
...
{
    addDocumentation();
    auto* object = civilcvcad_cast<App::DocumentObject*>(container);
    if (object) {
