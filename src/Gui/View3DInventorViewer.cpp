 ...
 * Therefore an overview and some remarks to the CivilCvCAD 3D viewing system.
 *
...
void View3DInventorViewer::init()
{
    ...
    // https://forum.civilcvcad.org/viewtopic.php?f=10&t=7486&start=120#p74398 and for
    // the fix and some details what happens behind the scene have a look at this
    // https://forum.civilcvcad.org/viewtopic.php?f=10&t=7486&p=74777#p74736
...
View3DInventorViewer::~View3DInventorViewer()
{
    ...
    // See https://forum.civilcvcad.org/viewtopic.php?f=3&t=39720
...
void View3DInventorViewer::setRenderCache(int mode)
{
    ...
    if (mode < 0) {
        ...
        // https://forum.civilcvcad.org/viewtopic.php?f=18&t=43305&start=10#p412537
...
void View3DInventorViewer::renderScene()
{
    ...
    // https://github.com/CivilCvCAD/CivilCvCAD/issues/8341
    // https://github.com/CivilCvCAD/CivilCvCAD/issues/6177
...
void View3DInventorViewer::viewObjects(const std::vector<App::SubObjectT>& objs, bool extend)
{
    ...
    for (auto& objT : objs) {
        auto vp = Base::civilcvcad_cast<ViewProviderDocumentObject*>(
...
void View3DInventorViewer::drawSingleBackground(const QColor& col)
{
    ...
    // See also: https://github.com/CivilCvCAD/CivilCvCAD/pull/9356#issuecomment-1529521654
    const SbViewportRegion vp = this->getSoRenderManager()->getViewportRegion();
    const SbVec2s size = vp.getViewportSizePixels();
    const int viewportWidth = size[0];
    const int viewportHeight = size[1];
