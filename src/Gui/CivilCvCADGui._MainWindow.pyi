...
"""Typed public method signatures for the ``CivilCvCADGui._MainWindow`` PyCXX type."""

from __future__ import annotations

from CivilCvCADGui import InputHint, _MDIView

class _MainWindow:
    """Wrapper around the CivilCvCAD main application window."""
