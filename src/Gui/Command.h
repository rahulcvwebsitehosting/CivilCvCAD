 ...
 * This lightweight class is the base class of all commands in CivilCvCAD. It represents the link
 * between the CivilCvCAD command framework and the QAction world of Qt.
 * @author Werner Mayer
 */
 ...
 * It contains also a lot of helper methods to make implementing commands for CivilCvCAD as easy as
 * possible.
 *
 ...
 *  This class manage all available commands in CivilCvCAD. All
