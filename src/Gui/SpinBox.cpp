    ...
    : spinbox(sb)
{
    ...
    // Set Margins
    // https://forum.civilcvcad.org/viewtopic.php?f=8&t=50615
...
void ExpressionSpinBox::showExpression(Number number)
{
    ...
    auto* value = civilcvcad_cast<NumberExpression*>(result.get());
...
void ExpressionSpinBox::openFormulaDialog()
{
    ...
    auto* qprop = civilcvcad_cast<PropertyQuantity*>(getPath().getProperty());
    Unit unit;
