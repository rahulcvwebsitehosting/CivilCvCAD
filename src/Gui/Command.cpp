...
/** \defgroup commands Command Framework
    \ingroup GUI
    \brief Structure for registering commands to the CivilCvCAD system
 * \section Overview
...
void Command::_invoke(int id, bool disablelog)
{
    try {
        ...
        e.reportException();
        // Pop-up a dialog for CivilCvCAD-specific exceptions
...
const char* Command::beginCmdHelp()
{
    return "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.0 Transitional//EN\">\n"
           ...
           "<title>CivilCvCAD Main Index</title>\n"
           "</head>\n"
           "<body bgcolor=\"#ffffff\">\n\n";
}
...
const char* Command::keySequenceToAccel(int sk) const
{
    ...
    // In case CivilCvCAD is loaded without GUI (issue 16407)
