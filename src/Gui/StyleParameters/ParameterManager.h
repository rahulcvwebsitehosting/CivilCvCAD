...
/**
 * @brief Built-in parameter source that reads from CivilCvCAD's parameter system.
 *
 * This source provides access to predefined parameters that are stored in
 * CivilCvCAD's global parameter system. These parameters are typically defined
