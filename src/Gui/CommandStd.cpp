    ...
    : Command("Std_RestartInSafeMode")
{
    ...
    sToolTipText = QT_TR_NOOP("Starts CivilCvCAD without any modules or plugins loaded");
...
void StdCmdRestartInSafeMode::activated(int iMsg)
{
    ...
    restartBox.setText(QObject::tr("Restart CivilCvCAD and enter safe mode?"));
    ...
    if (restartBox.exec() == QMessageBox::Yes) {
        // restart CivilCvCAD after a delay to give time to this dialog to close
        const int ms = 1000;
...
//===========================================================================
// Std_CivilCvCADDonation
//===========================================================================

DEF_STD_CMD(StdCmdCivilCvCADDonation)

StdCmdCivilCvCADDonation::StdCmdCivilCvCADDonation()
    : Command("Std_CivilCvCADDonation")
{
    sGroup = "Help";
    sMenuText = QT_TR_NOOP("Donate to CivilCvCA&D");
    sToolTipText = QT_TR_NOOP("Opens the CivilCvCAD donation page");
    sWhatsThis = "Std_CivilCvCADDonation";
    sStatusTip = sToolTipText;
    sPixmap = "internet-web-browser";
    eType = 0;
}

void StdCmdCivilCvCADDonation::activated(int iMsg)
{
    Q_UNUSED(iMsg);
}
    ...
    : Command("Std_DevHandbook")
{
    ...
    sToolTipText = QT_TR_NOOP("Opens the CivilCvCAD developers handbook");
...
//===========================================================================
// Std_CivilCvCADWebsite
//===========================================================================

DEF_STD_CMD(StdCmdCivilCvCADWebsite)

StdCmdCivilCvCADWebsite::StdCmdCivilCvCADWebsite()
    : Command("Std_CivilCvCADWebsite")
{
    sGroup = "Help";
    sMenuText = QT_TR_NOOP("CivilCvCAD W&ebsite");
    sToolTipText = QT_TR_NOOP("Navigates to the official CivilCvCAD website");
    sWhatsThis = "Std_CivilCvCADWebsite";
    sStatusTip = sToolTipText;
    sPixmap = "internet-web-browser";
    eType = 0;
}

void StdCmdCivilCvCADWebsite::activated(int iMsg)
{
    Q_UNUSED(iMsg);
}

//===========================================================================
// Std_CivilCvCADUserHub
//===========================================================================

DEF_STD_CMD(StdCmdCivilCvCADUserHub)

StdCmdCivilCvCADUserHub::StdCmdCivilCvCADUserHub()
    : Command("Std_CivilCvCADUserHub")
{
    sGroup = "Help";
    sMenuText = QT_TR_NOOP("&User Documentation");
    sToolTipText = QT_TR_NOOP("Opens the documentation for users");
    sWhatsThis = "Std_CivilCvCADUserHub";
    sStatusTip = sToolTipText;
    sPixmap = "internet-web-browser";
    eType = 0;
}

void StdCmdCivilCvCADUserHub::activated(int iMsg)
{
    Q_UNUSED(iMsg);
}
...
DEF_STD_CMD(StdCmdCivilCvCADForum)

StdCmdCivilCvCADForum::StdCmdCivilCvCADForum()
    : Command("Std_CivilCvCADForum")
{
    sGroup = "Help";
    sMenuText = QT_TR_NOOP("CivilCvCAD &Forum");
    sToolTipText = QT_TR_NOOP("Opens the CivilCvCAD forum to find help from other users");
    sWhatsThis = "Std_CivilCvCADForum";
    sStatusTip = sToolTipText;
    sPixmap = "internet-web-browser";
    eType = 0;
}

void StdCmdCivilCvCADForum::activated(int iMsg)
{
    Q_UNUSED(iMsg);
}
...
void StdCmdAnnotationLabel::activated(int)
{
    ...
    const auto* supportObj = civilcvcad_cast<App::DocumentObject*>(support);
    ...
    else if (auto* gf = civilcvcad_cast<App::GeoFeature*>(supportObj); supportObj && gf) {
    ...
    auto* label = civilcvcad_cast<App::AnnotationLabel*>(obj);
