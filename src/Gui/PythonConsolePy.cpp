...
void PythonStdout::init_type()
{
    ...
    behaviors().doc("Redirection of stdout to CivilCvCAD's Python console window");
...
void OutputStdout::init_type()
{
    ...
    behaviors().doc("Redirection of stdout to CivilCvCAD's report view");
    // you must have overwritten the virtual functions
    behaviors().supportRepr();
...
void PythonStdin::init_type()
{
    ...
    behaviors().doc("Redirection of stdin to CivilCvCAD to open an input dialog");
    // you must have overwritten the virtual functions
    behaviors().supportRepr();
    behaviors().supportGetattr();
