...
"""Typed public method signatures for the ``CivilCvCADGui._MDIView`` PyCXX type."""

from __future__ import annotations

from typing import Literal, TypeAlias, overload

from CivilCvCAD import DocumentObject
...
class _MDIView:
    """Base MDI view wrapper for CivilCvCAD GUI view types."""
