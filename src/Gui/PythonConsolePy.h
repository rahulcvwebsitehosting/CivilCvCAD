...
/**
 * Python class for redirection of stdout to CivilCvCAD's Python
...
/**
 * Python class for redirection of stderr to CivilCvCAD's Python
 * console window. This allows one to show all Python messages in
 * the same window where the commands are performed.
 * @see PythonStdout
 * @see PythonConsole
...
/**
 * Python class for redirection of stdout to CivilCvCAD's output
...
/**
 * Python class for redirection of stderr to CivilCvCAD's output
