 ...
 * CivilCvCAD distribution, or inside various installed mods.
 */
...
public:
     ...
     * a PreferencePack
     *
     * PreferencePacks can contain any parameters at all, but inside CivilCvCAD there is no
     ...
     * hidden from the users: CivilCvCAD behaves as though those values exist in the config file.
     *
     ...
     *
     * The base CivilCvCAD installation includes default templates in:
     ...
     * sets of core CivilCvCAD preferences.
     */
    struct TemplateFile
    {
