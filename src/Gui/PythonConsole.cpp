    ...
    , _sourceDrain(nullptr)
{
    ...
    // Don't override stdin when running CivilCvCAD as Python module
...
void PythonConsole::runSource(const QString& line)
{
    ...
    try {
        ...
        QMessageBox::critical(this, tr("Python Console"), tr("Unhandled CivilCvCAD exception."));
    }
...
void PythonConsole::insertFromMimeData(const QMimeData* source)
{
    ...
    // https://forum.civilcvcad.org/viewtopic.php?f=3&t=34618
