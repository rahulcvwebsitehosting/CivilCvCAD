//
//  ZipExtractor.swift
//  CivilCvCAD QuickLook Swift Implementation
//
//  Pure Swift ZIP parser for extracting thumbnails from CivilCvCAD (.FCStd) files
//  This removes external dependencies while maintaining modern Swift APIs
//
//  Created for integration with CivilCvCAD upstream
//
...
struct SwiftZIPParser {
    private static let logger = Logger(
        subsystem: Bundle.main.bundleIdentifier ?? "org.civilcvcad.quicklook",
