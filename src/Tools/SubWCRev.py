...
#
# CivilCvCAD RevInfo script to get the revision information from Subversion, Bazaar, and Git.
#
...
class DebianChangelog(VersionControl):
    def extractInfo(self, srcdir, bindir):
        ...
        self.url = "https://code.launchpad.net/~vcs-imports/civilcvcad/trunk"
        return True
...
class GitControl(VersionControl):
        ...
        for ref in self.branchlst:
            if "/" in ref:
                ...
                if remote in self.remotes:
                    ...
                    entryscore = (
                        url == "git://github.com/CivilCvCAD/CivilCvCAD.git",
    ...
    def extractInfo(self, srcdir, bindir):
        ...
        for fetchurl in (
            "git@github.com:CivilCvCAD/CivilCvCAD.git",
            "https://github.com/CivilCvCAD/CivilCvCAD.git",
        ):
