...
TYPE_CONTEXT_RULES = (
    TypeContextRule(
        ...
        internal_reason="startup sys.stdout sink; not exported from a CivilCvCAD module",
    ),
    TypeContextRule(
        source="src/Gui/PythonConsolePy.cpp",
        context_name="PythonStdout",
        internal_reason="Python console sys.stdout replacement; not exported from a CivilCvCAD module",
    ),
    TypeContextRule(
        source="src/Gui/PythonConsolePy.cpp",
        context_name="PythonStderr",
        internal_reason="Python console sys.stderr replacement; not exported from a CivilCvCAD module",
    ),
    TypeContextRule(
        source="src/Gui/PythonConsolePy.cpp",
        context_name="OutputStdout",
        internal_reason="report view sys.stdout replacement; not exported from a CivilCvCAD module",
    ),
    TypeContextRule(
        source="src/Gui/PythonConsolePy.cpp",
        context_name="OutputStderr",
        internal_reason="report view sys.stderr replacement; not exported from a CivilCvCAD module",
    ),
    TypeContextRule(
        source="src/Gui/PythonConsolePy.cpp",
        context_name="PythonStdin",
        internal_reason="Python console sys.stdin replacement; not exported from a CivilCvCAD module",
    ),
    TypeContextRule(
        source="src/Base/ParameterPy.cpp",
        context_name="ParameterGrp",
        public_targets=(PublicTypeTarget("CivilCvCAD", "ParameterGrp"),),
    ),
    TypeContextRule(
        source="src/Gui/MainWindowPy.cpp",
        context_name="MainWindowPy",
        public_targets=(PublicTypeTarget("CivilCvCADGui", "_MainWindow"),),
    ),
    TypeContextRule(
        source="src/Gui/MDIViewPy.cpp",
        context_name="MDIViewPy",
        public_targets=(PublicTypeTarget("CivilCvCADGui", "_MDIView"),),
    ),
    TypeContextRule(
        source="src/Gui/SplitView3DInventor.cpp",
        context_name="AbstractSplitViewPy",
        public_targets=(PublicTypeTarget("CivilCvCADGui", "_AbstractSplitView"),),
    ),
    TypeContextRule(
        source="src/Gui/TaskView/TaskDialogPython.cpp",
        context_name="Control",
        public_targets=(PublicTypeTarget("CivilCvCADGui", "_Control", "Control"),),
    ),
    TypeContextRule(
        source="src/Gui/TaskView/TaskDialogPython.cpp",
        context_name="TaskDialog",
        public_targets=(PublicTypeTarget("CivilCvCADGui", "_TaskDialog"),),
    ),
    TypeContextRule(
        source="src/Gui/View3DPy.cpp",
        context_name="View3DInventorPy",
        public_targets=(PublicTypeTarget("CivilCvCADGui", "_View3DInventor"),),
    ),
    TypeContextRule(
        source="src/Gui/View3DViewerPy.cpp",
        context_name="View3DInventorViewerPy",
        public_targets=(PublicTypeTarget("CivilCvCADGui", "_View3DInventorViewer"),),
    ),
    TypeContextRule(
        source="src/Gui/WidgetFactory.cpp",
        context_name="PyResource",
        public_targets=(PublicTypeTarget("CivilCvCADGui", "_PyResource"),),
    ),
    TypeContextRule(
