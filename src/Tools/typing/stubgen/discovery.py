...
creation code, then maps those findings onto the public CivilCvCAD Python module
...
KNOWN_PYMETHODDEF_MODULE_HINTS: dict[tuple[str, str], str] = {
    ("src/App/ApplicationPy.cpp", "ApplicationPy::Methods"): "CivilCvCAD",
    ("src/Base/Console.cpp", "ConsoleSingleton::Methods"): "CivilCvCAD.Console",
    ("src/Base/UnitsApiPy.cpp", "UnitsApi::Methods"): "CivilCvCAD.Units",
    ("src/Gui/ApplicationPy.cpp", "ApplicationPy::Methods"): "CivilCvCADGui",
    ("src/Gui/Selection/Selection.cpp", "SelectionSingleton::Methods"): "CivilCvCADGui.Selection",
    ("src/Main/CivilCvCADGuiPy.cpp", "CivilCvCADGui_methods"): "CivilCvCADGui",
    ("src/Gui/Application.cpp", "CivilCvCADGui_methods"): "CivilCvCADGui",
    (
...
KNOWN_PYCXX_MODULE_HINTS: dict[tuple[str, str], str] = {
    ("src/Base/Translate.cpp", "__Translate__"): "CivilCvCAD.Qt",
    ("src/Gui/UiLoader.cpp", "PySideUic"): "CivilCvCADGui.PySideUic",
