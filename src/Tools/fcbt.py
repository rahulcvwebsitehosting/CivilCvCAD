...
possible commands are:
 ...
 - CreateModule    (CM)   Insert a new CivilCvCAD Module in the module directory
 - CreatePyModule  (CP)   Insert a new CivilCvCAD Python Module in the module directory
