...
class @self.export.Namespace.replace("::", "_")@Export @self.export.Name@ModulePy
{
public:
+ if self.export.Runtime == "ExtensionModule":
...
// has to be implemented in a source-owned @self.export.Name@ModulePyImp.cpp translation unit
