...
const auto sBanner = fmt::format(
    "(C) 2001-{} CivilCvCAD contributors\n"
    "CivilCvCAD is free and open-source software licensed under the terms of LGPL2+ license.\n\n",
    FCCopyrightYear
);
...
int main(int argc, char** argv)
{
    ...
    // See https://github.com/CivilCvCAD/CivilCvCAD/issues/16724

    // Make sure to setup the Qt locale system before setting LANG and LC_ALL to C.
    // which is needed to use the system locale settings.
    (void)QLocale::system();
    // See https://forum.civilcvcad.org/viewtopic.php?f=18&t=20600
...
#else
    _putenv("PYTHONPATH=");
    // https://forum.civilcvcad.org/viewtopic.php?f=4&t=18288
    // https://forum.civilcvcad.org/viewtopic.php?f=3&t=20515
    ...
    // see https://forum.civilcvcad.org/viewtopic.php?p=485142#p485016
    ...
    App::Application::Config()["DesktopFileName"] = "org.civilcvcad.CivilCvCAD";
