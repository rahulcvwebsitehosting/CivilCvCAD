...
public:
     ...
     *
     * This mechanism is very useful to have an own sequencer for each layer of CivilCvCAD.
     * For example, if CivilCvCAD is running in server mode you have/need no GUI layer
     * and therewith no (graphical) progress bar; in this case ConsoleSequencer is taken.
     * But in cases CivilCvCAD is running with GUI the @ref Gui::ProgressBar is taken instead.
     * @see Sequencer
     */
 ...
 *
 * This class has been introduced to simplify the use with the sequencer. In the CivilCvCAD Gui layer
