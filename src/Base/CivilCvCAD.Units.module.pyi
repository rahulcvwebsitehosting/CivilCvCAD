...
"""Typed public signatures for the ``CivilCvCAD.Units`` helper module.
...
from CivilCvCAD.Base import Quantity
...
def parseQuantity(expression: str, /) -> Quantity:
    ...
    compound unit expression that CivilCvCAD's quantity parser understands.
    """
    ...
