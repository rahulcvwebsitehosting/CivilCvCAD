 ...
 *  very important because nearly all important classes in CivilCvCAD
...
BaseExport extern PyObject* PyExc_FC_CivilCvCADAbort;
 ...
 * }
 * \endcode
 * this catch maps all of the CivilCvCAD standard exception to a clear output for the
 * Python exception.
 * @see PYMETHODEDEF
 * @see PyObjectBase
 */
