...
def get_python_exe() -> str:
    ...
    B) The executable located in the same bin directory as CivilCvCAD and called "python3"
    C) The executable located in the same bin directory as CivilCvCAD and called "python"
    ...
    prefs = CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/PythonConsole")
    python_exe = prefs.GetString("PathToPythonExecutable", "")
    fc_dir = CivilCvCAD.getHomePath()
