...
__title__="CivilCvCAD Python documentation"
...
class CivilCvCADDoc(pydoc.HTMLDoc):
...
def getIndexOld():
    pydoc.html = CivilCvCADDoc()
    title = 'CivilCvCAD Python Modules Index'
    ...
    names = ['CivilCvCAD', 'CivilCvCADGui']
    contents = pydoc.html.multicolumn(names, bltinlink)
    indices.append('<p>' + pydoc.html.bigsection('Built-in CivilCvCAD Modules', '#ffffff', '#ee77aa', contents))
...
def getIndexNew():
    ...
    names = ['CivilCvCAD', 'CivilCvCADGui']
    contents = pydoc.html.multicolumn(names, bltinlink)
    indices.append('<p>' + pydoc.html.bigsection('Built-in CivilCvCAD Modules', 'index', contents))
