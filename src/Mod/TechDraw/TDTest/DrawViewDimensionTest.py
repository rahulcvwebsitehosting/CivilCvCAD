...
class DrawViewDimensionTest(unittest.TestCase):
    def setUp(self):
        ...
        print("DVDTest.setUp()")
        CivilCvCAD.newDocument("TDDimTest")
        CivilCvCAD.setActiveDocument("TDDimTest")
        CivilCvCAD.ActiveDocument = CivilCvCAD.getDocument("TDDimTest")
    ...
    def tearDown(self):
        ...
        CivilCvCAD.closeDocument("TDDimTest")
