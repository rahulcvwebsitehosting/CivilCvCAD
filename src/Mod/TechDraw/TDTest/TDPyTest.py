...
def TDPyTest():
    ...
    CivilCvCAD.newDocument("TDPy")
    CivilCvCAD.setActiveDocument("TDPy")
    CivilCvCAD.ActiveDocument=CivilCvCAD.getDocument("TDPy")

    direction = CivilCvCAD.Vector(0.0, 1.0, 0.0)
