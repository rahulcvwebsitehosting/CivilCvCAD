...
void QGIBalloonLabel::mouseDoubleClickEvent(QGraphicsSceneMouseEvent* event)
{
    ...
    auto ViewProvider = civilcvcad_cast<ViewProviderBalloon*>(
...
void QGIViewBalloon::setViewPartFeature(TechDraw::DrawViewBalloon* balloonFeat)
{
    ...
    if (docObj) {
        balloonParent = civilcvcad_cast<DrawView*>(docObj);
        if (balloonParent) {
...
void QGIViewBalloon::placeBalloon(QPointF pos)
{
    ...
    DrawView* balloonParent = civilcvcad_cast<DrawView*>(balloon->SourceView.getValue());
    if (!balloonParent) {
        return;
    }
    ...
    auto partVP = civilcvcad_cast<ViewProviderViewPart*>(objVp);
    if (partVP) {
...
QColor QGIViewBalloon::prefNormalColor()
{
    ...
    if (vp) {
        vpBalloon = civilcvcad_cast<ViewProviderBalloon*>(vp);
        if (vpBalloon) {
...
DrawView* QGIViewBalloon::getSourceView() const
{
    ...
    DrawViewBalloon* dvb = civilcvcad_cast<DrawViewBalloon*>(docObj);
    if (dvb) {
        balloonParent = civilcvcad_cast<DrawView*>(dvb->SourceView.getValue());
    }
