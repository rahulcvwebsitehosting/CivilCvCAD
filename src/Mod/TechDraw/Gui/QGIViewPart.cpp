...
void QGIViewPart::drawAllFaces(void)
{
    ...
    for (auto& face : faceGeoms) {
        ...
        if (fGeom) {
            ...
            ViewProviderGeomHatch* geomVp = civilcvcad_cast<ViewProviderGeomHatch*>(gvp);
            if (geomVp) {
            ...
            ViewProviderHatch* hatchVp = civilcvcad_cast<ViewProviderHatch*>(gvp);
            if (hatchVp) {
...
void QGIViewPart::highlightMoved(QGIHighlight* highlight, QPointF newPos)
{
    ...
    auto detail = civilcvcad_cast<DrawViewDetail*>(docObj);
    auto baseView = civilcvcad_cast<DrawViewPart*>(getViewObject());
    if (detail && baseView) {
