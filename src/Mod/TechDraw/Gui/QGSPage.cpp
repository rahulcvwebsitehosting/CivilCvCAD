...
bool QGSPage::attachView(App::DocumentObject* obj)
{
    ...
    if (auto o = civilcvcad_cast<TechDraw::DrawViewSection*>(obj)) {
        qview = addViewSection(o);
    }
    else if (auto o = civilcvcad_cast<TechDraw::DrawViewPart*>(obj)) {
        qview = addViewPart(o);
    }
    else if (auto o = civilcvcad_cast<TechDraw::DrawProjGroup*>(obj)) {
        qview = addProjectionGroup(o);
    }
    else if (auto o = civilcvcad_cast<TechDraw::DrawViewCollection*>(obj)) {
        qview = addDrawView(o);
    }
    else if (auto o = civilcvcad_cast<TechDraw::DrawViewDimension*>(obj)) {
        qview = addViewDimension(o);
    }
    else if (auto o = civilcvcad_cast<TechDraw::DrawViewBalloon*>(obj)) {
        qview = addViewBalloon(o);
    }
    else if (auto o = civilcvcad_cast<TechDraw::DrawViewAnnotation*>(obj)) {
        qview = addAnnotation(o);
    }
    else if (auto o = civilcvcad_cast<TechDraw::DrawViewSpreadsheet*>(obj)) {
        // has to be before DrawViewSymbol since it's a subclass of it.
        qview = addDrawViewSpreadsheet(o);
    }
    else if (auto o = civilcvcad_cast<TechDraw::DrawViewSymbol*>(obj)) {
        qview = addDrawViewSymbol(o);
    }
    else if (auto o = civilcvcad_cast<TechDraw::DrawViewClip*>(obj)) {
        qview = addDrawViewClip(o);
    }
    else if (auto o = civilcvcad_cast<TechDraw::DrawViewImage*>(obj)) {
        qview = addDrawViewImage(o);
    }
    else if (auto o = civilcvcad_cast<TechDraw::DrawLeaderLine*>(obj)) {
        qview = addViewLeader(o);
    }
    else if (auto o = civilcvcad_cast<TechDraw::DrawRichAnno*>(obj)) {
        qview = addRichAnno(o);
    }
    else if (auto o = civilcvcad_cast<TechDraw::DrawWeldSymbol*>(obj)) {
        qview = addWeldSymbol(o);
    }
    else if (civilcvcad_cast<TechDraw::DrawHatch*>(obj)) {
...
void QGSPage::saveSvg(QString filename)
{
    ...
    QString svgDescription = QStringLiteral("Drawing page: ") + pageName
        + QStringLiteral(" exported from CivilCvCAD document: ") + docName;
    ...
    svgGen.setTitle(QStringLiteral("CivilCvCAD SVG Export"));
...
void QGSPage::postProcessXml(QTemporaryFile& temporaryFile, QString fileName, QString pageName)
{
    ...
    // Insert CivilCvCAD SVG namespace into namespace declarations
    exportDocElem.setAttribute(QStringLiteral("xmlns:civilcvcad"),
                               QString::fromUtf8(CIVILCVCAD_SVG_NS_URI));
