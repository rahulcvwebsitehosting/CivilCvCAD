...
void QGIDatumLabel::snapPosition(QPointF& pos)
{
    ...
    auto* vp = civilcvcad_cast<ViewProviderDimension*>(Gui::Application::Instance->getViewProvider(dim));
    ...
    if (qgiv) {
        ...
        if (dvp) {
            ...
            for (auto& d : dims) {
                ...
                auto* vp = civilcvcad_cast<ViewProviderDimension*>(Gui::Application::Instance->getViewProvider(d));
                if (!vp) { continue; }
...
void QGIDatumLabel::mouseDoubleClickEvent(QGraphicsSceneMouseEvent* event)
{
    ...
    auto ViewProvider = civilcvcad_cast<ViewProviderDimension*>(
