...
BaseGeomPtrVector DrawComplexSection::makeSectionLineGeometry()
{
    ...
    auto* baseDvp = civilcvcad_cast<DrawViewPart*>(BaseView.getValue());
    if (baseDvp) {
...
// being slightly wrong.  see https://forum.civilcvcad.org/viewtopic.php?t=79017&sid=612a62a60f5db955ee071a7aaa362dbb
...
TopoDS_Wire DrawComplexSection::makeNoseToTailWire(const TopoDS_Shape& inShape)
{
    ...
    // Prior to https://github.com/CivilCvCAD/CivilCvCAD/issues/26838, this method demanded that the
...
TopoDS_Edge DrawComplexSection::mapEdgeToBase(const TopoDS_Edge& inEdge)
{
    ...
    auto* baseDvp = civilcvcad_cast<DrawViewPart*>(baseObj);
