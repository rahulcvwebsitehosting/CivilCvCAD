This folder (`locale`) contains translations for [TechDraw workbench templates](https://wiki.civilcvcad.org/TechDraw_Templates) in the parent `Templates` folder.
...
3. [Translate away!](https://wiki.civilcvcad.org/TechDraw_Templates)
4. [Submit a PR (GitHub Pull Request)](https://civilcvcad.github.io/DevelopersHandbook/gettingstarted/#submitting-a-pr) to get your Tech Draw template translations included in CivilCvCAD.

Use the [CivilCvCAD forum](https://forum.civilcvcad.org/) if you need further help.