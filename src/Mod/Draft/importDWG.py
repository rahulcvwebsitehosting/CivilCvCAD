...
def get_libredwg_converter(typ):
    ...
    It searches the CivilCvCAD parameters database, then searches the OS search path.
...
def get_oda_converter():
    ...
    It searches the CivilCvCAD parameters database, then searches for common paths.
...
https://wiki.civilcvcad.org/Import_Export_Preferences""",
        )
        + "\n"
    )
    return None
