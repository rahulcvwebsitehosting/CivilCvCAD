...
def get_shape_normal(shape):
    ...
    # in discussion https://forum.civilcvcad.org/viewtopic.php?p=717862#p717862
    #
    ...
    #   https://forum.civilcvcad.org/viewtopic.php?p=715850#p715850
    ...
    # - https://forum.civilcvcad.org/viewtopic.php?p=713993#p713993
    ...
    if plane is None:
        ...
        # see https://blog.civilcvcad.org/2023/01/16/the-rotation-api-in-civilcvcad/ for App.Rotation(vecx, vecy, vecz, string)
        # discussion - https://forum.civilcvcad.org/viewtopic.php?p=717738#p717738
    ...
    if len(shape.Edges) >= 1:
        ...
        for edge in shape.Edges:
            ...
            if (
                ...
                # https://forum.civilcvcad.org/viewtopic.php?p=726101#p726101
...
def mirror_matrix(mtx, pos, nor):
    ...
    """
    # Code by Jolbas:
    # https://forum.civilcvcad.org/viewtopic.php?p=702793#p702793
...
# See: https://github.com/CivilCvCAD/CivilCvCAD/pull/5307
