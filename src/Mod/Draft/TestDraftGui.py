...
CivilCvCAD -t TestDraftGui

From within CivilCvCAD, run the following:
...
# within CivilCvCAD itself.
#
# The tests can be run using the full 'CivilCvCAD' executable
# or the console only 'CivilCvCADCmd' executable. In the latter case
...
# from the Python console within CivilCvCAD.
#
# ===========================================================================
# Run all Draft tests
# ----
# CivilCvCAD -t TestDraft
#
...
# ----
# CivilCvCAD -t drafttests.test_creation
#
...
# ----
# CivilCvCAD -t drafttests.test_creation.DraftCreation
#
# >>> import Test, drafttests.test_creation
...
# ----
# CivilCvCAD -t drafttests.test_creation.DraftCreation.test_line
#
# >>> import unittest
