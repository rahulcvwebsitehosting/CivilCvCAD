...
class DxfImportDialog:
    ...
    def __init__(self, entity_counts, parent=None):
        ...
        self.dialog = CivilCvCADGui.PySideUic.loadUi(":/ui/preferences-dxf-import.ui")
    ...
    def connect_signals(self):
        ...
        if buttonBox:
            ...
            CivilCvCAD.Console.PrintLog("DxfImportDialog: OK and Cancel buttons connected.\n")
        else:
            CivilCvCAD.Console.PrintWarning("DxfImportDialog: Could not find buttonBox!\n")
    ...
    def on_accept(self):
        ...
        self.dialog.accept()
        CivilCvCAD.Console.PrintLog("DxfImportDialog: self.dialog.accept() has been called.\n")
    ...
    def on_reject(self):
        ...
        # Manually call the original slot
        self.dialog.reject()
        CivilCvCAD.Console.PrintLog("DxfImportDialog: self.dialog.reject() has been called.\n")
    ...
    def exec_(self):
        CivilCvCAD.Console.PrintLog("DxfImportDialog: Calling self.dialog.exec_()...\n")
