...
class DraftModification(test_base.DraftTestCaseDoc):
    ...
    def test_offset_closed_with_reversed_edge(self):
        ...
        # Regression test for:
        # https://github.com/CivilCvCAD/CivilCvCAD/pull/5496
        operation = "Draft Offset"
        _msg("  Test '{}'".format(operation))
    ...
    def test_offset_rectangle_with_face(self):
        ...
        # Regression test for:
        # https://github.com/CivilCvCAD/CivilCvCAD/pull/7670
        operation = "Draft Offset"
        _msg("  Test '{}'".format(operation))
        length = 10
        width = 4
    ...
    def test_attached_clone_behavior(self):
        ...
        Test for https://github.com/CivilCvCAD/CivilCvCAD/issues/8771.
        """
