...
배율이 1:100이면 계수는 100입니다.</translation>
    ...
    <message>
      ...
      <translation>치수의 단위 재정의입니다. 비워두면 현재 CivilCvCAD 단위를 사용합니다.</translation>
    </message>
    <message>
...
입력하십시오. 비워두면 CivilCvCAD에 정의된 현재 단위를 사용합니다.</translation>
    </message>
    <message>
...
이 값은 최대 세그먼트 길이입니다.</translation>
    ...
    <message>
      ...
      <translation>CivilCvCAD가 DXF 라이브러리를 자동으로 다운로드하고 업데이트하도록 허용</translation>
    </message>
    <message>
...
the 'dxf_library' addon from the Addon Manager.</source>
      <translation>체크하면 CivilCvCAD가 레거시 가져오기에 필요한 Python 라이브러리를
...
그렇지 않으면 기본 CivilCvCAD 색상이 적용됩니다</translation>
    </message>
    <message>
...
if they match the X, Y or Z axis of the global coordinate system</source>
  ...
  일치할 때 빨간색, 녹색 또는 파란색으로 표시됩니다</translation>
    ...
    <message>
      ...
      <translation>CivilCvCAD가 DWG 파일을 DXF로 변환하는 방법입니다. "자동"을 선택하면 CivilCvCAD가 여기에 표시된 순서대로 다음 변환기를 찾으려고 시도합니다. CivilCvCAD가 찾지 못하면 특정 변환기를 선택하고 아래에 경로를 지정해야 할 수 있습니다. LibreDWG를 사용하는 경우 "dwg2dxf" 유틸리티를, ODA 파일 변환기를 사용하는 경우 "ODAFileConverter"를, QCAD 프로 버전을 사용하는 경우 "dwg2dwg" 유틸리티를 선택하십시오.</translation>
    </message>
    <message>
...
To enabled CivilCvCAD to download these libraries, answer Yes.</source>
      <translation>CivilCvCAD가 DXF 형식을 처리하는 데 필요한 DXF 가져오기/내보내기 라이브러리가
이 시스템에서 발견되지 않았습니다.
CivilCvCAD가 이러한 라이브러리를 다운로드하도록 허용하십시오:
1 - 드래프트 워크벤치를 로드합니다
2 - 메뉴 편집 → 환경설정 → 가져오기/내보내기 → DXF → 다운로드 활성화
또는 다음 설명에 따라 이러한 라이브러리를 수동으로 다운로드하십시오:
https://github.com/yorikvanhavre/드래프트-dxf-importer
CivilCvCAD가 이러한 라이브러리를 다운로드할 수 있도록 하려면 예를 선택하십시오.</translation>
    </message>
    <message>
...
otherwise it tries to heal all objects in the active document.</source>
      <translation>이전 버전의 CivilCvCAD로 저장된 결함이 있는 드래프트 객체를 복구합니다.
