...
註解比例小工具。如果比例為 1:100，則乘數為 100。</translation>
    ...
    <message>
      ...
      <translation>覆蓋標註尺寸的單位。留空以使用目前的 CivilCvCAD 單位。</translation>
    </message>
    <message>
...
或 cm 來覆蓋原有單位，留空以使用 CivilCvCAD 中定義的目前單位。</translation>
    </message>
    <message>
...
此值是最大線段長度。</translation>
    ...
    <message>
      ...
      <translation>允許CivilCvCAD自動下載並更新DXF函式庫</translation>
    </message>
    <message>
...
如果它們與全局座標系的 X、Y 或 Z 軸匹配</translation>
    ...
    <message>
      ...
      <translation>這是 CivilCvCAD 將使用的方法將 DWG 文件轉換為 DXF。如果選擇了「自動」，CivilCvCAD 將嘗試按照以下顯示的順序查找以下轉換器之一。如果 CivilCvCAD 無法找到任何轉換器，您可能需要選擇特定的轉換器並在這裡指定其路徑。如果使用 LibreDWG，請選擇 "dwg2dxf" 公用程式，如果使用 ODA 檔案轉換器，請選擇 "ODAFileConverter"，如果使用 QCAD 的專業版本，請選擇 "dwg2dwg" 公用程式。</translation>
    </message>
    <message>
