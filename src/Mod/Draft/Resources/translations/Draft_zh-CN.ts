...
Annotation scale widget. If the scale is 1:100 the multiplier is 100.</source>
    ...
    <message>
      ...
      <translation>尺寸的单位覆盖。留空则使用当前 CivilCvCAD 单位。</translation>
    </message>
    <message>
...
或 cm，留空则使用 CivilCvCAD 中定义的当前单位。</translation>
    </message>
    <message>
...
这个值指定了用于近似的短线段的最大长度。</translation>
    ...
    <message>
      ...
      <translation>允许 CivilCvCAD 自动下载和更新 DXF 库</translation>
    </message>
    <message>
...
the 'dxf_library' addon from the Addon Manager.</source>
      <translation>如果选中，CivilCvCAD 可以下载和更新旧版导入器所需的 Python 库
。 这也可以通过从附加组件管理器安装
...
否则，将应用默认的CivilCvCAD颜色</translation>
    </message>
    <message>
...
如果它们与全局坐标系的 X、Y 或 Z 轴匹配</translation>
    ...
    <message>
      ...
      <translation>这个方法 CivilCvCAD 将用于将 DWG 文件转换为 DXF。 如果选择“自动”，CivilCvCAD 将尝试按照这里显示的顺序找到以下转换器之一。 如果CivilCvCAD 找不到任何，您可能需要选择一个特定的转换器并在这里指明其路径。 如果使用 LibreDWG, "ODAFileConverter" 如果使用官方发展援助文件转换器，请选择"dwg2dxf", 如果使用QCAD Pro 版本，请选择"dwg2dwg"。</translation>
    </message>
    <message>
...
To enabled CivilCvCAD to download these libraries, answer Yes.</source>
      <translation>未在此系统上找到 CivilCvCAD 处理 DXF 格式所需的 DXF 导入/导出库。
请允许 CivilCvCAD 下载这些库：
  1 - 加载 Draft 工作台
  2 - 菜单 编辑 → 偏好设置 → 导入-导出 → DXF → 启用下载
或按照 https://github.com/yorikvanhavre/Draft-dxf-importer 上的说明手动下载这些库。
要允许 CivilCvCAD 下载这些库，请回答“是”。</translation>
    </message>
    <message>
...
otherwise it tries to heal all objects in the active document.</source>
      <translation>修复使用早期版本 CivilCvCAD 保存的有问题的草绘对象。
如果选择了对象，则仅尝试修复该对象，
