...
Annotation scale widget. If the scale is 1:100 the multiplier is 100.</source>
    ...
    <message>
      ...
      <translation>Единица измерения размеров. Оставьте пустым, чтобы использовать текущие единицы измерения CivilCvCAD.</translation>
    </message>
    <message>
...
определенную в CivilCvCAD.</translation>
    </message>
    <message>
...
the 'dxf_library' addon from the Addon Manager.</source>
      <translation>Если этот флажок установлен, CivilCvCAD разрешено загружать и 
...
будут применены цвета CivilCvCAD по умолчанию</translation>
    </message>
    <message>
...
if they match the X, Y or Z axis of the global coordinate system</source>
    ...
    <message>
      ...
      <translation>Этот метод CivilCvCAD будет использовать для преобразования файлов DWG в DXF. Если выбрано значение «Автоматически», CivilCvCAD попытается найти один из следующих конвертеров в том же порядке, как они показаны здесь. Если CivilCvCAD не сможет найти ни один из них, вам, возможно, потребуется выбрать конкретный конвертер и указать здесь путь к нему. Выберите утилиту "dwg2dxf" при использовании LibreDWG, "ODAFileConverter" при использовании конвертера файлов ODA, или утилиту "dwg2dwg" при использовании профессиональной версии QCAD.</translation>
    </message>
    <message>
...
https://wiki.civilcvcad.org/Import_Export_Preferences/ru</translation>
    </message>
    <message>
...
To enabled CivilCvCAD to download these libraries, answer Yes.</source>
      <translation>Библиотеки импорта/экспорта DXF, необходимые CivilCvCAD для работы 
с форматом DXF, не были найдены в этой системе.
Пожалуйста, разрешите CivilCvCAD загрузить эти библиотеки:
...
https://github.com/yorikvanhavre/Draft-dxf-importer
Чтобы CivilCvCAD мог загрузить эти библиотеки, выберите "Да".</translation>
    </message>
    <message>
