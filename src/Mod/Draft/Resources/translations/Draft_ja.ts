...
注釈スケールウィジェットで設定されたスケールの逆数です。スケールが1:100の場合、乗数は100です。</translation>
    ...
    <message>
      ...
      <translation>寸法の上書き単位。現在のCivilCvCAD単位を使用する場合は空白のままにします。</translation>
    </message>
    <message>
...
or cm, leave blank to use the current unit defined in CivilCvCAD.</source>
      <translation>デフォルトの寸法の単位設定。mやcmなどの単位を入力します。CivilCvCADで定義されている現在の単位を使用する場合は空白のままにします。</translation>
    </message>
    <message>
...
この値は最大セグメント長です。</translation>
    ...
    <message>
      ...
      <translation>DXF ライブラリの自動的なダウンロードと更新を CivilCvCAD に許可</translation>
    </message>
    <message>
...
the 'dxf_library' addon from the Addon Manager.</source>
      <translation>チェックされている場合、CivilCvCADは旧来のインポート機能が必要とするPythonライブラリをダウンロードし更新します。これはアドオン・マネージャーから手動で「dxf_library」アドオンをインストールすることでも行えます。</translation>
    </message>
    <message>
...
それができない場合はデフォルトのCivilCvCADの色が適用されます。</translation>
    </message>
    <message>
...
if they match the X, Y or Z axis of the global coordinate system</source>
    ...
    <message>
      ...
      <translation>CivilCvCAD が DWG ファイルを DXF へ変換するために使う方法です。「自動」が選択された場合、CivilCvCAD は以下のコンバーターを表示順に従って検索します。CivilCvCAD がコンバーターを見つけられなかった場合、特定のコンバーターを選んで、以下で指定する必要があります。LibreDWG を使用する場合は「dwg2dxf」、ODA ファイルコンバーターを使用する場合は「ODAFileConverter」、QCAD pro 版を使用する場合は「dwg2dwg」を選択してください。</translation>
    </message>
    <message>
...
To enabled CivilCvCAD to download these libraries, answer Yes.</source>
      <translation>DXF形式を処理するためにCivilCvCADが必要とするDXFインポート/エクスポート用ライブラリーがシステム内に見つかりません。
CivilCvCADにこれらのライブラリーのダウウンロードを許可するために、以下のいずれかを行って下さい：
1 - Draftワークベンチを読み込み
2 - メニューの 編集→設定→インポート-エクスポート→DXF→ダウンロードを有効にする
またはライブラリー
https://github.com/yorikvanhavre/Draft-dxf-importer
の説明に従ってを手動でダウンロードします。
CivilCvCADでこれらライブラリーのダウンロードを有効にするためにYesを選択します。</translation>
    </message>
    <message>
...
otherwise it tries to heal all objects in the active document.</source>
      <translation>以前のバージョンのCivilCvCADで保存された不完全なドラフトオブジェクトを修復。
