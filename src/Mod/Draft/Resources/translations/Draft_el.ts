...
(Πώς λειτουργεί: Αν ο συντελεστής είναι 1.0, τα μεγέθη παραμένουν ως έχουν. Αν τον κάνετε 2.0, όλα τα κείμενα και οι δείκτες θα γίνουν διπλάσιοι. Αν τον κάνετε 0.5, θα γίνουν οι μισοί.)</translation>
    ...
    <message>
      ...
      <translation>Η τιμή που καθορίζει πόσο μεγάλα ή μικρά θα φαίνονται τα βέλη στην αρχή των γραμμών διάστασης, χρησιμοποιώντας τη μονάδα μέτρησης που έχετε ορίσει στο civilcvcad (συνήθως χιλιοστά - mm)</translation>
    </message>
    <message>
...
Annotation scale widget. If the scale is 1:100 the multiplier is 100.</source>
    ...
    <message>
      ...
      <translation>Παράκαμψη μονάδας για διαστάσεις. Αφήστε κενό για χρήση της τρέχουσας μονάδας CivilCvCAD.</translation>
    </message>
    <message>
...
or cm, leave blank to use the current unit defined in CivilCvCAD.</translation>
    </message>
    <message>
...
This value is the maximum segment length.</translation>
    ...
    <message>
      ...
      <translation>Να επιτρέπεται στο CivilCvCAD να κατεβάζει και ανανεώνει αυτόματα τις βιβλιοθήκες DXF</translation>
    </message>
    <message>
...
the 'dxf_library' addon from the Addon Manager.</source>
      <translation type="unfinished">If checked, CivilCvCAD is allowed to download and update the Python libraries
required by the legacy importer. This can also be done manually by installing
...
possible. Otherwise, default CivilCvCAD colors are applied</translation>
    </message>
    <message>
...
if they match the X, Y or Z axis of the global coordinate system</translation>
    ...
    <message>
      ...
      <translation>Αυτή είναι η μέθοδος που θα χρησιμοποιήσει το CivilCvCAD για τη μετατροπή αρχείων DWG σε DXF. Αν επιλεγεί το "Automatic", το CivilCvCAD θα προσπαθήσει να βρει έναν από τους παρακάτω μετατροπείς με την ίδια σειρά που εμφανίζονται εδώ. Αν το CivilCvCAD δεν είναι σε θέση να βρει, ίσως χρειαστεί να επιλέξετε ένα συγκεκριμένο μετατροπέα και να υποδείξετε τη διαδρομή του εδώ κάτω. Επιλέξτε το βοηθητικό πρόγραμμα "dwg2dxf" αν χρησιμοποιείτε το LibreDWG, "ODAFileConverter" εάν χρησιμοποιείτε το μετατροπέα αρχείων ODA, ή το βοηθητικό πρόγραμμα "dwg2dwg" εάν χρησιμοποιείτε την pro έκδοση του QCAD.</translation>
    </message>
    <message>
