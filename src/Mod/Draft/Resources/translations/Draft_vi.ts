...
value by using the [ and ] keys while drawing</translation>
    ...
    <message>
      ...
      <source>The unit to use for dimensions. Leave blank to use current CivilCvCAD unit</source>
      <translation type="unfinished">The unit to use for dimensions. Leave blank to use current CivilCvCAD unit</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <source>The number of decimals in internal coordinates operations (for ex. 3 = 0.001). Values between 6 and 8 are usually considered the best trade-off among CivilCvCAD users.</source>
      <translation type="unfinished">The number of decimals in internal coordinates operations (for ex. 3 = 0.001). Values between 6 and 8 are usually considered the best trade-off among CivilCvCAD users.</translation>
    </message>
    <message>
...
If this option is checked, the base objects will be selected instead.</translation>
    ...
    <message>
      ...
      <source>If this option is set, when creating Draft objects on top of an existing face of another object, the "Support" property of the Draft object will be set to the base object. This was the standard behaviour before CivilCvCAD 0.19</source>
      <translation type="unfinished">If this option is set, when creating Draft objects on top of an existing face of another object, the "Support" property of the Draft object will be set to the base object. This was the standard behaviour before CivilCvCAD 0.19</translation>
    </message>
    <message>
...
Nó có thể là tên phông chữ như "Arial", một kiểu mặc định như "sans", "serif" hoặc "mono" hoặc họ như "Arial, Helvetica, sans" hoặc tên có kiểu như "Arial: Bold"</translation>
    ...
    <message>
      ...
      <source>By leaving this field blank, the dimension measurements will be shown in the current unit defined in CivilCvCAD. By indicating a unit here such as m or cm, you can force new dimensions to be shown in that unit.</source>
      <translation type="unfinished">By leaving this field blank, the dimension measurements will be shown in the current unit defined in CivilCvCAD. By indicating a unit here such as m or cm, you can force new dimensions to be shown in that unit.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <source>Method chosen for importing SVG object color to CivilCvCAD</source>
      <translation type="unfinished">Method chosen for importing SVG object color to CivilCvCAD</translation>
    </message>
    <message>
...
Note: C++ exporter is faster, but is not as featureful yet</translation>
    ...
    <message>
      ...
      <source>Allow CivilCvCAD to download the Python converter for DXF import and export.
You can also do this manually by installing the "dxf_library" workbench
from the Addon Manager.</source>
      <translation type="unfinished">Allow CivilCvCAD to download the Python converter for DXF import and export.
You can also do this manually by installing the "dxf_library" workbench
from the Addon Manager.</translation>
    ...
    <message>
      ...
      <translation>Cho phép CivilCvCAD để tự động tải xuống và cập nhật các thư viện DXF</translation>
    </message>
    <message>
...
Otherwise default colors will be applied. </translation>
    ...
    <message>
      ...
      <source>CivilCvCAD will try to join coincident objects into wires.
Note that this can take a while!</source>
      <translation type="unfinished">CivilCvCAD will try to join coincident objects into wires.
...
This might fail for post DXF R12 templates.</translation>
    ...
    <message>
      ...
      <translation type="unfinished">This is the method CivilCvCAD will use to convert DWG files to DXF. If "Automatic" is chosen, CivilCvCAD will try to find one of the following converters in the same order as they are shown here. If CivilCvCAD is unable to find any, you might need to choose a specific converter and indicate its path here under. Choose the "dwg2dxf" utility if using LibreDWG, "ODAFileConverter" if using the ODA file converter, or the "dwg2dwg" utility if using the pro version of QCAD.</translation>
    </message>
    <message>
...
Please either enable CivilCvCAD to download these libraries:
  1 - Load Draft workbench
  2 - Menu Edit &gt; Preferences &gt; Import-Export &gt; DXF &gt; Enable downloads
Or download these libraries manually, as explained on
https://github.com/yorikvanhavre/Draft-dxf-importer
To enabled CivilCvCAD to download these libraries, answer Yes.</source>
      <translation type="unfinished">The DXF import/export libraries needed by CivilCvCAD to handle
the DXF format were not found on this system.
Please either enable CivilCvCAD to download these libraries:
  1 - Load Draft workbench
  2 - Menu Edit &gt; Preferences &gt; Import-Export &gt; DXF &gt; Enable downloads
Or download these libraries manually, as explained on
https://github.com/yorikvanhavre/Draft-dxf-importer
To enabled CivilCvCAD to download these libraries, answer Yes.</translation>
    </message>
    <message>
