...
__title__ = "CivilCvCAD Draft Edit Tool"
__author__ = (
...
class Edit(gui_base_original.Modifier):
    """The Draft_Edit CivilCvCAD command definition.

    A tool to graphically edit CivilCvCAD objects.
    ...
    max_objects: Int
        ...
        The max number of CivilCvCAD objects the tool is
    ...
    def Activated(self):
        ...
        if Gui.Selection.getSelection():
            ...
            # https://github.com/CivilCvCAD/CivilCvCAD/issues/27308
