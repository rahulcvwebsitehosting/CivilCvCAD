...
__title__ = "CivilCvCAD Draft Snap tools"
...
class Snapper:
    ...
    def _get_wp(self):
        ...
        # the mouse
        # See: https://github.com/CivilCvCAD/CivilCvCAD/issues/24013
    ...
    def snapToEndpoints(self, shape, point=None):
        ...
        if self.isEnabled("Endpoint"):
            ...
            if hasattr(shape, "Points") and point is not None:
                ...
                # https://github.com/CivilCvCAD/CivilCvCAD/issues/22367
    ...
    def getPoint(
        ...
        try:
            ...
            if self.callbackClick or self.callbackMove:
                # Next line fixes https://github.com/CivilCvCAD/CivilCvCAD/issues/10469:
