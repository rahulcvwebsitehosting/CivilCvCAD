...
class Draft2Sketch(gui_base_original.Modifier):
    ...
    def proceed(self):
        ...
        if not sel:
            ...
            _cmd += "("
            _cmd += "CivilCvCADGui.Selection.getSelection(), "
            _cmd += "autoconstraints=True"
            _cmd += ")"
            _cmd_list = ["sk = " + _cmd, "CivilCvCAD.ActiveDocument.recompute()"]
            ...
            _cmd_list.append("CivilCvCAD.ActiveDocument.recompute()")
            ...
            for obj in sel:
                ...
                _cmd_df += "("
                _cmd_df += "CivilCvCAD.ActiveDocument." + obj.Name + ", "
                _cmd_df += "delete=False"
                _cmd_df += ")"

                _cmd_sk = "Draft.make_sketch"
                _cmd_sk += "("
                _cmd_sk += "CivilCvCAD.ActiveDocument." + obj.Name + ", "
