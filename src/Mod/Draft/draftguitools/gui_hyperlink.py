...
__title__ = "CivilCvCAD Draft Workbench GUI Tools - Hyperlinks tools"
__author__ = ""
__url__ = ""
class Draft_Hyperlink:
    """The Draft_Hyperlink CivilCvCAD command definition."""
...
CivilCvCADGui.addCommand("Draft_Hyperlink", Draft_Hyperlink())
