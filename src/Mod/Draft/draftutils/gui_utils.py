...
def get_3d_view():
    ...
    # Also see discussion https://forum.civilcvcad.org/viewtopic.php?f=3&t=60251
    import CivilCvCADGui as Gui
    from pivy import coin
...
# See https://forum.civilcvcad.org/viewtopic.php?p=656362#p656362.
# Used to fix https://github.com/CivilCvCAD/CivilCvCAD/issues/10469.
def end_all_events():
    view = get_3d_view()
    if view is None:
        return
