...
if CivilCvCAD.GuiUp:
    ...
    def _update_grid_gui():
        ...
        try:
            ...
            view_idx = CivilCvCADGui.Snapper.trackers[0].index(view)
            grid = CivilCvCADGui.Snapper.trackers[1][view_idx]
            if grid.Visible:
    ...
    def _set_grid_button_state(button_check):
        ...
        action = CivilCvCADGui.Command.get("Draft_ToggleGrid").getAction()[0]
