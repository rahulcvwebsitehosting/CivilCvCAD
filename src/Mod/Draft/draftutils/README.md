...
modules and basic CivilCvCAD methods so that there are no circular dependencies,
...
[[Discussion] Splitting Draft tools into their own modules](https://forum.civilcvcad.org/viewtopic.php?f=23&t=38593&start=10#p341298)
