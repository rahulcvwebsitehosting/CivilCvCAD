...
class ShapeString(DraftObject):
    ...
    def execute(self, obj):
        ...
        if obj.FontFile[0] == ".":
            # FontFile path relative to the CivilCvCAD file directory.
        ...
        if fill is True:
            ...
            if not shapes:
                ...
                # https://github.com/CivilCvCAD/CivilCvCAD/issues/21501
    ...
    def make_faces(self, wireChar):
        ...
        # Some test fonts:
        # https://raw.githubusercontent.com/CivilCvCAD/FPA/main/images/civilcvcad_logo_official.svg
        #     https://evolventa.github.io/
        #     not a problem font, but it is used by CivilCvCAD
        # https://forum.civilcvcad.org/viewtopic.php?t=57774
        #     https://www.dafont.com/mutlu-ornamental.font
        # https://forum.civilcvcad.org/viewtopic.php?t=65110&p=559810#p559886
