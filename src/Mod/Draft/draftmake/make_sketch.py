...
def make_sketch(
    ...
    base.Length = point.dot(
        base.normalize()
    )  # See https://forum.civilcvcad.org/viewtopic.php?f=22&t=69304#p601149
    ...
    if autoconstraints:
        ...
        # https://forum.civilcvcad.org/viewtopic.php?t=97072
        # https://github.com/CivilCvCAD/CivilCvCAD/issues/21396
        ...
        # https://github.com/CivilCvCAD/CivilCvCAD/issues/19978
        nobj.solve()
