...
from CivilCvCAD import Units as U
...
def _quantity(st):
    ...
    # https://github.com/CivilCvCAD/CivilCvCAD/issues/11345
...
class TaskPanelPolarArray:
    ...
    The `.ui` file may use special CivilCvCAD widgets such as
    ...
    See Also
    --------
    * https://forum.civilcvcad.org/viewtopic.php?f=10&t=40007
    * https://forum.civilcvcad.org/viewtopic.php?t=5374#p43038
    """
    ...
    def display_point(self, point=None, plane=None, mask=None):
        ...
        #
        # setProperty() is used if the widget is a CivilCvCAD widget like
