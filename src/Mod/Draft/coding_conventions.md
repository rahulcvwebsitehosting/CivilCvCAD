...
- Imports should be at the beginning of the file,
  ...
  and then CivilCvCAD specific imports.
...
- The import of modules that require the graphical interface,
  such as `CivilCvCADGui`, should be guarded by an `if CivilCvCAD.GuiUp:` test.
...
- The online [LGTM service](https://lgtm.com/projects/g/CivilCvCAD/CivilCvCAD/latest/files/src/Mod/Draft/)
