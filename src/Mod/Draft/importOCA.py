...
__title__ = "CivilCvCAD Draft Workbench - OCA importer/exporter"
__author__ = "Yorik van Havre <yorik@uncreated.net>"
__url__ = ""
import CivilCvCAD, os, Part, DraftVecUtils, DraftGeomUtils
...
def getpoint(data):
    """Turn an OCA point definition into a CivilCvCAD.Vector.
...
def getarea(data):
    """Turn an OCA area definition into a CivilCvCAD Part.Wire.
...
def getarc(data):
    """Turn an OCA arc definition into a CivilCvCAD Part.Edge.
...
def getline(data):
    """Turns an OCA line definition into a CivilCvCAD Part.Edge.
...
def writepoint(vector):
    """Write a CivilCvCAD.Vector in OCA format.
...
def createobject(oid, doc):
    ...
    doc : App::Document
        A CivilCvCAD document to which the object is added.
    Returns
    -------
    None
    """
...
def export(exportList, filename):
    ...
    oca.write("#oca file generated from CivilCvCAD\r\n")
    oca.write("# edges\r\n")
    count = 1
    for e in edges:
