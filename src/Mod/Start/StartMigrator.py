...
class StartMigrator2024:
    ...
    def __init__(self):
        ...
        self.start_prefs = CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/Start")
        self.general_prefs = CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/General")
    ...
    def run_migration(self):
        if self.migration_2024_complete:
            ...
            return
        CivilCvCAD.Console.PrintMessage("Migrating Start Workbench to Start command... ")
        ...
        self._mark_complete()
        CivilCvCAD.Console.PrintMessage("done.\n")
    ...
    def _remove_wb_references(self):
        general_prefs = CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/General")
        ...
        treeview_prefs = CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/Workbenches")
    ...
    def _remove_commands(self):
        command_prefs = CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/Commands")
    ...
    def _remove_toolbars(self):
        tux_prefs = CivilCvCAD.ParamGet("User parameter:Tux/PersistentToolbars/User")
