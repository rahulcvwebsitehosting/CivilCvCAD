...
This epic is designed to fit with an [FPA grant proposal](https://github.com/CivilCvCAD/FPA-grant-proposals/issues/80).

| In  | Out |
| --- | --- |
| Add Clipper 2 to CivilCvCAD | Research other new libraries to add to CivilCvCAD |
...
| Remove libarea and kurve from the CivilCvCAD | |
