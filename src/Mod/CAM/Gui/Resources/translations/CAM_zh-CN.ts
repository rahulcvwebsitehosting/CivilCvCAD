...
对于来自基础对象边界框的毛坯，这意味着所有方向上的额外材料。从此类模板创建的毛坯对象将从新作业的基础对象获取其基本尺寸，并应用存储的额外设置。</translation>
    ...
    <message>
      ...
      <translation>显示可用的后处理器。CivilCvCAD 包含几个预安装的后处理器。必须在偏好设置中启用至少一个后处理器。</translation>
    </message>
    <message>
...
以下示例将所有与文档同名的文件存储在 /home/civilcvcad 目录中（请移除引号）：
&amp;quot;/home/cnc/%d.g-code&amp;quot;
有关如何处理名称冲突，请参阅下面的文件保存策略。</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>如果安装了带有 Python 绑定的 OpenCAMLib，则一些额外的 3D 操作可以使用它。注意：在此启用 OpenCAMLib 需要重新启动 CivilCvCAD 才能生效。</translation>
    </message>
    <message>
...
CivilCvCAD 不知道特定坐标系在机床坐标系中的位置，因此向作业添加额外的坐标系在作业中不会有视觉变化。但是，它会改变您的 G 代码输出。输出受影响的具体方式由&quot;排序方式&quot;设置控制。&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
...
如果不进行子选择操作，该形状的所有边都会被选中。</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>&lt;b&gt;注意&lt;/b&gt;: 此对话框以 CivilCvCAD 的基础单位（毫米/秒）显示路径命令。&lt;br&gt;数值将在后处理期间转换为所需的单位。</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>CivilCvCAD 刀具库</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>CivilCvCAD 刀具</translation>
    </message>
    <message>
