...
Для заготовки из ограничивающей рамки базового объекта это означает дополнительный материал во всех направлениях. Заготовочный объект, созданный из такого шаблона, получит свой базовый размер из базового объекта нового задания и применит сохраненные дополнительные настройки.</translation>
    ...
    <message>
      ...
      <translation>Отображает доступные пост-процессоры. CivilCvCAD включает несколько предустановленных постпроцессоров. По крайней мере один пост-процессор должен быть включен в настройках.</translation>
    </message>
    <message>
...
Большие значения (кроме справа) будут вычисляться быстрее; меньшие значения (далее слева) позволят получить более точные пути инструментов.</translation>
    ...
    <message>
      ...
      <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Инструмент и его настройки, которые будут использоваться для этой операции.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
...
В следующем примере все файлы с тем же именем, что и у документа, сохраняются в каталоге /home/civilcvcad (пожалуйста, удалите кавычки):
&amp;quot;/home/cnc/%d.g-code&amp;quot;
См. политику сохранения файлов ниже, чтобы узнать, как решать конфликты имен.</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Если OpenCAMLib установлена с привязками Python, её можно использовать для некоторых дополнительных 3D-операций. ПРИМЕЧАНИЕ. Включение OpenCAMLib здесь требует перезапуска CivilCvCAD, чтобы изменения вступили в силу.</translation>
    </message>
    <message>
...
CivilCvCAD не имеет сведений о том, где находится конкретная система координат в системе координат машины, поэтому добавление дополнительных систем координат в вашу работу не приведет к визуальным изменениям в вашей работе. Однако это изменит ваш вывод G-кода. Точный способ, которым это повлияет на вывод, контролируется настройкой «order by».&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
...
Without sub selection all edges of the shape will be selected.</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Библиотека инструментов CivilCvCAD</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Инструмент CivilCvCAD</translation>
    </message>
    <message>
