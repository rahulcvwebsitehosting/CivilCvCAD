# CivilCvCAD Path Workbench GCode documentation

This is a documentation of all GCodes used by the CivilCvCAD Path Workbench
...
| G40          | Turn off tool radius compensation                                 | Radius compensation is done in CivilCvCAD |
| G41          | Tool radius compensation value                                    | Radius compensation is done in CivilCvCAD |
| G42          | Tool radius compensation value                                    | Radius compensation is done in CivilCvCAD |
