...
class ObjectDressup:
    ...
    def getLeadStart(self, obj, move, first, inInstrPrev, outInstrPrev):
        ...
        if styleIn not in ("No Retract", "Vertical"):
            ...
            # https://forum.civilcvcad.org/viewtopic.php?t=97641
...
class CommandPathDressup:
    ...
    def Activated(self):
        ...
        CivilCvCADGui.addModule("Path.Dressup.Gui.LeadInOut")
        CivilCvCADGui.doCommand(f"base = CivilCvCAD.ActiveDocument.getObject('{op.Name}')")
        CivilCvCADGui.doCommand("Path.Dressup.Gui.LeadInOut.Create(base)")
...
if App.GuiUp:
    ...
    CivilCvCADGui.addCommand("CAM_DressupLeadInOut", CommandPathDressup())
