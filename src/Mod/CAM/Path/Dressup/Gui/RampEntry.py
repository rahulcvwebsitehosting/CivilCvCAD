...
class CommandPathDressup:
    ...
    def Activated(self):
        ...
        # everything ok!
        CivilCvCAD.ActiveDocument.openTransaction("Create RampEntry Dressup")
        CivilCvCADGui.addModule("Path.Dressup.Gui.RampEntry")
        CivilCvCADGui.doCommand(f"base = CivilCvCAD.ActiveDocument.getObject('{op.Name}')")
        CivilCvCADGui.doCommand("Path.Dressup.Gui.RampEntry.Create(base)")
...
def Create(baseObject, name="DressupRampEntry", mode=0):
    ...
    CivilCvCAD.ActiveDocument.openTransaction("Create a DressupRampEntry")
...
if CivilCvCAD.GuiUp:
    ...
    CivilCvCADGui.addCommand("CAM_DressupRampEntry", CommandPathDressup())
