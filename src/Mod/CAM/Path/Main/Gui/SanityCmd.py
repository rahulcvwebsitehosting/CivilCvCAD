...
"""
This file has the GUI command for checking and catching common errors in CivilCvCAD
CAM projects.
"""
...
class CommandCAMSanity:
    ...
    def Activated(self):
        ...
        obj = CivilCvCADGui.Selection.getSelectionEx()[0].Object

        # Ask the user for a filename to save the report to

        defaultDir = os.path.split(CivilCvCAD.ActiveDocument.getFileName())[0]
        ...
        CivilCvCAD.Console.PrintMessage("Sanity check report written to: {}\n".format(file_location))

        open_local_url(file_location)
...
class CommandCAMQuickValidate:
    ...
    def Activated(self):
        ...
        try:
            ...
            CivilCvCAD.Console.PrintError(f"Quick Validate failed: {e}\n")
            return
        ...
        CivilCvCAD.Console.PrintMessage(translate("CAM_Sanity", "=== Quick Validation Results ===\n"))
...
if CivilCvCAD.GuiUp:
    ...
    CivilCvCADGui.addCommand("CAM_Sanity", CommandCAMSanity())
    CivilCvCADGui.addCommand("CAM_QuickValidate", CommandCAMQuickValidate())
