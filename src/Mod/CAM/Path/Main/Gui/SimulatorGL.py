...
from CivilCvCAD import Vector, Placement, Rotation
...
class CAMSimTaskUi:
    ...
    def __init__(self, parent):
        ...
        self.form = CivilCvCADGui.PySideUic.loadUi(":/panels/TaskCAMSimulator.ui")
        self.parent = parent
...
class CAMSimulation:
    ...
    def SimPlay(self):
        ...
        self.SetupSimulation()
        self.millSim.ResetSimulation(CivilCvCADGui.getDocument(self.job.Document))
...
class CommandCAMSimulate:
    """CivilCvCAD invoke simulation task panel command"""
...
if CivilCvCAD.GuiUp:
    ...
    CivilCvCADGui.addCommand("CAM_SimulatorGL", CommandCAMSimulate())
