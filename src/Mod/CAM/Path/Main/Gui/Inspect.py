...
class GCodeHighlighter(QtGui.QSyntaxHighlighter):
    def __init__(self, parent=None):
        ...
        p = CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/Editor")
        colors = []
...
class GCodeEditorDialog(QtGui.QDialog):
    ...
    def __init__(self, PathObj, parent=CivilCvCADGui.getMainWindow()):
        ...
        p = CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/CAM")
        ...
        self.selectionobj = CivilCvCAD.ActiveDocument.addObject("Path::Feature", "selection")
        ...
        lab.setText(
            translate(
                "CAM_Inspect",
                "<b>Note</b>: This dialog shows path commands in CivilCvCAD base units (mm/s)."
    ...
    def cleanup(self):
        ...
        CivilCvCAD.ActiveDocument.removeObject(self.selectionobj.Name)
    ...
    if hasattr(obj, "Path"):
        if obj.Path:
            ...
            if result:
                ...
                CivilCvCAD.ActiveDocument.openTransaction("Edit Path")
                obj.Path = p
...
class CommandPathInspect:
    ...
    def Activated(self):
        ...
        CivilCvCADGui.addModule("Path.Main.Gui.Inspect")
        CivilCvCADGui.doCommand(f"obj = CivilCvCAD.ActiveDocument.getObject('{selection[0].Name}')")
        CivilCvCADGui.doCommand("Path.Main.Gui.Inspect.show(obj)")


if CivilCvCAD.GuiUp:
    # register the CivilCvCAD command
    CivilCvCADGui.addCommand("CAM_Inspect", CommandPathInspect())
