...
class CommandPathFixture:
    ...
    def Activated(self):
        CivilCvCAD.ActiveDocument.openTransaction("Create a Fixture Offset")
        CivilCvCADGui.addModule("Path.Main.Gui.Fixture")
        snippet = """
import Path
import PathScripts
from PathScripts import PathUtils
prjexists = False
obj = CivilCvCAD.ActiveDocument.addObject("Path::FeaturePython","Fixture")
...
if CivilCvCAD.GuiUp:
    ...
    CivilCvCADGui.addCommand("CAM_Fixture", CommandPathFixture())


CivilCvCAD.Console.PrintLog("Loading PathFixture… done\n")
