...
class ToolBitShapeSlittingSaw(ToolBitShape):
    ...
    def schema(cls) -> Mapping[str, Tuple[str, str]]:
        return {
            "BladeThickness": (
                CivilCvCAD.Qt.translate("ToolBitShape", "Blade thickness"),
                "App::PropertyLength",
            ),
            "CapDiameter": (
                CivilCvCAD.Qt.translate("ToolBitShape", "Cap diameter"),
                "App::PropertyLength",
            ),
            "CapHeight": (
                CivilCvCAD.Qt.translate("ToolBitShape", "Cap height"),
                "App::PropertyLength",
            ),
            "Diameter": (
    ...
    @property
    def label(self) -> str:
        return CivilCvCAD.Qt.translate("ToolBitShape", "Slitting Saw")
