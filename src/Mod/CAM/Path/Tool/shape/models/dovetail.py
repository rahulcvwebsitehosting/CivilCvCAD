...
class ToolBitShapeDovetail(ToolBitShape):
    ...
    def schema(cls) -> Mapping[str, Tuple[str, str]]:
        return {
            ...
            "CuttingEdgeHeight": (
                CivilCvCAD.Qt.translate("ToolBitShape", "Dovetail height"),
                "App::PropertyLength",
            ),
            "Diameter": (
                CivilCvCAD.Qt.translate("ToolBitShape", "Major diameter"),
                "App::PropertyLength",
            ),
            "Flutes": (
    ...
    @property
    def label(self) -> str:
        return CivilCvCAD.Qt.translate("ToolBitShape", "Dovetail")
