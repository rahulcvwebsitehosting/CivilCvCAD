...
class ToolBitShape(Asset):
    ...
    def __init__(self, id: str, **kwargs: Any):
        ...
        Args:
            ...
            **kwargs: Keyword arguments for shape parameters (e.g., Diameter).
                      Values should be CivilCvCAD.Units.Quantity where applicable.
        """
        ...
        # Stores the CivilCvCAD property types for each parameter
        self._param_types: Dict[str, str] = {}

        # Keeps the loaded CivilCvCAD document content for this instance
    ...
    @classmethod
    def _get_shape_class_from_doc(cls, doc: "CivilCvCAD.Document") -> Type["ToolBitShape"]:
    ...
    @classmethod
    def _find_property_object(cls, doc: "CivilCvCAD.Document") -> Optional["CivilCvCAD.DocumentObject"]:
        """
    ...
    def from_bytes(
        ...
        Raises:
            ValueError: If the data cannot be opened, no Body or PropertyBag
                        ...
                        shape name.
            Exception: For other potential CivilCvCAD errors during loading.
        """
    ...
    def to_bytes(self, serializer: Type[AssetSerializer]) -> bytes:
        ...
        try:
            ...
            doc = CivilCvCAD.newDocument("TemporaryShapeDoc", hidden=True)
    ...
    def schema(cls) -> Mapping[str, Tuple[str, str]]:
        ...
        translations and CivilCvCAD property type strings (e.g.,
        'App::PropertyLength').
    ...
    def get_schema_property_type(cls, param_name: str) -> str:
        """
        Get the CivilCvCAD property type string for a given parameter name.
        """
    ...
    def get_parameter(self, name: str) -> Any:
        ...
        Returns:
            The value of the parameter (often a CivilCvCAD.Units.Quantity).
    ...
    def set_parameter(self, name: str, value: Any):
        ...
        Args:
            ...
            value: The new value for the parameter. Should be compatible
                   with the expected type (e.g., CivilCvCAD.Units.Quantity).
    ...
    def make_body(self, doc: "CivilCvCAD.Document"):
        """
        ...
        with ShapeDocFromBytes(self._data) as tmp_doc:
            ...
            # Temporarily disable duplicate labels to let CivilCvCAD automatically
            ...
            try:
                ...
                # Copy the body - CivilCvCAD will now automatically make labels unique
