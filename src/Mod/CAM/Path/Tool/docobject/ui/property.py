...
class BasePropertyEditorWidget(QtGui.QWidget):
    ...
    def __init__(self, obj: CivilCvCAD.DocumentObject, prop_name: str, parent: QtGui.QWidget = None):
    ...
    def attachTo(self, obj: CivilCvCAD.DocumentObject, prop_name: Optional[str] = None):
    ...
    @classmethod
    def for_property(
        cls, obj: CivilCvCAD.DocumentObject, prop_name: str, parent: QtGui.QWidget = None
        ...
        if isinstance(prop_value, CivilCvCAD.Units.Quantity):
...
class QuantityPropertyEditorWidget(BasePropertyEditorWidget):
    ...
    def __init__(self, obj: CivilCvCAD.DocumentObject, prop_name: str, parent: QtGui.QWidget = None):
        ...
        self._editor_widget: CivilCvCADGui.QuantitySpinBox = ui.createWidget("Gui::QuantitySpinBox")
    ...
    def updateWidget(self):
        value: CivilCvCAD.Units.Quantity = self._obj.getPropertyByName(self._prop_name)
    ...
    def updateProperty(self):
        ...
        new_value = CivilCvCAD.Units.Quantity(new_value_str)
