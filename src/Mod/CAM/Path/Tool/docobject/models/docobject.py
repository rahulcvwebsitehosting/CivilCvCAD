...
class DetachedDocumentObject:
    """
    A lightweight class mimicking the property API of a CivilCvCAD DocumentObject.

    This class is used by ToolBit instances when they are not associated
    with a real CivilCvCAD DocumentObject, allowing properties to be stored
    ...
    def addProperty(
        ...
        """Mimics CivilCvCAD DocumentObject.addProperty."""
        if name not in self._properties:
            ...
            if thetype in [
                ...
                self._properties[name] = CivilCvCAD.Units.Quantity(0.0)
    ...
    def getPropertyByName(self, name: str) -> Any:
        """Mimics CivilCvCAD DocumentObject.getPropertyByName."""
        return self._properties.get(name)

    def setPropertyByName(self, name: str, value: Any) -> None:
        """Mimics CivilCvCAD DocumentObject.setPropertyByName."""
        self._properties[name] = value

    def __setattr__(self, name: str, value: Any) -> None:
        """
        Intercept attribute assignment. This is done to behave like
        CivilCvCAD's DocumentObject, which may have any property assigned,
        pre-defined or not.
        ...
        # Attempt to convert string values to Quantity if the property type is Quantity
            ...
            value = CivilCvCAD.Units.Quantity(value)
    ...
    def copy_to(self, obj: CivilCvCAD.DocumentObject) -> None:
        """
