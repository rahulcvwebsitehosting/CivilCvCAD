...
class LibraryEditor(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.form = CivilCvCADGui.PySideUic.loadUi(":/panels/ToolBitLibraryEdit.ui")
    ...
    def _on_add_library_requested(self):
        ...
        new_library = Library(CivilCvCAD.Qt.translate("CAM", "New Library"))
    ...
    def _on_remove_library_requested(self):
        ...
        reply = QMessageBox.question(
            self,
            CivilCvCAD.Qt.translate("CAM", "Confirm Library Removal"),
            CivilCvCAD.Qt.translate(
                "CAM",
        ...
        try:
            ...
            QMessageBox.critical(
                self,
                CivilCvCAD.Qt.translate("CAM", "Error"),
                CivilCvCAD.Qt.translate("CAM", "Failed to delete library '{0}': {1}").format(
    ...
    def _on_import_library_requested(self):
        ...
        try:
            ...
            QMessageBox.critical(
                self,
                CivilCvCAD.Qt.translate("CAM", "Error"),
                CivilCvCAD.Qt.translate("CAM", f"Failed to import library: {file_path} {e}"),
            )
    ...
    def _on_add_toolbit_requested(self):
        ...
        try:
            ...
            new_toolbit.label = CivilCvCAD.Qt.translate("CAM", "New Toolbit")
            ...
            QMessageBox.critical(
                self,
                CivilCvCAD.Qt.translate("CAM", "Error Creating Toolbit"),
                str(e),
            )
            raise
    ...
    def _on_import_toolbit_requested(self):
        ...
        if not current_library:
            ...
            QMessageBox.warning(
                self,
                CivilCvCAD.Qt.translate("CAM", "Warning"),
                CivilCvCAD.Qt.translate("CAM", "Select a library first."),
            )
            return
    ...
    def _on_export_toolbit_requested(self):
        ...
        if not selected_toolbits:
            ...
            QMessageBox.warning(
                self,
                CivilCvCAD.Qt.translate("CAM", "Warning"),
                CivilCvCAD.Qt.translate("CAM", "Select a toolbit to export."),
            )
            return
        ...
        if len(selected_toolbits) > 1:
            ...
            QMessageBox.warning(
                self,
                CivilCvCAD.Qt.translate("CAM", "Warning"),
                CivilCvCAD.Qt.translate("CAM", "Select only one toolbit to export."),
            )
            return
