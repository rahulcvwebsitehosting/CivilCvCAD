...
class CamoticsToolBitSerializer(AssetSerializer):
    ...
    def get_label(cls) -> str:
        return CivilCvCAD.Qt.translate("CAM", "Camotics Tool")
    ...
    def deserialize(
        ...
        bit.set_diameter(CivilCvCAD.Units.Quantity(float(attrs["diameter"]), "mm"))
        bit.set_length(CivilCvCAD.Units.Quantity(float(attrs["length"]), "mm"))
        return bit
