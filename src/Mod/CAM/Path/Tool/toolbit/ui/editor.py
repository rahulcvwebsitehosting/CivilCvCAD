...
class ToolBitPropertiesWidget(QtGui.QWidget):
    ...
    def __init__(
        ...
        properties_group_box = QtGui.QGroupBox(CivilCvCAD.Qt.translate("CAM", "Properties"))
    ...
    def load_toolbit(self, toolbit: ToolBit):
        ...
        elif CivilCvCAD.ActiveDocument is None:
            setToolBitSchema()
...
class ToolBitEditor(QtGui.QWidget):
    ...
    def __init__(
        ...
        super().__init__(parent)
        self.form = CivilCvCADGui.PySideUic.loadUi(":/panels/ToolBitEditor.ui")
        ...
        self._original_schema = CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/Units").GetInt(
            "UserSchema", 6
        )
    ...
    def _refresh_property_editor(self):
        ...
        CivilCvCAD.Units.setSchema(self._original_schema)
