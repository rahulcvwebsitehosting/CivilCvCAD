...
class ToolBitBrowserWidget(QtGui.QWidget):
    ...
    def _on_item_double_clicked(self, item):
        ...
        try:
            ...
            QMessageBox.warning(
                self,
                CivilCvCAD.Qt.translate("CAM", "Missing Toolbit"),
            ...
            QMessageBox.critical(
                ...
                CivilCvCAD.Qt.translate("CAM", f"Failed to load toolbit: {e}"),
            )
    ...
    def _to_clipboard(
        ...
        mime_data = QMimeData()
        mime_type = "application/x-civilcvcad-toolbit-list-yaml"
    ...
    def _on_delete_requested(self):
        ...
        reply = QMessageBox.question(
            self,
            CivilCvCAD.Qt.translate("CAM", "Confirm Deletion"),
            CivilCvCAD.Qt.translate(
                "CAM",
