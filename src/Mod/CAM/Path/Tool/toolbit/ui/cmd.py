...
class CommandToolBitCreate:
    ...
    def Activated(self):
        ...
        obj = toolbit.attach_to_doc(CivilCvCAD.ActiveDocument)
...
class CommandToolBitSave:
    ...
    def Activated(self):
        ...
        dialog = AssetSaveDialog(ToolBit, toolbit_serializers, CivilCvCADGui.getMainWindow())
...
class CommandToolBitLoad:
    ...
    def Activated(self):
        dialog = ToolBitOpenDialog(toolbit_serializers, CivilCvCADGui.getMainWindow())
...
if CivilCvCAD.GuiUp:
    CivilCvCADGui.addCommand("CAM_ToolBitCreate", CommandToolBitCreate())
    CivilCvCADGui.addCommand("CAM_ToolBitLoad", CommandToolBitLoad())
    CivilCvCADGui.addCommand("CAM_ToolBitSave", CommandToolBitSave(False))
    CivilCvCADGui.addCommand("CAM_ToolBitSaveAs", CommandToolBitSave(True))
