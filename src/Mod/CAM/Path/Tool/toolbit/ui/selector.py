...
class ToolBitSelector(QtWidgets.QDialog):
    ...
    def __init__(
        ...
        parent=None,
        compact=False,
        button_label=CivilCvCAD.Qt.translate("CAM", "Add Tool"),
        show_all_tools=False,
    ):
        super().__init__(parent)

        self.setMinimumSize(700, 500)
        self.setWindowTitle(CivilCvCAD.Qt.translate("CAM", "Select Toolbit"))
        ...
        self._cancel_button = QtWidgets.QPushButton(CivilCvCAD.Qt.translate("CAM", "Cancel"))
