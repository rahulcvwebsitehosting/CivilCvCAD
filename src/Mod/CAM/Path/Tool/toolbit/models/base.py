...
class ToolBit(Asset, ABC):
    ...
    def from_shape(
        ...
        # Discussion: https://github.com/CivilCvCAD/CivilCvCAD/issues/21722
    ...
    def attach_to_doc(
        self, doc: CivilCvCAD.Document, label: Optional[str] = None
    ) -> CivilCvCAD.DocumentObject:
        """
        Creates a new CivilCvCAD DocumentObject in the given document and attaches
    ...
    def attach_to_obj(self, tool_doc_obj: CivilCvCAD.DocumentObject, label: Optional[str] = None):
        """
        Attaches the ToolBit instance to an existing CivilCvCAD DocumentObject.
    ...
    def onDelete(self, obj, arg2=None):
        ...
        if hasattr(self, "_recompute_observer"):
            CivilCvCAD.removeDocumentObserver(self._recompute_observer)
    ...
    def _setup_recompute_observer(self):
        ...
        if not hasattr(self, "_recompute_observer"):
            ...
            CivilCvCAD.addDocumentObserver(self._recompute_observer)
    ...
    def to_dict(self):
        ...
        for name in property_names:
            ...
            if value is None or isinstance(value, CivilCvCAD.DocumentObject):
                Path.Log.warning(
    ...
    def __getstate__(self):
        ...
        state["_shape_data"] = {
            ...
            "parameters": {
                ...
                if not isinstance(getattr(self.obj, name, None), CivilCvCAD.DocumentObject)
            },
        }
