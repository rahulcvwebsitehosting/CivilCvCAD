...
def Create(
    ...
    if CivilCvCAD.GuiUp and assignViewProvider:
    ...
    if assignTool:
        if not tool:
            ...
            tool = toolbit.attach_to_doc(doc=CivilCvCAD.ActiveDocument)
            if tool.ViewObject:
...
CivilCvCAD.Console.PrintLog("Loading Path.Tool.Gui.Controller... done\n")
