...
class OpTaskPanel:
    ...
    def __init__(self, obj, name, op):
        ...
        self.obj = obj
        self.op = op
        self.form = CivilCvCADGui.PySideUic.loadUi(":/panels/SetupOp.ui")
...
class TaskPanel:
    ...
    def __init__(self, vobj):
        ...
        self.globalForm = CivilCvCADGui.PySideUic.loadUi(":/panels/SetupGlobal.ui")
        ...
        CivilCvCAD.ActiveDocument.openTransaction("Edit SetupSheet")
