...
class ViewProvider(object):
    ...
    def setEdit(self, vobj, mode=0):
        ...
        CivilCvCADGui.Control.showDialog(taskPanel)
        taskPanel.setupUi()
        return True
...
class PropertyCreate(object):
    def __init__(self, obj, grp, typ, another):
        self.obj = obj
        self.form = CivilCvCADGui.PySideUic.loadUi(":panels/PropertyCreate.ui")
...
class TaskPanel(object):
    ...
    def __init__(self, vobj):
        ...
        self.form = CivilCvCADGui.PySideUic.loadUi(":panels/PropertyBag.ui")

        # initialized later
        self.model = None
        self.delegate = None
        CivilCvCAD.ActiveDocument.openTransaction("Edit PropertyBag")
...
def Create(name="PropertyBag"):
    ...
    CivilCvCAD.ActiveDocument.openTransaction("Create PropertyBag")
...
if CivilCvCAD.GuiUp:
    CivilCvCADGui.addCommand("CAM_PropertyBag", PropertyBagCreateCommand())

CivilCvCAD.Console.PrintLog("Loading PathPropertyBagGui… done\n")
