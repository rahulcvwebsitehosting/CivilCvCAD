...
class Instruction(object):
    ...
    def positionEnd(self):
        ...
        return CivilCvCAD.Vector(self.x(self.begin.x), self.y(self.begin.y), self.z(self.begin.z))
    ...
    def xyBegin(self):
        ...
        return CivilCvCAD.Vector(self.begin.x, self.begin.y, 0)

    def xyEnd(self):
        """xyEnd() ... internal convenience function"""
        return CivilCvCAD.Vector(self.x(self.begin.x), self.y(self.begin.y), 0)
...
class MoveArc(Instruction):
    ...
    def xyCenter(self):
        return CivilCvCAD.Vector(self.begin.x + self.i(), self.begin.y + self.j(), 0)
...
class Maneuver(object):
    ...
    def __init__(self, begin=None, instr=None):
        ...
        self.setPositionBegin(begin if begin else CivilCvCAD.Vector(0, 0, 0))
