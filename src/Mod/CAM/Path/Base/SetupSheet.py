...
class SetupSheet:
    ...
    def hasDefaultOperationHeights(self):
        if (
            ...
            != CivilCvCAD.Units.Quantity(self.DefaultSafeHeightOffset).UserString
        ):
            return False
        if (
            self.obj.ClearanceHeightOffset.UserString
            != CivilCvCAD.Units.Quantity(self.DefaultClearanceHeightOffset).UserString
        ):
            return False
    ...
    def expressionReference(self):
        ...
        #
        # https://forum.civilcvcad.org/viewtopic.php?f=10&t=24839
        # https://forum.civilcvcad.org/viewtopic.php?f=10&t=24845
