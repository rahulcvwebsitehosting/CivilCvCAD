...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    ...
    def getForm(self):
        """getForm() ... returns UI"""
        return CivilCvCADGui.PySideUic.loadUi(":/panels/PageOpProbeEdit.ui")
    ...
    def setFields(self, obj):
        ...
        self.form.Xoffset.setText(
            CivilCvCAD.Units.Quantity(obj.Xoffset.Value, CivilCvCAD.Units.Length).UserString
        )
        self.form.Yoffset.setText(
            CivilCvCAD.Units.Quantity(obj.Yoffset.Value, CivilCvCAD.Units.Length).UserString
        )
...
CivilCvCAD.Console.PrintLog("Loading PathProbeGui... done\n")
