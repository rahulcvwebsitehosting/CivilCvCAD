...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    ...
    def getForm(self):
        ...
        form = CivilCvCADGui.PySideUic.loadUi(":/panels/PageOpPocketFullEdit.ui")
    ...
    def setFields(self, obj):
        ...
        self.form.extraOffset.setText(
            CivilCvCAD.Units.Quantity(obj.ExtraOffset.Value, CivilCvCAD.Units.Length).UserString
        )
        ...
        self.form.angle.setText(CivilCvCAD.Units.Quantity(obj.Angle, CivilCvCAD.Units.Angle).UserString)
