...
def debugMsg(msg):
    global DEBUG
    if DEBUG:
        CivilCvCAD.Console.PrintMessage("PathSlotGui:: " + msg + "\n")
...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    ...
    def getForm(self):
        """getForm() ... returns UI"""
        debugMsg("getForm()")
        return CivilCvCADGui.PySideUic.loadUi(":/panels/PageOpSlotEdit.ui")
...
CivilCvCAD.Console.PrintLog("Loading PathSlotGui... done\n")
