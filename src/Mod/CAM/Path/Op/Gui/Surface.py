...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    ...
    def getForm(self):
        """getForm() ... returns UI"""
        form = CivilCvCADGui.PySideUic.loadUi(":/panels/PageOpSurfaceEdit.ui")
        comboToPropertyMap = [
    ...
    def getFields(self, obj):
        ...
        obj.DropCutterExtraOffset.x = CivilCvCAD.Units.Quantity(
            self.form.boundBoxExtraOffsetX.text()
        ).Value
        obj.DropCutterExtraOffset.y = CivilCvCAD.Units.Quantity(
    ...
    def setFields(self, obj):
        ...
        self.form.boundBoxExtraOffsetX.setText(
            CivilCvCAD.Units.Quantity(obj.DropCutterExtraOffset.x, CivilCvCAD.Units.Length).UserString
        )
        self.form.boundBoxExtraOffsetY.setText(
            CivilCvCAD.Units.Quantity(obj.DropCutterExtraOffset.y, CivilCvCAD.Units.Length).UserString
        )
        self.selectInComboBox(obj.DropCutterDir, self.form.dropCutterDirSelect)
        self.form.depthOffset.setText(
            CivilCvCAD.Units.Quantity(obj.DepthOffset.Value, CivilCvCAD.Units.Length).UserString
        )
        self.form.stepOver.setValue(obj.StepOver)
        self.form.sampleInterval.setText(
            CivilCvCAD.Units.Quantity(obj.SampleInterval.Value, CivilCvCAD.Units.Length).UserString
        )
...
CivilCvCAD.Console.PrintLog("Loading PathSurfaceGui... done\n")
