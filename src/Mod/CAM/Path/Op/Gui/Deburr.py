...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    ...
    def getForm(self):
        form = CivilCvCADGui.PySideUic.loadUi(self._ui_form)
    ...
    def initPage(self, obj):
        self.opImagePath = "{}Mod/CAM/Images/Ops/{}".format(CivilCvCAD.getHomePath(), "chamfer.svg")
    ...
    def setFields(self, obj):
        self.form.value_W.setText(
            CivilCvCAD.Units.Quantity(obj.Width.Value, CivilCvCAD.Units.Length).UserString
        )
        self.form.value_h.setText(
            CivilCvCAD.Units.Quantity(obj.ExtraDepth.Value, CivilCvCAD.Units.Length).UserString
        )
...
CivilCvCAD.Console.PrintLog("Loading PathDeburrGui... done\n")
