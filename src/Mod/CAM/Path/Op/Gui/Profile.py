...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    ...
    def getForm(self):
        ...
        form = CivilCvCADGui.PySideUic.loadUi(":/panels/PageOpProfileFullEdit.ui")
    ...
    def setFields(self, obj):
        ...
        self.form.extraOffset.setText(
            CivilCvCAD.Units.Quantity(obj.OffsetExtra.Value, CivilCvCAD.Units.Length).UserString
        )
        self.form.numPasses.setValue(obj.NumPasses)
        self.form.stepover.setText(
            CivilCvCAD.Units.Quantity(obj.Stepover.Value, CivilCvCAD.Units.Length).UserString
        )
...
CivilCvCAD.Console.PrintLog("Loading PathProfileGui ... done\n")
