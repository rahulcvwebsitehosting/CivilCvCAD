...
def fillThreads(form, dataFile, defaultSelect):
    ...
    with open("{}Mod/CAM/Data/Threads/{}".format(CivilCvCAD.getHomePath(), dataFile)) as fp:
...
class TaskPanelOpPage(PathCircularHoleBaseGui.TaskPanelOpPage):
    ...
    def getForm(self):
        """getForm() ... return UI"""
        form = CivilCvCADGui.PySideUic.loadUi(":/panels/PageOpThreadMillingEdit.ui")
        comboToPropertyMap = [
...
CivilCvCAD.Console.PrintLog("Loading PathThreadMillingGui ... done\n")
