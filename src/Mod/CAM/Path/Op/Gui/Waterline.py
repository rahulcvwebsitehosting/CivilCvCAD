...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    ...
    def getForm(self):
        """getForm() ... returns UI"""
        form = CivilCvCADGui.PySideUic.loadUi(":/panels/PageOpWaterlineEdit.ui")
        comboToPropertyMap = [
    ...
    def setFields(self, obj):
        ...
        self.form.boundaryAdjustment.setText(
            CivilCvCAD.Units.Quantity(obj.BoundaryAdjustment.Value, CivilCvCAD.Units.Length).UserString
        )
        self.form.stepOver.setValue(obj.StepOver)
        self.form.minSampleInterval.setText(
            CivilCvCAD.Units.Quantity(obj.MinSampleInterval.Value, CivilCvCAD.Units.Length).UserString
        )
...
CivilCvCAD.Console.PrintLog("Loading PathWaterlineGui... done\n")
