...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    def getForm(self):
        ...
        form = CivilCvCADGui.PySideUic.loadUi(":/panels/PageOpAdaptiveEdit.ui")
    ...
    def initPage(self, obj):
        ...
        self.form.stepOverDistance.setProperty(
            "unit", CivilCvCAD.Units.Quantity("1 mm").getUserPreferred()[2]
        )
    ...
    def setFields(self, obj):
        ...
        self.form.HelixMaxRampAngle.setText(
            CivilCvCAD.Units.Quantity(obj.HelixMaxRampAngle, CivilCvCAD.Units.Angle).UserString
        )

        self.form.HelixMaxPitch.setProperty("rawValue", obj.HelixMaxPitch.Value)

        self.form.HelixConeAngle.setText(
            CivilCvCAD.Units.Quantity(obj.HelixConeAngle, CivilCvCAD.Units.Angle).UserString
        )
