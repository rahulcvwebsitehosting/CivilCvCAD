...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    ...
    def getForm(self):
        """getForm() ... returns UI"""
        form = CivilCvCADGui.PySideUic.loadUi(":/panels/PageOpCustomEdit.ui")
    ...
    def setFileName(self):
        ...
        if not dirname:
            dirname = os.path.dirname(CivilCvCAD.activeDocument().FileName)
        filter1 = "All Files (*)"
...
CivilCvCAD.Console.PrintLog("Loading PathCustomGui... done\n")
