...
class ObjectOp(PathOp.ObjectOp):
    ...
    def _buildPathArea(self, obj, baseobject, isHole, start, getsim):
        ...
        areaParams["SectionTolerance"] = CivilCvCAD.Base.Precision.confusion() * 10  # basically 1e-06
        ...
        if getsim:
            ...
            simobj = sec.extrude(CivilCvCAD.Vector(0, 0, baseobject.BoundBox.ZMax))
    ...
    def _buildProfileOpenEdges(self, obj, openWire, start, getsim):
        ...
        for i in range(0, len(heights)):
            openWire.translate(CivilCvCAD.Vector(0, 0, heights[i] - openWire.BoundBox.ZMin))
            ...
            if Path.Geom.isRoughly(y, 0.0):
                y = 0.00001
            pathParams["start"] = CivilCvCAD.Vector(x, y, verts[0].Z)
