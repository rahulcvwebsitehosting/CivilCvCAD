...
class _TransformedShapeProxy:
    """Lightweight proxy that wraps a CivilCvCAD document object and intercepts
    ...
    Z-up geometry without the base class ever writing to a CivilCvCAD property
...
class ObjectOp(object):
    ...
    def __init__(self, obj, name, parentJob=None):
        ...
        obj.Workplane = CivilCvCAD.Vector(0, 0, 1)
    ...
    def updateDepths(self, obj, ignoreErrors=False):
        ...
        if hasattr(obj, "Base") and obj.Base:
            ...
            if matrix is not None:
                ...
                if rot is not None:
                    corners = [
                        CivilCvCAD.Vector(modelBB.XMin, modelBB.YMin, modelBB.ZMin),
                        CivilCvCAD.Vector(modelBB.XMax, modelBB.YMin, modelBB.ZMin),
                        CivilCvCAD.Vector(modelBB.XMin, modelBB.YMax, modelBB.ZMin),
                        CivilCvCAD.Vector(modelBB.XMax, modelBB.YMax, modelBB.ZMin),
                        CivilCvCAD.Vector(modelBB.XMin, modelBB.YMin, modelBB.ZMax),
                        CivilCvCAD.Vector(modelBB.XMax, modelBB.YMin, modelBB.ZMax),
                        CivilCvCAD.Vector(modelBB.XMin, modelBB.YMax, modelBB.ZMax),
                        CivilCvCAD.Vector(modelBB.XMax, modelBB.YMax, modelBB.ZMax),
                    ]
    ...
    def _setup_workplane_transform(self, obj):
        ...
        try:
            ...
            # Store as CivilCvCAD.Matrix for transformShape()
    ...
    def execute(self, obj):
        ...
        # This only touches plain Python attributes — no CivilCvCAD properties
