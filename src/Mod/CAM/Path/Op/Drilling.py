...
class ObjectDrilling(PathCircularHoleBase.ObjectOp):
    ...
    def _executeDrilling(self, obj, holes):
        ...
        edgelist = []
        for hole in holes:
            v1 = CivilCvCAD.Vector(hole["x"], hole["y"], obj.StartDepth.Value)
            v2 = CivilCvCAD.Vector(hole["x"], hole["y"], obj.FinalDepth.Value - endoffset)
        ...
        for edge in edgelist:
            ...
            if firstMove:  # Build manually
                ...
                target_at_safe_height = CivilCvCAD.Vector(startPoint.x, startPoint.y, safe_height)
