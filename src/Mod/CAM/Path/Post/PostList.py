...
class Postable:
    ...
    accidentally marking the original CivilCvCAD document objects dirty.
    ...
    Attributes:
        ...
        path:      Always a *copy* of the source path so mutations here never touch
                   the original CivilCvCAD document object.
...
def _wrap_tc(tc: Any) -> Postable:
    """Wrap a CivilCvCAD ToolController document object in a Postable.
...
def _wrap_op(op: Any) -> Postable:
    """Wrap a CivilCvCAD operation document object in a Postable.
