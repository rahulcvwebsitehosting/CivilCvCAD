...
class _HeaderBuilder:
    ...
    def add_exporter_info(self, exporter: str = "CivilCvCAD"):
...
class PostProcessor:
    ...
    def get_sanity_checks(self, job):
        ...
        Args:
            job: CivilCvCAD CAM job object to validate
    ...
    def _create_squawk(self, squawk_type, note):
        ...
        return {
            ...
            "squawkIcon": f"{CivilCvCAD.getHomePath()}Mod/CAM/Path/Main/Sanity/{icon_map.get(squawk_type, 'Sanity_Note')}.svg",
        }
