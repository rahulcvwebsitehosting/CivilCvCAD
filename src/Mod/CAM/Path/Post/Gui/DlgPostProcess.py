...
class PostProcessDialog:
    ...
    def __init__(self, job):
        self.job = job
        self.dialog = CivilCvCADGui.PySideUic.loadUi(":/panels/DlgPostProcess.ui")
    ...
    def _save_output_files(self):
        ...
        for fname, gcode in self._generated_outputs.items():
            try:
                ...
                CivilCvCAD.Console.PrintMessage(f"File written to {save_path}\n")
            except Exception as e:
