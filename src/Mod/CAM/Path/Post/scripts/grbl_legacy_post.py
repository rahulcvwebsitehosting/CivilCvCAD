...
def drill_translate(outstring, cmd, params):
    ...
    param_X = Units.Quantity(params["X"], CivilCvCAD.Units.Length)
    param_Y = Units.Quantity(params["Y"], CivilCvCAD.Units.Length)
    param_Z = Units.Quantity(params["Z"], CivilCvCAD.Units.Length)
    param_R = Units.Quantity(params["R"], CivilCvCAD.Units.Length)
