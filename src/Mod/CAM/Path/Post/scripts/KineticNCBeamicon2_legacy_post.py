...
# *   2021                                                                   *
# *                                                                          *
# *   This postprocessor is based on the linuxcnc_post coming with CivilCvCAD   *
...
CivilCvCAD, via the GUI importer or via python scripts with:
        ...
        for c in PathUtils.getPathWithPlacement(pathobj).Commands:
            ...
            if (
                ...
                if not OUTPUT_DOUBLES:
                    ...
                    pos = Units.Quantity(currLocation["R"], CivilCvCAD.Units.Length)
                    outstring.append(
