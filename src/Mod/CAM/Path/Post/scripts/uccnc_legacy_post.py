...
# See: https://wiki.civilcvcad.org/Path_Post
#      https://wiki.civilcvcad.org/Path_Postprocessor_Customization
...
Path/Tool folder, can be used directly from inside CivilCvCAD,
...
It was tested on CivilCvCAD v0.17, v0.18 and v0.19
...
HEADER = """(Exported by CivilCvCAD for {})
...
def export(objectslist, filename, argstring):
    ...
    if OUTPUT_HEADER:
        for line in HEADER.format(
            ...
            __name__,
            VERSION,
            CivilCvCAD.ActiveDocument.FileName,
            str(now),
        ).splitlines(False):
            if line:
                gcode += append(line + "\n")
