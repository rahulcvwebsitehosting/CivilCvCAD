...
def mkHeader(selection):
    ...
    # this is within a function, because otherwise filename and time don't change when changing the CivilCvCAD project
    #  now = datetime.datetime.now()
    now = time.strftime("%Y-%m-%d %H:%M")
    originfile = CivilCvCAD.ActiveDocument.FileName
