 ...
 *
 * For an application like CivilCvCAD, there are often cases where the same set of
 ...
 * CivilCvCAD's current xml python export.
 *
 * \section Debugging
 *
 ...
 * can use #PARAM_ENUM_EXCEPT to throw Base::ValueError exception in CivilCvCAD
 *
 ...
 * Helper macros for CivilCvCAD properties
 * \ingroup ParamHelper
 * @{*/
