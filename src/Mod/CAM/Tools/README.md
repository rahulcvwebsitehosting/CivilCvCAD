...
with CivilCvCAD should be installed analogous to TechDraw's templates.
...
1.  Create a new CivilCvCAD document.
...
1.  Save the document as a new file in the Shape directory.
    * Before saving the document, make sure you have _Save Thumbnail_
        selected, and _Add program logo_ deselected in CivilCvCAD's
        preferences.
