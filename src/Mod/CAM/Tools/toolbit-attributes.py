...
parser.add_argument("--civilcvcad", help="Directory CivilCvCAD binaries (libCivilCvCAD.so) if not installed")
args = parser.parse_args()

if args.civilcvcad:
    sys.path.append(args.civilcvcad)
...
for i, fname in enumerate(args.path):
    # print(fname)
    doc = CivilCvCAD.openDocument(fname, False)
