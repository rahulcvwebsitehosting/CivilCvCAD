...
class TestFileNameGenerator(unittest.TestCase):
    ...
    user macro: ~/.local/share/CivilCvCAD/Macro
    Job:  MainJob
    Operations:
        OutsideProfile
        DrillAllHoles
    ...
    def setUpClass(cls):
        ...
        cls.doc = CivilCvCAD.newDocument("TestFileNaming")
        cls.testfilename = cls.doc.Name
        cls.testfilepath = os.getcwd()
        cls.macro = CivilCvCAD.getUserMacroDir()
    ...
    def test000(self):
        ...
        CivilCvCAD.setActiveDocument(self.doc.Label)
        teststring = ""
...
class TestExport2Integration(unittest.TestCase):
    ...
    def setUpClass(cls):
        CivilCvCAD.ConfigSet("SuppressRecomputeRequiredDialog", "True")
        cls.doc = CivilCvCAD.newDocument("export2_test")
