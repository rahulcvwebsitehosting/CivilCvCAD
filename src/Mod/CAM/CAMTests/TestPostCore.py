...
class TestBuildPostList(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.doc = CivilCvCAD.newDocument("test_filenaming")
    ...
    def test095_operation_postable_tool_controller_is_postable(self):
        ...
        not the raw CivilCvCAD document object.
        ...
        Then: The returned value is a PostList.Postable instance (not a CivilCvCAD document object)
    ...
    def test096_operation_postable_tool_controller_is_isolated(self):
        ...
        a copy, so mutations do not propagate back to the real CivilCvCAD TC document object.
        ...
        Then: The original CivilCvCAD TC document object's Path is unchanged
    ...
    def test097_buildpostlist_does_not_touch_operations(self):
        ...
        operation state without side-effecting the CivilCvCAD document.  When operations are
...
class TestJobPropertyOverrides(unittest.TestCase):
    ...
    def setUpClass(cls):
        CivilCvCAD.ConfigSet("SuppressRecomputeRequiredDialog", "True")
        cls.doc = CivilCvCAD.newDocument("job_override_test")
