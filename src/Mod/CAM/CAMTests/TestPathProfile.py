...
class TestPathProfile(PathTestBase):
    ...
    @classmethod
    def initClass(cls):
        # Open existing CivilCvCAD document with test geometry
        cls.needsInit = False
        CivilCvCAD.ConfigSet("SuppressRecomputeRequiredDialog", "True")
        cls.doc = CivilCvCAD.open(CivilCvCAD.getHomePath() + "Mod/CAM/CAMTests/test_profile.fcstd")
    ...
    def tearDownClass(cls):
        ...
        is able to call static methods within this same class.
        """
        # CivilCvCAD.Console.PrintMessage("TestPathAdaptive.tearDownClass()\n")
    ...
    def test01(self):
        ...
        # CivilCvCAD.Console.PrintMessage("test01_moves: " + operationMoves + "\n")
    ...
    def test02(self):
        ...
        moves = getGcodeMoves(profile.Path.Commands, includeRapids=False)
        operationMoves = ";  ".join(moves)
        # CivilCvCAD.Console.PrintMessage("test02_moves: " + operationMoves + "\n")
    ...
    def test03(self):
        ...
        moves = getGcodeMoves(profile.Path.Commands, includeRapids=False)
        operationMoves = ";  ".join(moves)
        # CivilCvCAD.Console.PrintMessage("test03_moves: " + operationMoves + "\n")
...
class TestPathOpenProfile(PathTestBase):
    ...
    def setUpClass(cls):
        ...
        cls.doc = CivilCvCAD.newDocument("TestPathOpenProfile")
        CivilCvCAD.setActiveDocument(cls.doc.Name)
        ...
        v2 = CivilCvCAD.Vector(triangle_base, 0, 0)
        v3 = CivilCvCAD.Vector(triangle_base / 2.0, triangle_height, 0)
        ...
        triangle_solid = triangle_face.extrude(CivilCvCAD.Vector(0, 0, extrude_height))
        ...
        target_point = CivilCvCAD.Vector(0, 0, extrude_height)
        tolerance = 0.001
    ...
    def test02(self):
        ...
        move_lengths = []
        last = CivilCvCAD.Vector(0.0, 0.0, 0.0)
        ...
        left_leg = CivilCvCAD.Vector(self.triangle_base / 2.0, self.triangle_height, 0).normalize()
        base = CivilCvCAD.Vector(self.triangle_base, 0, 0).normalize()
        left_normal = CivilCvCAD.Vector(-left_leg.y, left_leg.x, 0)
        base_normal = CivilCvCAD.Vector(base.y, -base.x, 0)
