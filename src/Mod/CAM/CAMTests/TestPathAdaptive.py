...
class TestPathAdaptive(PathTestBase):
    ...
    def initClass(cls):
        ...
        cls.doc = CivilCvCAD.open(CivilCvCAD.getHomePath() + "Mod/CAM/CAMTests/test_adaptive.fcstd")
    ...
    def testFaceSingleSimple(self):
        ...
        # CivilCvCAD.Console.PrintMessage("test00_moves: " + operationMoves + "\n")
    ...
    def testOutlineWithCutout(self):
        ...
        minPoint = CivilCvCAD.Vector(sqrBB.XMin, sqrBB.YMin, 0.0)
        maxPoint = CivilCvCAD.Vector(sqrBB.XMax, sqrBB.YMax, 0.0)
    ...
    def testStockLimitsAwareness(self):
        ...
        # different stepdowns
        btall = Part.makeBox(17, 27, 11, CivilCvCAD.Vector(-1, -1, 0))
        bshort = Part.makeBox(42, 27, 6, CivilCvCAD.Vector(-1, -1, 0))
