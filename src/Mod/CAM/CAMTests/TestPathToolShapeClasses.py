...
class DummyShape(ToolBitShape):
    ...
    def __init__(self, id, **kwargs):
        ...
        self._defaults = {
            "Param1": CivilCvCAD.Units.Quantity("10 mm"),
            "Param2": CivilCvCAD.Units.Quantity("5 deg"),
        }
    ...
    def schema(cls) -> Mapping[str, Tuple[str, str]]:
        return {
            "Param1": (
                CivilCvCAD.Qt.translate("Param1", "Parameter 1"),
                "App::PropertyLength",
            ),
            "Param2": (
                CivilCvCAD.Qt.translate("Param2", "Parameter 2"),
                "App::PropertyAngle",
            ),
        }
...
class TestPathToolShapeClasses(PathTestWithAssets):
    ...
    def test_base_init_with_defaults(self):
        ...
        self.assertEqual(shape.get_parameter("Param1").Unit, CivilCvCAD.Units.Unit("mm"))
        self.assertEqual(shape.get_parameter("Param2").Value, 5.0)
        self.assertEqual(shape.get_parameter("Param2").Unit, CivilCvCAD.Units.Unit("deg"))
    ...
    def test_base_init_with_kwargs(self):
        ...
        shape = DummyShape(
            ...
            Param1=CivilCvCAD.Units.Quantity("20 mm"),
            Param3="Ignored",
        )
    ...
    def test_base_get_set_parameter(self):
        ...
        self.assertEqual(shape.get_parameter("Param1").Value, 10.0)
        self.assertEqual(shape.get_parameter("Param1").Unit, CivilCvCAD.Units.Unit("mm"))
        shape.set_parameter("Param1", CivilCvCAD.Units.Quantity("15 mm"))
    ...
    def test_base_get_parameters(self):
        ...
        shape = DummyShape(
            id="dummy_shape_4",
            filepath=Path("/fake/dummy.fcstd"),
            Param1=CivilCvCAD.Units.Quantity("12 mm"),
        )
        # Create mock quantity instances using the configured mock class
        expected_param1 = CivilCvCAD.Units.Quantity("12.0 mm")
        expected_param2 = CivilCvCAD.Units.Quantity("5.0 deg")
    ...
    def test_concrete_classes_instantiation(self):
        ...
        # No patching of CivilCvCAD document operations here.
        # The test relies on the actual CivilCvCAD environment.
    ...
    # should also not use mocks for CivilCvCAD document operations or Units.
    # They should rely on the actual CivilCvCAD environment and the
