...
mock_civilcvcad = MagicMock(Name="CivilCvCAD_Mock")
mock_civilcvcad.Console = MagicMock()
mock_civilcvcad.Console.PrintWarning = MagicMock()
mock_civilcvcad.Console.PrintError = MagicMock()
...
class TestPathToolShapeDoc(unittest.TestCase):
    ...
    def test_doc_get_object_properties_found(self):
        ...
        mock_civilcvcad.Console.PrintWarning.assert_not_called()

    def test_doc_get_object_properties_missing(self):
        """Test get_object_properties handles missing properties with warning."""
        # Re-import doc within the patch context to use the mocked CivilCvCAD
    ...
    @patch("CivilCvCAD.openDocument")
    @patch("CivilCvCAD.getDocument")
    @patch("CivilCvCAD.closeDocument")
