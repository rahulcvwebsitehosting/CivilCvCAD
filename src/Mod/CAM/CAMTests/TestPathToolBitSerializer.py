...
class _BaseToolBitSerializerTestCase(PathTestWithAssets):
    ...
    def setUp(self):
        ...
        self.test_tool_bit.set_diameter(CivilCvCAD.Units.Quantity("4.12 mm"))
        self.test_tool_bit.set_length(CivilCvCAD.Units.Quantity("15.0 mm"))
...
class TestCamoticsToolBitSerializer(_BaseToolBitSerializerTestCase):
    ...
    def test_deserialize(self):
        ...
        self.assertEqual(
            deserialized_bit.get_diameter(), CivilCvCAD.Units.Quantity(4.12, CivilCvCAD.Units.Length)
        )
        self.assertEqual(
            deserialized_bit.get_length(), CivilCvCAD.Units.Quantity(15.0, CivilCvCAD.Units.Length)
        )
...
class TestFCTBSerializer(_BaseToolBitSerializerTestCase):
    ...
    def test_serialize(self):
        ...
        self.assertEqual(
            CivilCvCAD.Units.Quantity(data.get("parameter", {}).get("Diameter")),
            CivilCvCAD.Units.Quantity(4.12, CivilCvCAD.Units.Length),
        )
        self.assertEqual(
            CivilCvCAD.Units.Quantity(data.get("parameter", {}).get("Length")),
            CivilCvCAD.Units.Quantity(15.0, CivilCvCAD.Units.Length),
        )
