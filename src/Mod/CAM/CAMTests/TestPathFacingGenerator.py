...
class TestPathFacingGenerator(PathTestBase):
    ...
    def setUp(self):
        ...
        self.circle_wire = Part.Wire(
            [Part.Circle(CivilCvCAD.Vector(5, 5, 0), CivilCvCAD.Vector(0, 0, 1), 5).toShape()]
        )
    ...
    def test_spiral_angled_rectangle(self):
        ...
        for x, y in corners:
            ...
            rotated_corners.append(CivilCvCAD.Vector(new_x, new_y, 0))
    ...
    def test_project_bounds_rectangular_wire(self):
        ...
        vec_x = CivilCvCAD.Vector(1, 0, 0)
        vec_y = CivilCvCAD.Vector(0, 1, 0)
    ...
    def test_generate_t_values_circular_wire(self):
        ...
        origin = self.circle_wire.BoundBox.Center
        step_vec = CivilCvCAD.Vector(0, 1, 0)
