...
class TestPostGCodes(PathTestUtils.PathTestBase):
    ...
    def setUpClass(cls):
        ...
        cls.doc = CivilCvCAD.open(CivilCvCAD.getHomePath() + "/Mod/CAM/CAMTests/boxtest.fcstd")
    ...
    #         # The current CivilCvCAD code treats G53 as modal (like G54-G59.9).
...
""",
    ...
    def test19120(self):
        ...
        #
        # Note that CivilCvCAD internal units are (mm or degrees) per second
