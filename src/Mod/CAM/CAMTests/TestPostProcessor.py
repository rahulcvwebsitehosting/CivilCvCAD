...
class TestResolvingPostProcessorName(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.doc = CivilCvCAD.newDocument("boxtest")
    ...
    def setUp(self):
        pref = CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/CAM")
...
class TestHeaderBuilder(unittest.TestCase):
    ...
    def test040_path_property_complete(self):
        ...
        builder.add_exporter_info("CivilCvCAD")
    ...
    def test050_path_property_partial(self):
        ...
        expected_commands = ["(Exported by CivilCvCAD)", "(T5=Drill)", "(Note: Partial test)"]
        ...
        # converted
        expected_gcode = "(Exported by CivilCvCAD)\n(T5=Drill)\n(Note: Partial test)\n"
        gcode = path.toGCode()
