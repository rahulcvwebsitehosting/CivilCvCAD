...
class TestPathStock(PathTestBase):
    def setUp(self):
        self.doc = CivilCvCAD.newDocument("TestPathStock")
    ...
    def tearDown(self):
        CivilCvCAD.closeDocument("TestPathStock")
    ...
    def test00(self):
        ...
        extent = CivilCvCAD.Vector(17, 13, 77)
        ...
        placement = CivilCvCAD.Placement(CivilCvCAD.Vector(-3, 88, 4), CivilCvCAD.Vector(0, 0, 1), 180)
    ...
    def test01(self):
        ...
        placement = CivilCvCAD.Placement(CivilCvCAD.Vector(3, 8, -4), CivilCvCAD.Vector(0, 0, 1), -90)
    ...
    def test10(self):
        ...
        self.assertEqual(orig.Width, stock.Width)
        self.assertEqual(orig.Height, stock.Height)
        self.assertPlacement(CivilCvCAD.Placement(), stock.Placement)

    def test11(self):
        """Verify FromTemplate cylinder creation."""
        radius = 7
        height = 12
        placement = CivilCvCAD.Placement(CivilCvCAD.Vector(99, 88, 77), CivilCvCAD.Vector(1, 1, 1), 123)
        ...
        self.assertPlacement(
            CivilCvCAD.Placement(CivilCvCAD.Vector(50, 100, 0), CivilCvCAD.Rotation()),
            stock.Placement,
        )

    def test12(self):
        """Verify FromTemplate from Base creation."""
        neg = CivilCvCAD.Vector(1, 2, 3)
        pos = CivilCvCAD.Vector(9, 8, 7)
