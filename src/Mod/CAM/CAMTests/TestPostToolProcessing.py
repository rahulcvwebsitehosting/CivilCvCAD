...
class TestToolLengthOffset(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.doc = CivilCvCAD.newDocument("TestToolLengthOffset")

    def tearDown(self):
        """Clean up test environment."""
        CivilCvCAD.closeDocument("TestToolLengthOffset")
...
class TestToolProcessing(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test environment."""
        self.doc = CivilCvCAD.newDocument("TestToolProcessing")
