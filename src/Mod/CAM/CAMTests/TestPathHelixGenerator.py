...
def _resetArgs():
    v1 = CivilCvCAD.Vector(5, 5, 20)
    v2 = CivilCvCAD.Vector(5, 5, 18)
...
G0 X11.250000 Y5.000000 Z23.000000"
    ...
    def test07(self):
        ...
        args = _resetArgs()
        v1 = CivilCvCAD.Vector(5, 5, 20)
        v2 = CivilCvCAD.Vector(5.0001, 5, 10)
        edg = Part.makeLine(v1, v2)
        args["edge"] = edg
        self.assertRaises(ValueError, generator.generate, **args)
        ...
        args = _resetArgs()
        v1 = CivilCvCAD.Vector(5, 5.0001, 20)
        v2 = CivilCvCAD.Vector(5, 5, 10)
        edg = Part.makeLine(v1, v2)
        args["edge"] = edg
        self.assertRaises(ValueError, generator.generate, **args)
    ...
    def test08(self):
        ...
        args = _resetArgs()
        v1 = CivilCvCAD.Vector(10, 5, 5)
        v2 = CivilCvCAD.Vector(20, 5, 5)
        edg = Part.makeLine(v1, v2)
        args["edge"] = edg
        self.assertRaises(ValueError, generator.generate, **args)
    ...
    def test09(self):
        ...
        args = _resetArgs()
        v1 = CivilCvCAD.Vector(5, 5, 18)
        v2 = CivilCvCAD.Vector(5, 5, 20)
        edg = Part.makeLine(v1, v2)
        args["edge"] = edg
    ...
    def test10(self):
        ...
        args = _resetArgs()
        v1 = CivilCvCAD.Vector(0, 0, 20)
        v2 = CivilCvCAD.Vector(0, 0, 18)
        edg = Part.makeLine(v1, v2)
        args["edge"] = edg
