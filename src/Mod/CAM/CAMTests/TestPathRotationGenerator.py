...
class TestPathRotationGenerator(PathTestUtils.PathTestBase):
    ...
    def _create_table_table_machine(self):
        ...
        machine.rotary_axes["C"] = RotaryAxis(
            name="C",
            rotation_vector=CivilCvCAD.Vector(0, 0, 1),
            min_limit=-360,
            max_limit=360,
        ...
        machine.rotary_axes["A"] = RotaryAxis(
            name="A",
            rotation_vector=CivilCvCAD.Vector(1, 0, 0),
            min_limit=-120,
            max_limit=120,
            role=AxisRole.TABLE_ROTARY,
            parent="C",
    ...
    def _create_head_head_machine(self):
        ...
        machine.rotary_axes["B"] = RotaryAxis(
            name="B",
            rotation_vector=CivilCvCAD.Vector(0, 1, 0),
            min_limit=-90,
            max_limit=90,
    ...
    def test00_identity_orientation(self):
        ...
        desired_axis = CivilCvCAD.Vector(0, 0, 1)  # Z-up
    ...
    def test10_forty_five_degree_tilt(self):
        ...
        desired_axis = CivilCvCAD.Vector(0.7071, 0, 0.7071).normalize()
    ...
    def test20_axis_limits_active(self):
        ...
        desired_axis = CivilCvCAD.Vector(0, 0.7071, 0.7071).normalize()
    ...
    def test30_head_head_machine(self):
        ...
        desired_axis = CivilCvCAD.Vector(0.5, 0.5, 0.7071).normalize()
    ...
    def test40_mixed_machine(self):
        ...
        desired_axis = CivilCvCAD.Vector(0.3, 0.4, 0.866).normalize()
    ...
    def test50_single_axis_solve(self):
        ...
        desired_axis = CivilCvCAD.Vector(0.866, 0, 0.5).normalize()
    ...
    def test70_current_state_awareness(self):
        ...
        """
        machine = self._create_table_table_machine()
        desired_axis = CivilCvCAD.Vector(0.5, 0.5, 0.5).normalize()
    ...
    def test100_no_rotary_axes(self):
        ...
        desired_axis = CivilCvCAD.Vector(0, 0, 1)
    ...
    def test110_sequential_solves(self):
        ...
        orientations = [
            CivilCvCAD.Vector(0, 0, 1),  # Start with Z-up
            CivilCvCAD.Vector(0.7071, 0, 0.7071),  # Tilt in X
            CivilCvCAD.Vector(0, 0.7071, 0.7071),  # Tilt in Y
            CivilCvCAD.Vector(0, 0, 1),  # Back to Z-up
        ]
    ...
    def test120_geometry_rotation_y_workplane(self):
        ...
        desired = CivilCvCAD.Vector(0, 1, 0)
    ...
    def test130_geometry_rotation_neg_x_workplane(self):
        ...
        """
        machine = self._create_ac_table_table_machine()
        desired = CivilCvCAD.Vector(-1, 0, 0)
    ...
    def test140_geometry_rotation_diagonal_workplane(self):
        ...
        """
        machine = self._create_ac_table_table_machine()
        desired = CivilCvCAD.Vector(0.5, 0.5, 0.5).normalize()
