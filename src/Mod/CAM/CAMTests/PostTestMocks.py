...
This module provides mock objects that simulate CivilCvCAD CAM job structure
without requiring disk I/O or loading actual CivilCvCAD documents.
"""
...
class MockToolController:
    ...
    def __init__(
        ...
        spindle_speed=1000,
        spindle_dir="Forward",
        feed=CivilCvCAD.Units.Quantity("1 mm/s"),
    ):
        self.Tool = MockTool()
...
def create_default_job_with_operation():
    ...
    tc = MockToolController(
        ...
        label="TC: Default Tool",
        spindle_speed=1000,
        feed=CivilCvCAD.Units.Quantity("10 mm/s"),
    )
    job.Tools.Group = [tc]
