...
class TestPathToolBit(PathTestWithAssets):
    ...
    def testBullnose(self):
        ...
        self.assertEqual(bullnose_bit.obj.Diameter, CivilCvCAD.Units.Quantity("5.0 mm"))
        self.assertEqual(bullnose_bit.obj.CornerRadius, CivilCvCAD.Units.Quantity("1.5 mm"))
