...
class TestPathThreadMillingGenerator(PathTestBase):
    ...
    def test00(self):
        ...
        gcode = [
            ...
            "G0 Z0.000000",
            "G1 Y3.000000",
            "G2 I0.000000 J-3.000000 Y-3.000000 Z0.500000",
            "G2 I0.000000 J3.000000 Y3.000000 Z1.000000",
            "G1 X0.000000 Y2.000000",
        ]
        self.assertEqual([p.toGCode() for p in path], gcode)
        self.assertCoincide(start, CivilCvCAD.Vector(0, 2, zFinal))
    ...
    def test01(self):
        ...
        gcode = [
            ...
            "G2 I0.000000 J-3.000000 Y-3.000000 Z0.500000",
            "G2 I0.000000 J3.000000 Y3.000000 Z1.000000",
            "G2 I0.000000 J-3.000000 Y-3.000000 Z1.500000",
            "G2 I0.000000 J3.000000 Y3.000000 Z2.000000",
            "G1 X0.000000 Y2.000000",
        ]
        self.assertEqual([p.toGCode() for p in path], gcode)
        self.assertCoincide(start, CivilCvCAD.Vector(0, 2, zFinal))
    ...
    def test03(self):
        ...
        gcode = [
            ...
            "G2 I0.000000 J-3.000000 Y-3.000000 Z1.500000",
            #'(------- finish-thread -------)',
            "G2 I0.000000 J3.000000 X-3.000000 Y0.000000 Z1.750000",
            #'(------- finish-thread -------)',
            "G1 X-2.000000 Y0.000000",
        ]
        self.assertEqual([p.toGCode() for p in path], gcode)
        self.assertCoincide(start, CivilCvCAD.Vector(-2, 0, zFinal))
    ...
    def test04(self):
        ...
        gcode = [
            ...
            "G0 Z0.000000",
            "G1 Y3.000000",
            "G3 I0.000000 J-3.000000 Y-3.000000 Z0.500000",
            "G3 I0.000000 J3.000000 Y3.000000 Z1.000000",
            "G3 I0.000000 J-3.000000 Y-3.000000 Z1.500000",
            #'(------- finish-thread -------)',
            "G3 I0.000000 J3.000000 X3.000000 Y0.000000 Z1.750000",
            #'(------- finish-thread -------)',
    ...
    def test10(self):
        ...
        gcode = [
            ...
            "G0 Z0.000000",
            #'(------- lead-in -------)',
            "G2 I0.000000 J0.500000 Y3.000000",
            #'(------- lead-in -------)',
            "G2 I0.000000 J-3.000000 Y-3.000000 Z0.500000",
            "G2 I0.000000 J3.000000 Y3.000000 Z1.000000",
            #'(------- lead-out -------)',
