...
class TestPropertyEditorFactory(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.obj.Length = CivilCvCAD.Units.Quantity(10.0)  # Set value separately
...
class TestQuantityPropertyEditorWidget(unittest.TestCase):
    ...
    def setUp(self):
        self.obj = DetachedDocumentObject()
        self.obj.addProperty("App::PropertyLength", "Length", "Base", "Length property")
        self.obj.Length = CivilCvCAD.Units.Quantity("10.0 mm")
    ...
    def test_update_property(self):
        ...
        self.assertEqual(
            self.editor.property("value"), CivilCvCAD.Units.Quantity(10.0, CivilCvCAD.Units.Length)
        )
        ...
        self.assertEqual(self.obj.Length, CivilCvCAD.Units.Quantity(12.0, CivilCvCAD.Units.Length))

        # Try assignment with unit.
        self.editor.lineEdit().setText("15.5 in")
        self.widget.updateProperty()
        updated_value = self.obj.getPropertyByName("Length")
        self.assertIsInstance(updated_value, CivilCvCAD.Units.Quantity)
        self.assertEqual(updated_value, CivilCvCAD.Units.Quantity("15.5 in"))
