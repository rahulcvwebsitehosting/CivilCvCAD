...
class TestPathToolLibrarySerializerBase(PathTestWithAssets):
    ...
    def setUp(self):
        ...
        shape1.set_parameter("Diameter", CivilCvCAD.Units.Quantity("6.0 mm"))
        shape1.set_parameter("Length", CivilCvCAD.Units.Quantity("20.0 mm"))
        tool1 = ToolBitEndmill(shape1, id="tool_1")
        tool1.label = "Endmill 6mm"

        shape2 = ToolBitShapeEndmill("endmill_2")
        shape2.set_parameter("Diameter", CivilCvCAD.Units.Quantity("3.0 mm"))
        shape2.set_parameter("Length", CivilCvCAD.Units.Quantity("15.0 mm"))
        tool2 = ToolBitEndmill(shape2, id="tool_2")
        tool2.label = "Endmill 3mm"

        shape3 = ToolBitShapeBallend("ballend_1")
        shape3.set_parameter("Diameter", CivilCvCAD.Units.Quantity("5.0 mm"))
        shape3.set_parameter("Length", CivilCvCAD.Units.Quantity("18.0 mm"))
...
class TestCamoticsLibrarySerializer(TestPathToolLibrarySerializerBase):
    ...
    def test_camotics_deserialize(self):
        ...
        self.assertEqual(
            tool_10._tool_bit_shape.get_parameter("Diameter"), CivilCvCAD.Units.Quantity("8 mm")
        )
        self.assertEqual(
            tool_10._tool_bit_shape.get_parameter("Length"), CivilCvCAD.Units.Quantity("25 mm")
        )
        ...
        self.assertEqual(
            tool_20._tool_bit_shape.get_parameter("Diameter"), CivilCvCAD.Units.Quantity("10 mm")
        )
        self.assertEqual(
            tool_20._tool_bit_shape.get_parameter("Length"), CivilCvCAD.Units.Quantity("30 mm")
        )
...
class TestLinuxCNCLibrarySerializer(TestPathToolLibrarySerializerBase):
    ...
    def test_linuxcnc_serialize(self):
        # TODO: this test uses the user-preferences for the tester's installed version of CivilCvCAD
        ...
        def format_D(v):
            ...
            as_quantity = CivilCvCAD.Units.Quantity(v)
