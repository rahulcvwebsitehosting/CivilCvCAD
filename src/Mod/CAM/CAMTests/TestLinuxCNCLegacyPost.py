...
class TestLinuxCNCLegacyPost(PathTestUtils.PathTestBase):
    ...
    def setUpClass(cls):
        ...
        CivilCvCAD.newDocument("Unnamed")
    ...
    def tearDownClass(cls):
        ...
        CivilCvCAD.closeDocument(CivilCvCAD.ActiveDocument.Name)
    ...
    def setUp(self):
        ...
        self.con = CivilCvCAD.Console
        self.docobj = CivilCvCAD.ActiveDocument.addObject("Path::Feature", "testpath")
        reload(
            postprocessor
    ...
    def tearDown(self):
        ...
        """
        CivilCvCAD.ActiveDocument.removeObject("testpath")
