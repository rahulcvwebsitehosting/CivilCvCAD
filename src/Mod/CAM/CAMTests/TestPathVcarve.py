...
class VbitTool:
    ...
    def __init__(self, dia, angle, tipDia):
        self.Diameter = CivilCvCAD.Units.Quantity(dia, CivilCvCAD.Units.Length)
        self.CuttingEdgeAngle = CivilCvCAD.Units.Quantity(angle, CivilCvCAD.Units.Angle)
        self.TipDiameter = CivilCvCAD.Units.Quantity(tipDia, CivilCvCAD.Units.Length)
...
class TestPathVcarve(PathTestWithAssets):
    ...
    def testFinishingPass(self):
        ...
        part1 = CivilCvCAD.ActiveDocument.addObject("Part::Feature", "TestShape")
        part2 = CivilCvCAD.ActiveDocument.addObject("Part::Feature", "TestShape")
    ...
    def test17(self):
        ...
        positionHistory = [
            CivilCvCAD.Base.Vector(0, 0, 0),  # previous position
            CivilCvCAD.Base.Vector(0, 1, 5),  # current position
        ]

        newPosition = CivilCvCAD.Base.Vector(0, 1.4, 3)
        assert PathVcarve.canSkipRepositioning(positionHistory, newPosition, 0.01)

        newPosition = CivilCvCAD.Base.Vector(0, 1.7, 3)
    ...
    def test18(self):
        ...
        newPosition = CivilCvCAD.Base.Vector(0, 0, 0)
        ...
        newPosition = CivilCvCAD.Base.Vector(0, 0.1, 0)
    ...
    def test19(self):
        ...
        newEdge = Part.Edge(
            Part.LineSegment(CivilCvCAD.Base.Vector(1, 2, 3), CivilCvCAD.Base.Vector(0, 1, 5))
        )
        ...
        newEdge = Part.Edge(
            Part.LineSegment(CivilCvCAD.Base.Vector(1, 2, 3), CivilCvCAD.Base.Vector(0, 0, 0))
        )
