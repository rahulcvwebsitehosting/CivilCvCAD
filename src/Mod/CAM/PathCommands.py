...
__title__ = "CivilCvCAD Path Commands"
    ...
    def Activated(self):
        ...
        if newSelection:
            ...
            for obj, names in newSelection:
                CivilCvCADGui.Selection.addSelection(obj, names)


if CivilCvCAD.GuiUp:
    CivilCvCADGui.addCommand("CAM_SelectLoop", _CommandSelectLoop())
...
if CivilCvCAD.GuiUp:
    CivilCvCADGui.addCommand("CAM_OpActiveToggle", _ToggleOperation())
...
class _CopyOperation:
    ...
    def Activated(self):
        ...
        for sel in selection:
            ...
            prevOpCopy = CivilCvCAD.ActiveDocument.copyObject(prevOp, False)
            while prevOp != sel:
                ...
                while op.Base != prevOp:
                    ...
                    op = op.Base
                opCopy = CivilCvCAD.ActiveDocument.copyObject(op, False)
...
if CivilCvCAD.GuiUp:
    CivilCvCADGui.addCommand("CAM_OperationCopy", _CopyOperation())
