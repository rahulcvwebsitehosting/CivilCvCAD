...
class SimpleEditPanel:
    """A simple property edit panel for a CivilCvCAD object
    ...
    def __init__(self, obj, view):
        ...
        CivilCvCAD.ActiveDocument.openTransaction(self._transaction_name)
        self.form = CivilCvCADGui.PySideUic.loadUi(self._ui_file)
        self._fc = {}
        self.setupUi()
