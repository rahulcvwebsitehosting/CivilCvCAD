...
{
    doCommand(Doc, "import MeshPartGui, CivilCvCADGui\nCivilCvCADGui.runCommand('MeshPart_Mesher')\n");
}
...
void CmdMeshTrimByPlane::activated(int)
{
    const char* cmd = "import MeshPartGui\n"
                      ...
                      "CivilCvCADGui.runCommand('MeshPart_TrimByPlane')\n";
    runCommand(Doc, cmd);
}
...
void CmdMeshSectionByPlane::activated(int)
{
    const char* cmd = "import MeshPartGui\n"
                      "import CivilCvCADGui\n"
                      "CivilCvCADGui.runCommand('MeshPart_SectionByPlane')\n";
    runCommand(Doc, cmd);
}
...
void CmdMeshCrossSections::activated(int)
{
    const char* cmd = "import MeshPartGui\n"
                      "import CivilCvCADGui\n"
                      "CivilCvCADGui.runCommand('MeshPart_CrossSections')\n";
    runCommand(Doc, cmd);
}
