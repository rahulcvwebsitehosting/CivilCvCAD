...
the default location ($USERAPPDATADIR/Mod/offline-documentation).</source>
      <translation>將其設定為自訂網址或說明文件所在的資料夾。
您可以使用附加元件管理員輕鬆下載文件以供離線使用
並安裝插入在 &quot;offline-documentation&quot;. 如果此
欄位留空，CivilCvCAD 將自動在預設位置
($USERAPPDATADIR/Mod/offline-documentation)搜尋說明文件。</translation>
    ...
    <message>
      ...
      <translation>CivilCvCAD Wiki (線上)</translation>
    </message>
    <message>
...
CivilCvCADwiki 網址為 the local documentation directory</translation>
    </message>
    <message>
...
&apos;Pandoc&apos; Python module should be installed for optimal results.</source>
      <translation>文件頁面將從 CivilCvCAD wiki 的自動 Markdown 轉換中
獲取, 託管於 CivilCvCAD&apos;s 的 GitHub 帳號. 這可以使用下面的自訂樣式表進行樣式設置
並且看起來比 wiki 選項更好. &apos;Markdown&apos; 或
...
This only applies if Markdown is selected above.</translation>
    ...
    <message>
      ...
      <translation>在 CivilCvCAD 標籤中</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>PySide QtWebEngineWidgets 模組不可用。說明產生是透過系統瀏覽器完成的</translation>
    </message>
    <message>
      <location filename="../../Help.py" line="86"/>
      <source>There is no Markdown renderer installed on your system, so this help page is rendered as is. Please install the Markdown or Pandoc Python modules to improve the rendering of this page.</source>
      <translation>您的系統上沒有安裝 Markdown 產生器，因此此說明頁面按原樣產生。請安裝 Markdown 或 Pandoc Python 模組以改善此頁面的產生。</translation>
    </message>
    <message>
