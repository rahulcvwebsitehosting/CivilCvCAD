...
the default location ($USERAPPDATADIR/Mod/offline-documentation).</source>
      <translation>将其设置为自定义 URL 或帮助文件所在文件夹。
您可以使用插件
管理器并安装 &quot;offline-documentation&quot; 附加组件，即可轻松下载文档供离线使用。如果此
字段留空，CivilCvCAD 将自动搜索帮助文件的默认位置
默认位置 ($USERAPPDATADIR/Mod/offline-documentation)。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>CivilCvCAD Wiki (在线)</translation>
    </message>
    <message>
      <location filename="../../dlgPreferencesHelp.ui" line="33"/>
      <source>GitHub (online)</source>
      <translation>GitHub (在线)</translation>
    </message>
    <message>
...
可以通过附加组件管理器下载文档以供离线使用，并安装“offline-documentation”附加组件。如果此字段留空，CivilCvCAD 将自动在默认位置（$USERAPPDATADIR/Mod/offline-documentation）搜索帮助文件。</translation>
    </message>
    <message>
...
CivilCvCADwiki at the local documentation directory</source>
      <translation>文档页面将从官方的
CivilCvCADwiki 在 the local documentation directory 获取。</translation>
    </message>
    <message>
...
&apos;Pandoc&apos; Python module should be installed for optimal results.</source>
      <translation>文档页面将从CivilCvCAD&apos;s GitHub 账户上的CivilCvCAD wiki自动Markdown 转换
获取。 这可以用下面的
自定义样式表样式表，并且看起来比wiki 选项更合适。 &apos;Markdown&apos; 或
&apos;Pandoc&apos; Python 模块应安装以取得最佳结果。</translation>
    </message>
    <message>
      <location filename="../../dlgPreferencesHelp.ui" line="145"/>
      <source>Markdown version (online)</source>
      <translation>Markdown 版本 (在线)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>文档将在 CivilCvCAD 界面的新标签页中打开。这需要 PySide QtWebengineWidgets 组件。</translation>
    </message>
    <message>
...
Requires the PySide QtWebengineWidgets component.</source>
      <translation>文档在 CivilCvCAD 中的可停靠对话框中打开，允许在 3D 视图中同时工作。
...
此设置仅适用于上方选择 Markdown 的情况。</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>无法检索此页面的内容。请检查菜单“编辑 → 偏好设置 → 常规 → 帮助”下的设置。</translation>
    </message>
    <message>
      <location filename="../../Help.py" line="78"/>
      <source>Help files location could not be determined. Please check settings under menu Edit → Preferences → General → Help</source>
      <translation>无法确定帮助文件的位置。请检查菜单“编辑 → 偏好设置 → 常规 → 帮助”下的设置。</translation>
    </message>
    <message>
