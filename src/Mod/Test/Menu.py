...
import CivilCvCAD, os, unittest, CivilCvCADGui

# ---------------------------------------------------------------------------
# define the functions to test the CivilCvCAD base code
# ---------------------------------------------------------------------------
...
class MenuCreateCases(unittest.TestCase):
    def setUp(self):
        ...
        CivilCvCAD.Console.PrintLog("Setup Test menu...\n")
        list = ["Test_TestAll", "Test_TestDoc", "Test_TestBase", "Test_TestWork"]
        w = CivilCvCADGui.getWorkbench("TestWorkbench")
        w.appendMenu("TestMenu", list)

    def testMenu(self):
        # check menu for items
        CivilCvCAD.Console.PrintLog("Checking Test menu...\n")
        w = CivilCvCADGui.getWorkbench("TestWorkbench")
        list = w.listMenus()
        self.b = False
        for i in list:
    ...
    def tearDown(self):
        if self.b:
            CivilCvCAD.Console.PrintLog("Test menu successfully added\n")
        else:
            CivilCvCAD.Console.PrintLog("Adding Test menu failed\n")


class MenuDeleteCases(unittest.TestCase):
    def setUp(self):
        CivilCvCADGui.activateWorkbench("TestWorkbench")
        CivilCvCAD.Console.PrintLog("Remove Test menu...\n")
        w = CivilCvCADGui.getWorkbench("TestWorkbench")
    ...
    def tearDown(self):
        if self.b:
            CivilCvCAD.Console.PrintLog("Test menu successfully removed\n")
        else:
            CivilCvCAD.Console.PrintLog("Removing Test menu failed\n")
