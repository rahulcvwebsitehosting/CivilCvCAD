...
# ---------------------------------------------------------------------------
# define the functions to test the CivilCvCAD Gui Document code
# ---------------------------------------------------------------------------
...
class TestGuiDocument(unittest.TestCase):
    ...
    def testGetTreeRootObject(self):
        ...
        root_objects = CivilCvCADGui.getDocument("TestDoc").TreeRootObjects
    ...
    def testIssue30418(self):
        ...
        gui = CivilCvCADGui.getDocument(self.doc)
    ...
    def testRefreshFallsBackToSyncForFeaturePython(self):
        params = CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/Document")
        ...
        try:
            ...
            CivilCvCADGui.runCommand("Std_Refresh", 0)
