...
- https://github.com/CivilCvCAD/CivilCvCAD/issues/26478

To run tests:
    CivilCvCAD -t TestTreeSelection.TestSelectAllInstances
"""

import unittest
import CivilCvCAD
import CivilCvCADGui
from CivilCvCADGui import Selection
...
class TestSelectAllInstances(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.doc = CivilCvCAD.newDocument("TestSelectAllInstances")
    ...
    def test_select_all_instances_with_mirror(self):
        ...
        mirror1.Source = rect
        mirror1.Normal = CivilCvCAD.Vector(1, 0, 0)
        mirror1.Base = CivilCvCAD.Vector(20, 0, 0)
        group.addObject(mirror1)

        mirror2 = self.doc.addObject("Part::Mirroring", "Rectangle (mirrored)001")
        mirror2.Source = rect
        mirror2.Normal = CivilCvCAD.Vector(0, 1, 0)
        mirror2.Base = CivilCvCAD.Vector(0, 20, 0)
        ...
        CivilCvCADGui.runCommand("Std_TreeSelectAllInstances", 0)
        CivilCvCADGui.updateGui()
    ...
    def test_select_all_instances_with_cuts(self):
        ...
        loosely taken from the below civilcvcad wiki page,
        https://wiki.civilcvcad.org/Std_TreeSelectAllInstances
        """
    ...
    def test_subelement_selection_preserved_on_tree_click(self):
        ...
        sketch.addGeometry(Part.LineSegment(CivilCvCAD.Vector(0, 0, 0), CivilCvCAD.Vector(10, 0, 0)))
        sketch.addGeometry(Part.LineSegment(CivilCvCAD.Vector(10, 0, 0), CivilCvCAD.Vector(10, 10, 0)))
        sketch.addGeometry(Part.LineSegment(CivilCvCAD.Vector(10, 10, 0), CivilCvCAD.Vector(0, 10, 0)))
        sketch.addGeometry(Part.LineSegment(CivilCvCAD.Vector(0, 10, 0), CivilCvCAD.Vector(0, 0, 0)))
        self.doc.recompute()
        CivilCvCADGui.updateGui()
