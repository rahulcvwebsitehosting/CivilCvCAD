...
<TS version="2.1" language="el" sourcelanguage="en">
  <context>
    ...
    <message>
      ...
      <translation>Δοκιμή Μονάδας CivilCvCAD</translation>
    </message>
    <message>
...
Κάντε διπλό κλικ σε οποιοδήποτε σφάλμα στο δενδροδιάγραμμα για να δείτε περισσότερες πληροφορίες, συμπεριλαμβανομένου του ίχνους της στοίβας.</translation>
    ...
    <message>
      ...
      <translation>Σχετικά με τον Έλεγχο Μονάδων του CivilCvCAD</translation>
    </message>
    <message>
...
Ο Έλεγχος Μονάδων του CivilCvCAD είναι μέρος του λογισμικού CivilCvCAD και υποστηρίζει την εγγραφή Ελέγχων Μονάδων για τις λειτουργικές μονάδες του εκάστοτε χρήστη.</translation>
    </message>
    <message>
