...
class PerfTestCase(unittest.TestCase):
    """
    Special Test Case that takes a list of filenames after the "--pass" parameter to CivilCvCAD, and
    runs a performance test by opening them, starting instrumentation, calling recompute(), and
    then saving results.

    Intended to be run as "<perf profiling>  CivilCvCAD -t TestPerf --pass <modelname>
