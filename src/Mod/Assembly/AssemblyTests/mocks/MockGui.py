...
"""
Mock classes for CivilCvCAD GUI testing.

This module provides mock implementations of CivilCvCAD and Qt classes
to enable unit testing without requiring the full CivilCvCAD environment.
"""
