...
def makeCompoundFilter(name, into_group=None):
    ...
    if into_group is None:
        into_group = CivilCvCAD.ActiveDocument
...
class _CompoundFilter:
    ...
    def execute(self, obj):
        ...
        if len(rst) == 0:
            ...
            # Feeding empty compounds to CivilCvCAD seems to cause rendering issues,
        ...
        if len(rst) > 1:
            ...
            sh.Placement = CivilCvCAD.Placement()
            obj.Shape = sh
        ...
        if not self.ViewObject.DontUnhideOnDelete:
            try:
                if self.Object.Base:
                    ...
                    # https://forum.civilcvcad.org/viewtopic.php?f=3&t=42242
                ...
                if hasattr(err, "message"):
                    ...
                    error_string = err
                CivilCvCAD.Console.PrintError("Error in onDelete: {}\n".format(error_string))
        return True
