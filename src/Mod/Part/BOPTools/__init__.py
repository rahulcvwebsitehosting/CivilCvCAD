...
__url__ = ""
__doc__ = """BOPTools Package (part of CivilCvCAD). Routines that power Connect, Embed, Cutout,
...
def addCommands():
    "addCommands(): add all GUI commands of BOPTools package to CivilCvCAD command manager."
