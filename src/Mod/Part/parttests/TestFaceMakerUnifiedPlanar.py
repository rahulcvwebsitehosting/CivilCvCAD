...
# =========================================================================
# Text glyph tests — uses the font bundled with CivilCvCAD (osifont)
# =========================================================================

_FONT_PATH = os.path.join(CivilCvCAD.getResourceDir(), "Mod", "TechDraw", "Resources", "fonts")
...
_PLANES = {
    "XY": CivilCvCAD.Placement(),
    "XZ": CivilCvCAD.Placement(Vec(0, 0, 0), CivilCvCAD.Rotation(Vec(1, 0, 0), 90)),
    "Tilted": CivilCvCAD.Placement(
        Vec(10, -20, 15), CivilCvCAD.Rotation(Vec(1, 0, 0), 45) * CivilCvCAD.Rotation(Vec(0, 0, 1), 30)
    ),
}
