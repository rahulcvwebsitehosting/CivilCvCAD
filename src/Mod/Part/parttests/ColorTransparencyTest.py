...
class ColorTransparencyTest(unittest.TestCase):
    ...
    def test_default_shape_transparency(self):
        """
        related: https://github.com/CivilCvCAD/CivilCvCAD/pull/11866
        related: https://github.com/CivilCvCAD/CivilCvCAD/pull/11586
        """
        transparency = 70
    ...
    def test_app_plane_transparency(self):
        """
        related: https://github.com/CivilCvCAD/CivilCvCAD/pull/12064
        """
