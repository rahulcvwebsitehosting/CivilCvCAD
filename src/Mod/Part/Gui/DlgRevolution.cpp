    ...
    try {
        ...
        for (auto item : items) {
            ...
            QString code = QStringLiteral(
                               "CivilCvCAD.ActiveDocument.addObject(\"%1\",\"%2\")\n"
                               "CivilCvCAD.ActiveDocument.%2.Source = CivilCvCAD.ActiveDocument.%3\n"
                               "CivilCvCAD.ActiveDocument.%2.Axis = (%4,%5,%6)\n"
                               "CivilCvCAD.ActiveDocument.%2.Base = (%7,%8,%9)\n"
                               "CivilCvCAD.ActiveDocument.%2.Angle = %10\n"
                               "CivilCvCAD.ActiveDocument.%2.Solid = %11\n"
                               "CivilCvCAD.ActiveDocument.%2.AxisLink = %12\n"
                               "CivilCvCAD.ActiveDocument.%2.Symmetric = %13\n"
                               "CivilCvCADGui.ActiveDocument.%3.Visibility = False\n"
            )
