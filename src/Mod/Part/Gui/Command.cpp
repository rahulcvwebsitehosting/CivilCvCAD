...
void CmdPartBox2::activated(int iMsg)
{
    ...
    doCommand(Doc, "from CivilCvCAD import Base");
...
void CmdPartRuledSurface::activated(int iMsg)
{
    ...
    doCommand(Doc, "CivilCvCAD.ActiveDocument.addObject('Part::RuledSurface', 'Ruled Surface')");
    doCommand(
        Doc,
        "CivilCvCAD.ActiveDocument.ActiveObject.Curve1=(CivilCvCAD.ActiveDocument.%s,['%s'])",
        obj1.c_str(),
        link1.c_str()
    );
    doCommand(
        Doc,
        "CivilCvCAD.ActiveDocument.ActiveObject.Curve2=(CivilCvCAD.ActiveDocument.%s,['%s'])",
        obj2.c_str(),
        link2.c_str()
    );
    commitCommand();
