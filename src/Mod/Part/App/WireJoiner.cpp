...
public:
        ...
        while (true) {
            ...
            for (int i = current->iStart[idx]; i < current->iEnd[idx]; ++i) {
                    ...
                    || edgeSet.contains(next))  // or, self intersect
                {
                    ...
                    // See
                    // https://github.com/realthunder/CivilCvCAD/blob/6f15849be2505f98927e75d0e8352185e14e7b72/src/Mod/Part/App/WireJoiner.cpp#L1141
                    // for reference.
    ...
    // https://github.com/realthunder/CivilCvCAD/blob/6f15849be2505f98927e75d0e8352185e14e7b72/src/Mod/Part/App/WireJoiner.cpp#L1366
    // for reference
