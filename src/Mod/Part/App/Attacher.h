...
enum eRefType
{
    ...
    rtFlagHasPlacement = 0x0100  // indicates that the linked shape is a whole CivilCvCAD object that
...
public:  // methods
     ...
     * flat faces in CivilCvCAD prior to introduction of Attacher. Set
