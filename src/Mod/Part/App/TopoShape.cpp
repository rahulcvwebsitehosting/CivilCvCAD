...
void TopoShape::exportStep(const char* filename) const
{
    try {
        ...
        // https://forum.civilcvcad.org/viewtopic.php?f=8&t=52967
        makeHeader.SetAuthorValue(1, new TCollection_HAsciiString("CivilCvCAD"));
        makeHeader.SetOrganizationValue(1, new TCollection_HAsciiString("CivilCvCAD"));
        makeHeader.SetOriginatingSystem(new TCollection_HAsciiString("CivilCvCAD"));
        makeHeader.SetDescriptionValue(1, new TCollection_HAsciiString("CivilCvCAD Model"));
...
{
    // https://forum.civilcvcad.org/viewtopic.php?f=3&t=1445
    // https://forum.civilcvcad.org/viewtopic.php?f=3&t=52719
    // Build a torus
    gp_Circ circle;
...
bool TopoShape::fix()
{
    ...
    // will affect the input shape. (See // https://github.com/realthunder/CivilCvCAD/issues/585,
    ...
    if (aChecker.IsValid()) {
        ...
        // the input shape.
        //
        // See https://github.com/realthunder/CivilCvCAD/issues/595. Sketch001
