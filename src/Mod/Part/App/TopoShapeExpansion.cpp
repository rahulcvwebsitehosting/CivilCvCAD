...
)
{
    ...
    // https://forum.civilcvcad.org/viewtopic.php?f=8&t=24052
    //
    ...
    do {
        ...
        for (auto it = faces.begin(); it != faces.end(); ++it) {
            ...
            if (!mkDraft.AddDone()) {
                ...
                //       http://forum.civilcvcad.org/viewtopic.php?f=10&t=3209&start=10#p25341 The
...
TopoShape TopoShape::splitWires(std::vector<TopoShape>* innerWiresOutput, SplitWireReorient reorient) const
{
    ...
    // (https://forum.civilcvcad.org/viewtopic.php?p=446006#p445674)
    //
