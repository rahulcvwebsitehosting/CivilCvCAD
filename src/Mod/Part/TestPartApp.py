...
import CivilCvCAD, unittest, Part
import copy
import math
...
class PartTestCases(unittest.TestCase):
    def setUp(self):
        self.Doc = CivilCvCAD.newDocument("PartTest")
    ...
    def tearDown(self):
        # closing doc
        CivilCvCAD.closeDocument("PartTest")
...
class PartTestBSplineCurve(unittest.TestCase):
    ...
    def testIssue2671(self):
        if "BUILD_SPREADSHEET" in CivilCvCAD.__cmake__:
...
class PartTestRuledSurface(unittest.TestCase):
    ...
    def testRuledSurfaceFromTwoObjects(self):
        line1 = Part.makeLine(CivilCvCAD.Vector(-70, -30, 0), CivilCvCAD.Vector(-50, 40, 0))
        line2 = Part.makeLine(CivilCvCAD.Vector(-40, -30, 0), CivilCvCAD.Vector(-40, 10, 0))
        plm1 = CivilCvCAD.Placement()
        plm1.Rotation = CivilCvCAD.Rotation(0.7071067811865476, 0.0, 0.0, 0.7071067811865475)
    ...
    def testRuledSurfaceFromTwoObjectsWithSharedVertexs(self):
        ...
        # Arrange
        line = Part.makeLine(CivilCvCAD.Vector(0, 0, 50), CivilCvCAD.Vector(0, -50, 0))
        line1 = Part.makeLine(CivilCvCAD.Vector(0, 0, 50), CivilCvCAD.Vector(50, 0, 0))
        line2 = Part.makeLine(CivilCvCAD.Vector(0, 0, 0), CivilCvCAD.Vector(0, -50, 0))
        line3 = Part.makeLine(CivilCvCAD.Vector(0, 0, 0), CivilCvCAD.Vector(50, 0, 0))
    ...
    def testRuledSurfaceFromOneObject(self):
        if "BUILD_SKETCHER" in CivilCvCAD.__cmake__:
            sketch = self.Doc.addObject("Sketcher::SketchObject", "Sketch")
            sketch.Placement = CivilCvCAD.Placement(
                CivilCvCAD.Vector(0.000000, 0.000000, 0.000000),
...
class GeometryCurve(unittest.TestCase):
    def testProject(self):
        line = Part.Line()
        line.projectPoint(CivilCvCAD.Vector())
...
class PartExtrusionTests(unittest.TestCase):
    ...
    def setUp(self):
        self.Doc = CivilCvCAD.newDocument("PartExtrusionTest")
    ...
    def tearDown(self):
        CivilCvCAD.closeDocument("PartExtrusionTest")
...
class PartFaceMakerBuildFaceTests(unittest.TestCase):
    ...
    def setUp(self):
        self.Doc = CivilCvCAD.newDocument("FaceMakerBuildFaceTest")

    def tearDown(self):
        CivilCvCAD.closeDocument("FaceMakerBuildFaceTest")
