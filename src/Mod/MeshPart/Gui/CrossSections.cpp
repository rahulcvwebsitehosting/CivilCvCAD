...
void CrossSections::apply()
{
    ...
    try {
        ...
        Gui::Command::runCommand(Gui::Command::App, "from CivilCvCAD import Base\n");
        ...
        for (std::vector<App::DocumentObject*>::iterator it = obj.begin(); it != obj.end(); ++it) {
            ...
            Gui::Command::runCommand(
                Gui::Command::App,
                QStringLiteral(
                    "points=CivilCvCAD.getDocument(\"%1\").%2.Mesh.crossSections(%3, %4, %5)\n"
                    "wires=[]\n"
                    "for i in points:\n"
            ...
            Gui::Command::runCommand(
                ...
                QStringLiteral(
                    ...
                    "slice=CivilCvCAD.getDocument(\"%1\").addObject(\"Part::Feature\",\"%2\")\n"
                    "slice.Shape=comp\n"
                    "slice.purgeTouched()\n"
