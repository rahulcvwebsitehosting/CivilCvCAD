...
__title__ = "CivilCvCAD Arch External Reference"
    ...
    def execute(self, obj):
        ...
        if filename and self.reload and obj.ReferenceMode in ["Normal", "Transient"]:
            ...
            if self.parts:
                ...
                hGrp = CivilCvCAD.ParamGet(loc).GetGroup("RefDxfImport")
...
class ViewProviderArchReference:
    ...
    def onOpen(self):
        ...
        if hasattr(self, "Object") and self.Object:
            if self.Object.File:
                CivilCvCAD.openDocument(self.Object.File)
    ...
    def loadInventor(self, obj):
        ...
        if not ivstring:
            ...
            CivilCvCAD.Console.PrintWarning(t + " " + obj.Label + "\n")
            return
        ...
        if not isinstance(lwnode, coin.SoSeparator):
            ...
            CivilCvCAD.Console.PrintError(t + " " + obj.Label + "\n")
            return
    ...
    def accept(self):
        ...
        if self.partCombo.currentText():
            ...
            if i >= 1:
                ...
                self.obj.Part = ""
            QtCore.QTimer.singleShot(0, CivilCvCAD.ActiveDocument.recompute)
    ...
    def openFile(self):
        ...
        if self.obj.File:
            if self.obj.File.lower().endswith(".fcstd"):
                CivilCvCAD.openDocument(self.obj.File)
            else:
                CivilCvCAD.loadFile(self.obj.File)
            CivilCvCADGui.Control.closeDialog()
            CivilCvCADGui.ActiveDocument.resetEdit()
