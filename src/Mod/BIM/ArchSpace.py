...
__title__ = "CivilCvCAD Arch Space"
    ...
    def getShape(self, obj):
        ...
        if shape:
            ...
            if not bb:
                ...
                return
            shape = Part.makeBox(
                bb.XLength, bb.YLength, bb.ZLength, CivilCvCAD.Vector(bb.XMin, bb.YMin, bb.ZMin)
            )
        ...
        if hasattr(vobj, "TextPosition"):
            ...
            if DraftVecUtils.isNull(vobj.TextPosition):
                try:
                    ...
                    pos = CivilCvCAD.Vector(pos.x, pos.y, z)
    ...
    def addBoundary(self):
        if self.obj:
            if CivilCvCADGui.Selection.getSelectionEx():
                self.obj.Proxy.addSubobjects(self.obj, CivilCvCADGui.Selection.getSelectionEx())
                self.updateBoundaries()
