...
__title__ = "CivilCvCAD Arch Floor"
...
def makeFloor(objectslist=None, baseobj=None, name=None):
    ...
    if not CivilCvCAD.ActiveDocument:
        ...
        return
    obj = CivilCvCAD.ActiveDocument.addObject("App::DocumentObjectGroupPython", "Floor")
...
class _CommandFloor:
    ...
    https://wiki.civilcvcad.org/Arch_Floor
    """
...
Floor creation aborted.",
            ...
            ss += "]"
            CivilCvCAD.ActiveDocument.openTransaction(translate("Arch", "Create Floor"))
            CivilCvCADGui.addModule("Arch")
            CivilCvCADGui.doCommand("obj = Arch.makeFloor(" + ss + ")")
...
class _Floor(ArchIFC.IfcProduct):
    ...
    about groups here: https://wiki.civilcvcad.org/Std_Group
...
if CivilCvCAD.GuiUp:
    CivilCvCADGui.addCommand("Arch_Floor", _CommandFloor())
