...
__title__ = "CivilCvCAD Precast concrete module"
...
class _PrecastTaskPanel:
    ...
    def __init__(self):
        ...
        self.valueChamfer = CivilCvCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueDentLength = CivilCvCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueDentWidth = CivilCvCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueDentHeight = CivilCvCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueBase = CivilCvCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueHoleMajor = CivilCvCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueHoleMinor = CivilCvCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueHoleSpacing = CivilCvCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueGrooveDepth = CivilCvCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueGrooveHeight = CivilCvCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueGrooveSpacing = CivilCvCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueDownLength = CivilCvCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueRiser = CivilCvCADGui.UiLoader().createWidget("Gui::InputField")
        self.grid.addWidget(self.labelRiser, 17, 0, 1, 1)
        self.grid.addWidget(self.valueRiser, 17, 1, 1, 1)

        self.labelTread = QtGui.QLabel()
        self.valueTread = CivilCvCADGui.UiLoader().createWidget("Gui::InputField")
    ...
    def restoreValue(self, widget, val):
        widget.setText(CivilCvCAD.Units.Quantity(val, CivilCvCAD.Units.Length).UserString)
...
class _DentsTaskPanel:
    ...
    def __init__(self):
        ...
        self.valueOffset = CivilCvCADGui.UiLoader().createWidget("Gui::InputField")
    ...
    def editDent(self, item=None):
        if self.listDents.currentItem():
            ...
            self.valueLength.setText(
                CivilCvCAD.Units.Quantity(float(s[0]), CivilCvCAD.Units.Length).UserString
            )
            self.valueWidth.setText(
                CivilCvCAD.Units.Quantity(float(s[1]), CivilCvCAD.Units.Length).UserString
            )
            self.valueHeight.setText(
                CivilCvCAD.Units.Quantity(float(s[2]), CivilCvCAD.Units.Length).UserString
            )
            self.valueSlant.setText(
                CivilCvCAD.Units.Quantity(float(s[3]), CivilCvCAD.Units.Length).UserString
            )
            self.valueLevel.setText(
                CivilCvCAD.Units.Quantity(float(s[4]), CivilCvCAD.Units.Length).UserString
            )
            self.valueRotation.setCurrentIndex(self.RotationAngles.index(int(s[5])))
            self.valueOffset.setText(
                CivilCvCAD.Units.Quantity(float(s[6]), CivilCvCAD.Units.Length).UserString
            )
...
def makePrecast(
    ...
    if precasttype == "Beam":
        obj = CivilCvCAD.ActiveDocument.addObject("Part::FeaturePython", "Beam")
        _PrecastBeam(obj)
        obj.Length = length
        obj.Width = width
        obj.Height = height
        ...
        obj = CivilCvCAD.ActiveDocument.addObject("Part::FeaturePython", "Pillar")
        _PrecastPillar(obj)
        obj.Length = length
        obj.Width = width
        obj.Height = height
        ...
        obj = CivilCvCAD.ActiveDocument.addObject("Part::FeaturePython", "Panel")
        _PrecastPanel(obj)
        obj.Length = length
        obj.Width = width
        obj.Height = height
        ...
        obj = CivilCvCAD.ActiveDocument.addObject("Part::FeaturePython", "Slab")
        _PrecastSlab(obj)
        ...
        obj = CivilCvCAD.ActiveDocument.addObject("Part::FeaturePython", "Precast")
        _Precast(obj)
    if CivilCvCAD.GuiUp:
