...
def makeBuilding(objectslist=None, name=None):
    ...
    if not CivilCvCAD.ActiveDocument:
        ...
        return
    obj = CivilCvCAD.ActiveDocument.addObject("App::DocumentObjectGroupPython", "Building")
...
Building creation aborted.",
            ...
            CivilCvCADGui.doCommand("obj = Arch.makeBuilding(" + ss + ")")
...
if CivilCvCAD.GuiUp:
    ...
    CivilCvCADGui.addCommand("Arch_Building", _CommandBuilding())
