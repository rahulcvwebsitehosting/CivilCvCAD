...
def get_axis_bubble_data(obj, vobj):
    ...
    Returns:
        tuple[list[Part.Shape], list[tuple[str, CivilCvCAD.Vector]]]
    """
    bubble_shapes = []
    bubble_texts = []
                    ...
                    if obj.Shape.Edges:
                        ...
                        for i, cir in enumerate(bubbles):
                            ...
                            if z_vec.getAngle(normal) < math.pi / 4:
                                ...
                                up_vec = CivilCvCAD.Vector(0, 1, 0)
                            else:
                                # Use the global Z-axis as the up_vec.
                                up_vec = z_vec
                            rot_local = CivilCvCAD.Rotation(
                            ...
                            offset_world = CivilCvCAD.Vector(0, -fs / 2.5, 0)
                ...
                for i in range(n):
                    if obj.Labels[i]:
                        ...
                        if hasattr(vobj, "LabelOffset"):
                            pl = CivilCvCAD.Placement(vobj.LabelOffset)
