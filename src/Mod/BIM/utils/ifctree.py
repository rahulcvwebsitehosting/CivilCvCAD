...
"""
This module recreates the whole structure of an IFC file in CivilCvCAD (ie.
one CivilCvCAD object per IFC entity). It serves mostly as a proof of concept
...
def create(ifcentity):
    ...
    if obj:
        return obj
    obj = CivilCvCAD.ActiveDocument.addObject("App::FeaturePython", name)
...
lenobjects = str(len(CivilCvCAD.ActiveDocument.Objects)) + " objects"
