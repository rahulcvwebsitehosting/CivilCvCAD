...
"""Build IFC property-set CSV files from a local psd.zip archive."""
...
if not os.path.isfile("psd.zip"):
    raise SystemExit("Place psd.zip beside this script before running it offline.")
