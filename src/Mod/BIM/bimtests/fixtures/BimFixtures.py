...
def create_test_model(document, **overrides):
    ...
    p1 = CivilCvCAD.Vector(0, 0, 0)
    p2 = CivilCvCAD.Vector(building_length, 0, 0)
    p3 = CivilCvCAD.Vector(building_length, building_width, 0)
    p4 = CivilCvCAD.Vector(0, building_width, 0)
    ...
    p5 = CivilCvCAD.Vector(building_length / 2, 0, 0)
    p6 = CivilCvCAD.Vector(building_length / 2, building_width, 0)
    ...
    door.Placement = CivilCvCAD.Placement(
        CivilCvCAD.Vector(800, 0, 0), CivilCvCAD.Rotation(CivilCvCAD.Vector(1, 0, 0), 90)
    )
    ...
    window.Placement = CivilCvCAD.Placement(
        CivilCvCAD.Vector(building_length, building_width / 2, 900),
        CivilCvCAD.Rotation(CivilCvCAD.Vector(0, 1, 0), 270),
    )
    ...
    living_box.Placement.Base = CivilCvCAD.Vector(building_length / 2, 0, 0)
    ...
    column.Placement.Base = CivilCvCAD.Vector(
    ...
    beam.IfcType = "Beam"
    beam.Placement = CivilCvCAD.Placement(
        CivilCvCAD.Vector(0, building_width / 2, interior_wall_height), CivilCvCAD.Rotation()
    )
    ...
    slab_profile = Draft.makeRectangle(
        ...
        placement=CivilCvCAD.Placement(CivilCvCAD.Vector(0, 0, interior_wall_height), CivilCvCAD.Rotation()),
    )
    ...
    roof_profile = Draft.makeRectangle(
        ...
        placement=CivilCvCAD.Placement(
            CivilCvCAD.Vector(-roof_overhang, -roof_overhang, ground_floor_height), CivilCvCAD.Rotation()
        ),
    )
    doc.recompute()
    ...
    generic_box.Placement.Base = CivilCvCAD.Vector(building_length + 1000, building_width + 1000, 0)
