...
class TestArchWall(TestArchBase.TestArchBase):
    ...
    def test_wall_makeblocks(self):
        ...
        This is a regression test for https://github.com/CivilCvCAD/CivilCvCAD/issues/26982,
        a unit test for https://github.com/CivilCvCAD/CivilCvCAD/issues/27817, and a basic, functional test for the
    ...
    def test_baseless_wall_offset(self):
        ...
        Regression test for https://github.com/CivilCvCAD/CivilCvCAD/issues/29256.
        """
