...
class TestWebGLExportGui(TestArchBase):
    ...
    @patch("BIM.importers.importWebGL.CivilCvCADGui")
    ...
    def test_export_returns_false_when_no_template(self):
        ...
        with patch("BIM.importers.importWebGL.getHTMLTemplate", return_value=None):
            with patch("BIM.importers.importWebGL.CivilCvCADGui") as mock_gui:
    ...
    def test_export_returns_true_when_template_available(self):
        ...
        with patch(
            ...
            with patch("BIM.importers.importWebGL.CivilCvCAD.ActiveDocument") as mock_doc:
