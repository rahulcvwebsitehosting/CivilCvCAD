...
class TestArchReport(TestArchBase.TestArchBase):
    ...
    def setUp(self):
        ...
        self.wall_ext.Height = CivilCvCAD.Units.Quantity(
            3000, "mm"
        ...
        self.wall_int.Height = CivilCvCAD.Units.Quantity(2500, "mm")  # Store as Quantity
    ...
    @patch("CivilCvCAD.Console.PrintError")
    ...
    def test_count_property_vs_count_star(self):
        ...
        # dependent on CivilCvCAD's internal naming schemes.
        labels_to_count = [
            self.wall_ext.Label,
            self.wall_int.Label,
            self.column.Label,
    ...
    def test_core_engine_enhancements_for_pipeline(self):
        ...
        with self.subTest(description="Test _run_query with a source_objects list"):
            ...
            # c) The new third return value, `resulting_objects`, should contain the correct CivilCvCAD objects.
            self.assertEqual(
    ...
    def test_public_api_for_pipelines(self):
        ...
        with self.subTest(description="Test Arch.selectObjectsFromPipeline"):
            ...
            self.assertIsInstance(resulting_objects[0], CivilCvCAD.DocumentObject)
            self.assertEqual(
    ...
    def test_default_header_uses_internal_units(self):
        ...
        original_schema_index = CivilCvCAD.Units.getSchema()

        try:
            # Get the list of available schema names.
            schema_names = CivilCvCAD.Units.listSchemas()
            ...
            CivilCvCAD.Units.setSchema(meter_schema_index)
            ...
            CivilCvCAD.Units.setSchema(original_schema_index)
    ...
    def test_numeric_comparisons_on_quantities(self):
        ...
        try:
            ...
            CivilCvCAD.Units.setSchema(mks_schema_index)
