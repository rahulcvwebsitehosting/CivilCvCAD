...
class TestArchComponent(TestArchBase.TestArchBase):
    ...
    def testBsplineSlabAreas(self):
        ...
        See https://github.com/CivilCvCAD/CivilCvCAD/issues/20989.
        """
    ...
    def testHouseSpaceAreas(self):
        ...
        See https://github.com/CivilCvCAD/CivilCvCAD/issues/14687.
        """
    ...
    def test_remove_single_window_from_wall_host_is_none(self):
        ...
        See https://github.com/CivilCvCAD/CivilCvCAD/issues/21551
        """
    ...
    def test_rotated_component_area(self):
        ...
        # CivilCvCAD sums all vertical faces (front + back + vertical side edges).
