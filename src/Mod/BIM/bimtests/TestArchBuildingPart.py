...
class TestArchBuildingPart(TestArchBase.TestArchBase):
    ...
    def test_nativeifc_aggregate_storey_pset_respects_file_scale(self):
        ...
        self.assertTrue(
            ifc_tools.restore_CivilCvCAD_property(
                floor,
                object(),
                "Height",
                object(),
    ...
    def test_nativeifc_aggregate_storey_preserves_level_data(self):
        ...
        pset = self._get_pset(element, "CivilCvCADPropertySet")
        ...
        self.assertAlmostEqual(prop_values["CivilCvCAD_Height"], 3.0, delta=1e-6)
        self.assertAlmostEqual(prop_values["CivilCvCAD_LevelOffset"], 0.125, delta=1e-6)
