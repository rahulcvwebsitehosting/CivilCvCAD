...
class TestArchWallGui(TestArchBaseGui.TestArchBaseGui):
    ...
    def setUp(self):
        ...
        super().setUp()
        self.params = CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/BIM")
    ...
    def test_create_baseless_wall_interactive_mode(self):
        ...
        cmd.points = [CivilCvCAD.Vector(1000, 1000, 0), CivilCvCAD.Vector(3000, 1000, 0)]
        cmd.Align = "Center"
        cmd.Width = 200.0
        cmd.Height = 2500.0
        cmd.MultiMat = None
        ...
        expected_center = CivilCvCAD.Vector(2000, 1000, 0)
        self.assertTrue(
    ...
    def test_create_draft_line_baseline_wall_interactive(self):
        ...
        cmd.doc = self.document
        cmd.wp = WorkingPlane.get_working_plane()
        cmd.points = [CivilCvCAD.Vector(0, 0, 0), CivilCvCAD.Vector(2000, 0, 0)]
        cmd.Align = "Center"
        cmd.Width = 200.0
        cmd.Height = 2500.0
        cmd.MultiMat = None
    ...
    def test_stretch_rotated_baseless_wall(self):
        ...
        rotation = CivilCvCAD.Rotation(CivilCvCAD.Vector(0, 0, 1), 45)
        placement = CivilCvCAD.Placement(CivilCvCAD.Vector(1000, 1000, 0), rotation)
        wall.Placement = placement
        self.document.recompute()

        # Ensure the view is scaled to the object so selection logic works correctly
        CivilCvCADGui.ActiveDocument.ActiveView.fitAll()
        ...
        cmd = Stretch()
        cmd.doc = self.document
        CivilCvCADGui.Selection.addSelection(self.document.Name, wall.Name)
        ...
        cmd.addPoint(CivilCvCAD.Vector(p_end_initial.x - 1, p_end_initial.y - 1, 0))
        cmd.addPoint(CivilCvCAD.Vector(p_end_initial.x + 1, p_end_initial.y + 1, 0))
        ...
        displacement_vector = CivilCvCAD.Vector(500, -500, 0)
        cmd.addPoint(CivilCvCAD.Vector(0, 0, 0))  # Start of displacement
    ...
    def test_create_baseless_wall_on_rotated_working_plane(self):
        ...
        placement = CivilCvCAD.Placement(
            CivilCvCAD.Vector(0, 0, 1000), CivilCvCAD.Rotation(CivilCvCAD.Vector(0, 0, 1), 45)
        )
        ...
        p1_local = CivilCvCAD.Vector(0, 0, 0)
        p2_local = CivilCvCAD.Vector(2000, 0, 0)
        ...
        rotation_local = CivilCvCAD.Rotation(CivilCvCAD.Vector(1, 0, 0), direction_local)
        placement_local = CivilCvCAD.Placement(midpoint_local, rotation_local)
    ...
    def test_create_multiple_sketch_based_walls(self):
        ...
        cmd.points = [CivilCvCAD.Vector(0, 0, 0), CivilCvCAD.Vector(1000, 0, 0)]
        cmd.create_wall()
        base1 = self.document.getObject("Wall").Base

        # Act again: Create the second wall
        cmd.points = [CivilCvCAD.Vector(0, 1000, 0), CivilCvCAD.Vector(1000, 1000, 0)]
        cmd.create_wall()
    ...
    def _simulate_interactive_wall_creation(self, p1, p2, existing_wall, wall_width=200.0):
        ...
        try:
            ...
            if CivilCvCAD.activeDraftCommand is cmd:
    ...
    def test_baseless_wall_autojoins_as_addition(self, mock_get_param):
        ...
        wall2 = self._simulate_interactive_wall_creation(
            CivilCvCAD.Vector(1000, 0, 0), CivilCvCAD.Vector(1000, 1000, 0), wall1
        )
    ...
    def test_line_based_wall_merges_with_joinWallSketches(self, mock_get_param):
        ...
        line1 = Draft.makeLine(CivilCvCAD.Vector(0, 0, 0), CivilCvCAD.Vector(1000, 0, 0))
    ...
    def test_line_based_wall_falls_back_to_autojoin_on_incompatible_walls(self, mock_get_param):
        ...
        wall2 = self._simulate_interactive_wall_creation(
            CivilCvCAD.Vector(1000, 0, 0), CivilCvCAD.Vector(1000, 1000, 0), wall1, wall_width=300
        )
    ...
    def test_sketch_based_wall_merges_with_joinWallSketches(self, mock_get_param):
        ...
        sketch1.addGeometry(Part.LineSegment(CivilCvCAD.Vector(0, 0, 0), CivilCvCAD.Vector(1000, 0, 0)))
