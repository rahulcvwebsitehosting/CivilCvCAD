...
class BIMWorkbench(Workbench):
    ...
    def __init__(self):
        ...
        bdir = os.path.join(CivilCvCAD.getResourceDir(), "Mod", "BIM")
    ...
    def createTools(self):
        ...
        CivilCvCADGui.addCommand("BIM_ArcTools", BIM_ArcTools())
        CivilCvCADGui.addCommand("BIM_SplineTools", BIM_SplineTools())
        CivilCvCADGui.addCommand("BIM_AxisTools", BIM_AxisTools())
        CivilCvCADGui.addCommand("BIM_OffsetTools", BIM_OffsetTools())
        CivilCvCADGui.addCommand("BIM_ArrayTools", BIM_ArrayTools())
        CivilCvCADGui.addCommand("BIM_BooleanTools", BIM_BooleanTools())
        CivilCvCADGui.addCommand("BIM_IfcManageTools", BIM_IfcManageTools())
        CivilCvCADGui.addCommand("BIM_ReportTools", BIM_ReportTools())
        CivilCvCADGui.addCommand("BIM_GenericTools", BIM_GenericTools())
        CivilCvCADGui.addCommand("BIM_Create2DViews", BIM_Create2DViews())
        CivilCvCADGui.addCommand("BIM_CloneTools", BIM_CloneTools())
        ...
        try:
            ...
            CivilCvCADGui.addCommand("Arch_RebarTools", RebarGroupCommand())
        ...
        # https://github.com/CivilCvCAD/CivilCvCAD/issues/26539
        # https://github.com/CivilCvCAD/CivilCvCAD/issues/27984
        chk = (
    ...
    def loadPreferences(self):
        ...
        CivilCvCADGui.addPreferencePage(":/ui/preferences-arch.ui", t1)
        CivilCvCADGui.addPreferencePage(":/ui/preferences-archdefaults.ui", t1)
        CivilCvCADGui.addPreferencePage(":/ui/preferencesNativeIFC.ui", t1)
        if hasattr(CivilCvCADGui, "draftToolBar"):
            if hasattr(CivilCvCADGui.draftToolBar, "loadedPreferences"):
                return
        from draftutils import params

        params._param_observer_start()
        CivilCvCADGui.addPreferencePage(":/ui/preferences-draft.ui", t2)
        CivilCvCADGui.addPreferencePage(":/ui/preferences-draftinterface.ui", t2)
        CivilCvCADGui.addPreferencePage(":/ui/preferences-draftsnap.ui", t2)
        CivilCvCADGui.addPreferencePage(":/ui/preferences-draftvisual.ui", t2)
        CivilCvCADGui.addPreferencePage(":/ui/preferences-drafttexts.ui", t2)
    ...
    def setupMultipleObjectSelection(self):
        ...
        if hasattr(CivilCvCADGui, "addDocumentObserver") and not hasattr(self, "BimSelectObserver"):
            self.BimSelectObserver = BimSelect.Setup()
            CivilCvCADGui.addDocumentObserver(self.BimSelectObserver)
    ...
    def Activated(self):
        ...
        class BimWatcher:
            ...
            def shouldShow(self):
                if self.invert:
                    return (CivilCvCAD.ActiveDocument != None) and (
        ...
        CivilCvCADGui.Control.addTaskWatcher(
            [
        ...
        if PARAMS.GetBool("RestoreBimViews", True):
            ...
            if not w:
                CivilCvCADGui.runCommand("BIM_Views")
            else:
                w.show()
    ...
    def Deactivated(self):
        ...
        if hasattr(self, "BimSelectObserver"):
            CivilCvCADGui.removeDocumentObserver(self.BimSelectObserver)
    ...
    def ContextMenu(self, recipient):
        ...
        if recipient == "Tree":
            ...
            if (len(CivilCvCADGui.Selection.getSelection()) == 1) and (
                CivilCvCADGui.Selection.getSelection()[0].Name == "Trash"
            ):
        ...
        if CivilCvCADGui.Selection.getSelection():
            if CivilCvCADGui.Selection.getSelection()[0].Name != "Trash":
...
CivilCvCADGui.addWorkbench(BIMWorkbench)
...
CivilCvCADGui.addPreferencePage(":/ui/preferences-ifc.ui", t)
CivilCvCADGui.addPreferencePage(":/ui/preferences-ifc-export.ui", t)
CivilCvCADGui.addPreferencePage(":/ui/preferences-dae.ui", t)
CivilCvCADGui.addPreferencePage(":/ui/preferences-sh3d-import.ui", t)
CivilCvCADGui.addPreferencePage(":/ui/preferences-webgl.ui", t)

# Add unit tests
CivilCvCAD.__unit_test__ += ["TestArchGui"]
# The NativeIFC tests require internet connection and file download
# CivilCvCAD.__unit_test__ += ["nativeifc.ifc_selftest"]
