...
CivilCvCADGui.addCommand("BIM_DimensionVertical", BIM_DimensionVertical())
CivilCvCADGui.addCommand("BIM_DimensionHorizontal", BIM_DimensionHorizontal())
CivilCvCADGui.addCommand("BIM_DimensionAligned", BIM_DimensionAligned())
