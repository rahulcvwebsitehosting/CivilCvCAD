...
class Arch_Profile:
    """The CivilCvCAD Arch_Profile command definition"""
    ...
    def getPoint(self, point=None, obj=None):
        ...
        if not self.Profile:
            return
        pt = "CivilCvCAD.Vector(" + str(point.x) + "," + str(point.y) + "," + str(point.z) + ")"
        ...
        CivilCvCADGui.doCommand("p.Placement = WorkingPlane.get_working_plane().get_placement()")
        CivilCvCADGui.doCommand("p.Placement.Base = " + pt)
        CivilCvCADGui.addModule("Draft")
        CivilCvCADGui.doCommand("Draft.autogroup(p)")
...
CivilCvCADGui.addCommand("Arch_Profile", Arch_Profile())
