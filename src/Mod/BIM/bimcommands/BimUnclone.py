...
class BIM_Unclone:
    ...
    def Activated(self):
        ...
        if len(sel) == 1:
            # make this undoable
            CivilCvCAD.ActiveDocument.openTransaction("Reextrude")
            obj = sel[0]
            ...
            CivilCvCAD.Console.PrintError(translate("BIM", "Select exactly one object") + "\n")


CivilCvCADGui.addCommand("BIM_Unclone", BIM_Unclone())
