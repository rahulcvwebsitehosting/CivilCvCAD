...
class BIM_Shape2DView(gui_shape2dview.Shape2DView):
    ...
    def proceed(self):
        ...
        if self.commitlist_BimShape2DView:
            ...
            commitlist.append("CivilCvCAD.ActiveDocument.recompute()")
    ...
    def proceed_BimShape2DView(self):  # Common
        ...
        if len(objs) == 1 and faces:
            ...
            _cmd += "("
            _cmd += "CivilCvCAD.ActiveDocument." + objs[0].Name + ", "
            ...
            for o in objs:
                _cmd = "Draft.make_shape2dview"
                _cmd += "("
                _cmd += "CivilCvCAD.ActiveDocument." + o.Name + ", "
                _cmd += DraftVecUtils.toString(vec)
                _cmd += ")"
...
class BIM_Shape2DCut(BIM_Shape2DView):
    ...
    def proceed(self):
        ...
        # CivilCvCADGui.doCommand("sv.ProjectionMode = \"Cutfaces\"")
...
CivilCvCADGui.addCommand("BIM_Shape2DView", BIM_Shape2DView())
CivilCvCADGui.addCommand("BIM_Shape2DCut", BIM_Shape2DCut())
