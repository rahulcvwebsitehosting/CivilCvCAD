    ...
    def Activated(self):
        ...
        if len(documents) == 2:
            ...
            if reply == QtGui.QMessageBox.Yes:
                activedoc = CivilCvCAD.ActiveDocument
                ...
                activedocids = {}  # main document, the original civilcvcad one
                ...
                if toselect:
                    CivilCvCAD.setActiveDocument(otherdoc.Name)
                    CivilCvCAD.ActiveDocument = CivilCvCADGui.getDocument(otherdoc.Name)
                    CivilCvCADGui.ActiveDocument = CivilCvCADGui.getDocument(otherdoc.Name)
...
CivilCvCADGui.addCommand("BIM_Diff", BIM_Diff())
