...
class BIM_SetWPFront:
    ...
    def Activated(self):
        ...
        CivilCvCADGui.doCommand("WorkingPlane.get_working_plane(update=False).set_to_front()")
...
class BIM_SetWPSide:
    ...
    def Activated(self):
        CivilCvCADGui.addModule("WorkingPlane")
        CivilCvCADGui.doCommand("WorkingPlane.get_working_plane(update=False).set_to_side()")
...
class BIM_SetWPTop:
    ...
    def Activated(self):
        CivilCvCADGui.addModule("WorkingPlane")
        CivilCvCADGui.doCommand("WorkingPlane.get_working_plane(update=False).set_to_top()")
...
CivilCvCADGui.addCommand("BIM_WPView", BIM_WPView())
CivilCvCADGui.addCommand("BIM_SetWPTop", BIM_SetWPTop())
CivilCvCADGui.addCommand("BIM_SetWPSide", BIM_SetWPSide())
CivilCvCADGui.addCommand("BIM_SetWPFront", BIM_SetWPFront())
