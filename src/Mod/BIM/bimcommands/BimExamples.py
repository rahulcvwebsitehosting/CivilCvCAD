    ...
    def GetResources(self):
        return {
            ...
            "ToolTip": QT_TRANSLATE_NOOP(
                "BIM_Examples",
                "Download examples of BIM files made with CivilCvCAD",
            ),
        }

    def Activated(self):
        CivilCvCAD.Console.PrintWarning(
            "Online examples are unavailable in this offline-only CivilCvCAD build.\n"
        )


CivilCvCADGui.addCommand("BIM_Examples", BIM_Examples())
