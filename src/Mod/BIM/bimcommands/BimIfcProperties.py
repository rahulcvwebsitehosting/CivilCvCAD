...
class BIM_IfcProperties:
    ...
    def Activated(self):
        ...
        self.form = CivilCvCADGui.PySideUic.loadUi(":/ui/dialogIfcProperties.ui")
    ...
    def rebuildObjectsList(self):
        ...
        if self.form.onlySelected.isChecked():
            ...
            objects = CivilCvCAD.ActiveDocument.Objects
        for obj in objects:
    ...
    def accept(self):
        ...
        for key, values in self.objectslist.items():
            obj = CivilCvCAD.ActiveDocument.getObject(key)
            if obj:
                ...
                if values[1] != props:
                    if not changed:
                        CivilCvCAD.ActiveDocument.openTransaction("Change properties")
                        changed = True
...
CivilCvCADGui.addCommand("BIM_IfcProperties", BIM_IfcProperties())
