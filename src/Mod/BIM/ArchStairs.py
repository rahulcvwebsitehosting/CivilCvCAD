...
__title__ = "CivilCvCAD Arch Stairs"
...
zeroMM = CivilCvCAD.Units.Quantity("0mm")
...
class _Stairs(ArchComponent.Component):
        ...
        if (not base) and obj.Width.Value and obj.Height.Value and (obj.NumberOfSteps > 0):
            ...
            if self.ensureBase(obj):
                ...
                if obj.Base.Shape.Solids:
                    ...
                    obj.Placement = CivilCvCAD.Placement(obj.Base.Placement).multiply(pl)
                    obj.TreadDepth = 0.0
                    obj.RiserHeight = 0.0
                    return
    ...
    def makeStraightStairs(
        ...
        # Upgrade obj if it is from an older version of CivilCvCAD
