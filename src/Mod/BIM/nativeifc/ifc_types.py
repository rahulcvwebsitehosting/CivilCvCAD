...
def show_type(obj):
    """Adds the types of that object as CivilCvCAD objects"""
...
def convert_to_type(obj, keep_object=False):
    ...
    if CivilCvCAD.GuiUp and ask_again:
        import CivilCvCADGui

        dlg = CivilCvCADGui.PySideUic.loadUi(":/ui/dialogConvertType.ui")
...
def edit_type(obj):
    ...
    if obj.Type:
        ...
        if obj.Type.Class != element.is_a() + "Type":
            ...
            CivilCvCAD.Console.PrintError(obj.Label + ": " + t + ": " + obj.Type.Class + "\n")
            obj.Type = None
            return
        # change type
