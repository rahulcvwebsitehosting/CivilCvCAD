...
class ifc_vp_object:
    ...
    def setupContextMenu(self, vobj, menu):
        ...
        if element.is_a("IfcSpatialElement"):
            if CivilCvCADGui.ActiveDocument.ActiveView.getActiveObject("NativeIFC") == vobj.Object:
    ...
    def activate(self):
        ...
        if CivilCvCADGui.ActiveDocument.ActiveView.getActiveObject("NativeIFC") == self.Object:
            CivilCvCADGui.ActiveDocument.ActiveView.setActiveObject("NativeIFC", None)
        else:
            CivilCvCADGui.ActiveDocument.ActiveView.setActiveObject("NativeIFC", self.Object)
