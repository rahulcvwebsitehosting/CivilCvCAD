...
FCSTD_FILE_PATH = None  # saved CivilCvCAD file
...
- in terminal mode: CivilCvCAD -t ifc_selftest
- in the CivilCvCAD UI: Switch to Test Framework workbench, press "Self test" and
...
def clearObjects():
    names = [o.Name for o in CivilCvCAD.getDocument("IfcTest").Objects]
    for n in names:
        CivilCvCAD.getDocument("IfcTest").removeObject(n)
...
class NativeIFCTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        if CivilCvCAD.ActiveDocument:
            if CivilCvCAD.ActiveDocument.Name != "IfcTest":
                CivilCvCAD.newDocument("IfcTest")
        else:
            CivilCvCAD.newDocument("IfcTest")
        CivilCvCAD.setActiveDocument("IfcTest")

    def tearDown(self):
        CivilCvCAD.closeDocument("IfcTest")
        pass
    ...
    def test01_ImportCoinSingle(self):
        CivilCvCAD.Console.PrintMessage("NativeIFC 01: Importing single object, coin mode...")
        clearObjects()
        fp = getIfcFilePath()
        ifc_import.insert(
            fp,
        ...
        fco = len(CivilCvCAD.getDocument("IfcTest").Objects)
        self.assertTrue(fco == 1 - SDU, "ImportCoinSingle failed")

    def test02_ImportCoinStructure(self):
        CivilCvCAD.Console.PrintMessage("NativeIFC 02: Importing model structure, coin mode...")
        clearObjects()
        fp = getIfcFilePath()
        ifc_import.insert(
            fp,
    ...
    def test03_ImportCoinFull(self):
        ...
        CivilCvCAD.Console.PrintMessage("NativeIFC 03: Importing full model, coin mode...")
        clearObjects()
        fp = getIfcFilePath()
        d = ifc_import.insert(
            fp,
    ...
    def test04_ImportShapeFull(self):
        CivilCvCAD.Console.PrintMessage("NativeIFC 04: Importing full model, shape mode...")
        clearObjects()
        fp = getIfcFilePath()
        d = ifc_import.insert(
            fp,
    ...
    def test05_ImportCivilCvCAD(self):
        CivilCvCAD.Console.PrintMessage("NativeIFC 05: CivilCvCAD import of NativeIFC coin file...")
        clearObjects()
        doc = CivilCvCAD.open(FCSTD_FILE_PATH)
        obj = doc.Objects[-1]
        proj = ifc_tools.get_project(obj)
        ifcfile = ifc_tools.get_ifcfile(proj)
        print(ifcfile)
        self.assertTrue(ifcfile, "ImportCivilCvCAD failed")

    def test06_ModifyObjects(self):
        CivilCvCAD.Console.PrintMessage("NativeIFC 06: Modifying IFC document...")
        doc = CivilCvCAD.open(FCSTD_FILE_PATH)
        obj = doc.Objects[-1]
    ...
    def test07_CreateDocument(self):
        CivilCvCAD.Console.PrintMessage("NativeIFC 07: Creating new IFC document...")
        doc = CivilCvCAD.ActiveDocument
        ifc_tools.create_document(doc, silent=True)
        fco = len(CivilCvCAD.getDocument("IfcTest").Objects)
        print(CivilCvCAD.getDocument("IfcTest").Objects)
        self.assertTrue(fco == 1 - SDU, "CreateDocument failed")

    def test08_ChangeIFCSchema(self):
        CivilCvCAD.Console.PrintMessage("NativeIFC 08: Changing IFC schema...")
        clearObjects()
        fp = getIfcFilePath()
        ifc_import.insert(
            fp,
        ...
        obj = CivilCvCAD.getDocument("IfcTest").Objects[-1]
        proj = ifc_tools.get_project(obj)
        oldid = obj.StepId
        proj.Proxy.silent = True
        proj.Schema = "IFC2X3"
        CivilCvCAD.getDocument("IfcTest").recompute()
        self.assertTrue(obj.StepId != oldid, "ChangeIFCSchema failed")

    def test08b_ClassListUsesActiveSchema(self):
        CivilCvCAD.Console.PrintMessage("NativeIFC 08b: IFC class list uses full schema...")
        clearObjects()
        fp = getIfcFilePath()
        ifc_import.insert(
            fp,
        ...
        wall = next(
            o
            for o in CivilCvCAD.getDocument("IfcTest").Objects
    ...
    def test08c_IFC2X3TypeClassListUsesTypeFamily(self):
        CivilCvCAD.Console.PrintMessage("NativeIFC 08c: IFC2X3 type class list uses full schema...")
        clearObjects()
        doc = CivilCvCAD.ActiveDocument
    ...
    def test09_CreateBIMObjects(self):
        CivilCvCAD.Console.PrintMessage("NativeIFC 09: Creating BIM objects...")
        doc = CivilCvCAD.ActiveDocument
        proj = ifc_tools.create_document(doc, silent=True)
        site = Arch.makeSite()
    ...
    def test09b_AggregatedStoreyKeepsLevelData(self):
        CivilCvCAD.Console.PrintMessage("NativeIFC 09b: Aggregated storey keeps level data...")
        clearObjects()
        doc = CivilCvCAD.ActiveDocument
        proj = ifc_tools.create_document(doc, silent=True)
        site = ifc_tools.aggregate(Arch.makeSite(), proj)
        ...
        source_storey.Placement.move(CivilCvCAD.Vector(0, 0, 6000))
        ...
        pset = ifc_psets.get_pset("CivilCvCADPropertySet", element)
        self.assertIsNotNone(pset, "Storey CivilCvCADPropertySet missing")
        prop_values = {
            prop.Name: prop.NominalValue.wrappedValue
            for prop in getattr(pset, "HasProperties", []) or []
            if getattr(prop, "NominalValue", None)
        }
        self.assertAlmostEqual(prop_values["CivilCvCAD_Height"], 3.0, delta=0.000001)
        storey.Placement.move(CivilCvCAD.Vector(0, 0, 500))
        doc.recompute()
        self.assertAlmostEqual(storey.Elevation.Value, 6500, delta=0.001)

    def test09c_DirectConversionStoreyKeepsLevelData(self):
        CivilCvCAD.Console.PrintMessage("NativeIFC 09c: Direct conversion keeps level data...")
        clearObjects()
        doc = CivilCvCAD.ActiveDocument
    ...
    def test10_ChangePlacement(self):
        CivilCvCAD.Console.PrintMessage("NativeIFC 10: Changing Placement...")
        clearObjects()
        fp = getIfcFilePath()
        ifc_import.insert(
            fp,
        ...
        obj = CivilCvCAD.getDocument("IfcTest").getObject("IfcObject00" + str(4 - SDU))
        elem = ifc_tools.get_ifc_element(obj)
        obj.Placement.move(CivilCvCAD.Vector(100, 200, 300))
    ...
    def test11_ChangeGeometry(self):
        CivilCvCAD.Console.PrintMessage("NativeIFC 11: Changing Geometry...")
        clearObjects()
        fp = getIfcFilePath()
        ifc_import.insert(
            fp,
        ...
        obj = CivilCvCAD.getDocument("IfcTest").getObject("IfcObject004")
    ...
    def test12_RemoveObject(self):
        ...
        CivilCvCAD.Console.PrintMessage("NativeIFC 12: Remove object...")
        clearObjects()
        fp = getIfcFilePath()
        ifc_import.insert(
            fp,
        ...
        ifcfile = ifc_tools.get_ifcfile(CivilCvCAD.getDocument("IfcTest").Objects[-1])
        count1 = len(ifcfile.by_type("IfcProduct"))
        CivilCvCAD.getDocument("IfcTest").removeObject("IfcObject004")
        count2 = len(ifcfile.by_type("IfcProduct"))
        self.assertTrue(count2 < count1, "RemoveObject failed")

    def test13_Materials(self):
        CivilCvCAD.Console.PrintMessage("NativeIFC 13: Materials...")
        clearObjects()
        fp = getIfcFilePath()
        ifc_import.insert(
            fp,
        ...
        proj = CivilCvCAD.getDocument("IfcTest").Objects[0]
        ifc_materials.load_materials(proj)
        prod = CivilCvCAD.getDocument("IfcTest").getObject("IfcObject006")
    ...
    def test13b_MaterialLayerLogical(self):
        CivilCvCAD.Console.PrintMessage("NativeIFC 13b: Material layer logical values...")
        clearObjects()
        proj = ifc_tools.create_document(CivilCvCAD.getDocument("IfcTest"), silent=True)
        ifcfile = ifc_tools.get_ifcfile(proj)
        ...
        layer_unknown_obj = ifc_tools.get_object(layer_unknown, CivilCvCAD.getDocument("IfcTest"))
        layer_true_obj = ifc_tools.get_object(layer_true, CivilCvCAD.getDocument("IfcTest"))
    ...
    def test14_Layers(self):
        CivilCvCAD.Console.PrintMessage("NativeIFC 14: Layers...")
        clearObjects()
        fp = getIfcFilePath()
        ifc_import.insert(
            fp,
    ...
    def test15_Psets(self):
        CivilCvCAD.Console.PrintMessage("NativeIFC 15: Psets...")
        clearObjects()
        fp = getIfcFilePath()
        ifc_import.insert(
            fp,
