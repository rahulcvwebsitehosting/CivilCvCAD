...
class TestImportCSG(unittest.TestCase):
    ...
    def setUp(self):
        self.test_dir = join(CivilCvCAD.getHomePath(), "Mod", "OpenSCAD", "OpenSCADTest", "data")
...
""","polyhedron"
    ...
    def test_import_rotate_extrude(self):
        ...
        # Bug #4353 - https://tracker.civilcvcad.org/view.php?id=4353
...
#        CivilCvCAD.closeDocument(doc.Name)
    ...
    def test_import_import_stl(self):
        ...
        if transfer_mechanism == 2:
            ...
            print ("If either OpenSCAD or CivilCvCAD are installed as sandboxed packages,")
...
resize(newsize = [0,0,10], auto = [0,0,0]) {
    ...
    def test_import_surface(self):
        ...
        if transfer_mechanism == 2:
            ...
            print ("If either OpenSCAD or CivilCvCAD are installed as sandboxed packages, use of")
  ...
  union() {
   union() {
    ...
    def test_complex_fuse_no_placement(self):
        # Issue #7878 - https://github.com/CivilCvCAD/CivilCvCAD/issues/7878
...
"""
        ...
        self.assertEqual (doc.RootObjects[0].Placement, CivilCvCAD.Placement())
        CivilCvCAD.closeDocument(doc.Name)
