...
# CivilCvCAD init script of the OpenSCAD module

import os
import CivilCvCAD

CivilCvCAD.addImportType("OpenSCAD CSG (*.csg *.CSG)", "importCSG")

param = CivilCvCAD.ParamGet(\
...
if openscadbin:
    CivilCvCAD.addImportType("OpenSCAD (*.scad *.SCAD)", "importCSG")
    CivilCvCAD.__unit_test__ += ["TestOpenSCADApp"]

CivilCvCAD.addExportType("OpenSCAD CSG (*.csg)", "exportCSG")
CivilCvCAD.addExportType("OpenSCAD (*.scad)", "exportCSG")
