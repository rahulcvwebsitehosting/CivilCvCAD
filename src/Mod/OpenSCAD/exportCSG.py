...
#*   Acknowledgements :                                                    *
#*                                                                         *
#*     Thanks to shoogen on the CivilCvCAD forum for programming advice       *
#*     and some code.                                                      *
#*                                                                         *
#***************************************************************************
__title__ = "CivilCvCAD OpenSCAD Workbench - CSG exporter Version"
...
def export(exportList, filename):
    ...
    csg.write("// CSG file generated from CivilCvCAD %s\n" % \
            '.'.join(CivilCvCAD.Version()[0:3]))
    ...
    # close file
    csg.close()
    CivilCvCAD.Console.PrintMessage("successfully exported" + " " + filename)
