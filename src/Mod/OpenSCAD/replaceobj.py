...
__title__ = "CivilCvCAD OpenSCAD Workbench - replace object function"
        ...
        if type(propvalue) == list:
            ...
            if bModified:
                if propname == "ExpressionEngine":
                    ...
                    CivilCvCAD.Console.PrintWarning("Expressions in "+parent.Name+" need to be modified, but they were not. Please do that manually.")
                    continue
...
if __name__ == '__main__':
    ...
    objs = [selobj.Object for selobj in CivilCvCADGui.Selection.getSelectionEx()]
