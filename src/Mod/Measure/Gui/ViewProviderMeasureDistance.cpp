...
SbMatrix ViewProviderMeasureDistance::getMatrix()
{
    ...
    auto prop1 = civilcvcad_cast<App::PropertyVector*>(pcObject->getPropertyByName("Position1"));
    auto prop2 = civilcvcad_cast<App::PropertyVector*>(pcObject->getPropertyByName("Position2"));
