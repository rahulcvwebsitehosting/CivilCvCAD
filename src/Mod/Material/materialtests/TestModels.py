...
"""
Test module for CivilCvCAD material models
"""
...
parseQuantity = CivilCvCAD.Units.parseQuantity

class ModelTestCases(unittest.TestCase):
    """
    Test class for CivilCvCAD material models
    """
    def setUp(self):
    ...
    def testTestModelCompleteness(self):
        ...
        self.assertEqual(col.Description, "Density in [CivilCvCAD Density unit]")
        ...
        self.assertEqual(col.Description, "Saturation stress for Voce isotropic hardening [CivilCvCAD Pressure unit]\n")
    ...
    def testModelInheritance(self):
        ...
        self.assertEqual(prop.Units, "kg/m^3")
        self.assertEqual(prop.Description, "Density in [CivilCvCAD Density unit]")
        ...
        self.assertEqual(prop.Description, "Bulk modulus in [CivilCvCAD Pressure unit]")
        ...
        self.assertEqual(prop.Units, "kPa")
        self.assertEqual(prop.Description, "Shear modulus in [CivilCvCAD Pressure unit]")
        ...
        self.assertEqual(prop.Units, "kPa")
        self.assertEqual(prop.Description, "Young's modulus (or E-Module) in [CivilCvCAD Pressure unit]")