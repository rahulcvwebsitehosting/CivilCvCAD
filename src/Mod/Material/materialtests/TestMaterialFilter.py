...
"""
Test module for CivilCvCAD material cards and APIs
"""
import os
...
class MaterialFilterTestCases(unittest.TestCase):
    """
    Test class for CivilCvCAD material cards and APIs
    """
    ...
    def setUp(self):
        ...
        param = CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/Material/Resources")
        ...
        paramExternal = CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/Material/ExternalInterface")
