...
__title__ = "CivilCvCAD material card importer"
...
def decode(name):
    ...
    try:
        ...
        try:
            ...
            CivilCvCAD.Console.PrintError("Error: Couldn't determine character encoding")
            decodedName = name
    return decodedName
...
# mainly this parser here is used in CivilCvCAD
...
# https://github.com/berndhahnebach/CivilCvCAD_bhb/commits/materialdev
...
# Line5: CivilCvCAD version info or empty
def read_old(filename):
    ...
    try:
        ...
        # https://forum.civilcvcad.org/viewtopic.php?f=18&t=56912#p489721
        # older CivilCvCAD do not write utf-8 for special character on windows
        # I have seen "ISO-8859-15" or "windows-1252"
        # explicit utf-8 writing, https://github.com/CivilCvCAD/CivilCvCAD/commit/9a564dd906f
        CivilCvCAD.Console.PrintError("Error on card loading. File might not utf-8.")
...
def write(filename, dictionary, write_group_section=True):
    ...
    f.write("; file created by CivilCvCAD " + rev + "\n")
    # write sections
