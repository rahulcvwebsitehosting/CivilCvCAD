...
// https://github.com/Spritkopf/civilcvcad-macros/blob/master/clip-sketch/clip_sketch.FCMacro
// https://forum.civilcvcad.org/viewtopic.php?p=231481#p231085
...
void CmdSketcherViewSection::activated(int iMsg)
{
    ...
    SketcherGui::ViewProviderSketch* vp =
        civilcvcad_cast<SketcherGui::ViewProviderSketch*>(doc->getInEdit());
    if (!vp) {
        return;
    }
