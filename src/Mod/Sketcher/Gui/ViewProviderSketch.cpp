    ...
    switch (key) {
        case SoKeyboardEvent::ESCAPE: {
            ...
            if (isInEditMode()) {
                ...
                // https://forum.civilcvcad.org/viewtopic.php?f=3&t=42207
...
void SketcherGui::ViewProviderSketch::finishRestoring()
{
    ...
    // if AutoColor was not touched it means that the document is from older version of CivilCvCAD
    // that meaans that we need to run migration strategy and come up with a proper value
    if (!AutoColor.isTouched()) {
        // white is the normally provided default for CivilCvCAD sketch colors
