...
Κάντε κλικ στην επιλογή ''Αλλαγή αρχικού και τελικού σημείου στους περιορισμούς'' προκειμένου να ορίσετε ξανά αρχικά και τελικά σημεία. Αυτό να γίνει μόνο μια φορά σε σκαριφήματα που δημιουργήθηκαν σε έκδοση του CivilCvCAD που είναι παλαιότερη από την έκδοση v0.15</translation>
    </message>
    <message>
...
Η απόσταση του πλέγματος αλλάζει αυτόματα εάν γίνει μικρότερη από το καθορισμένο μέγεθος pixel στην οθόνη.</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Οι παραβολές μετεγκαταστάθηκαν. Τα μετεγκατεστημένα αρχεία δεν ανοίγουν σε προηγούμενες εκδόσεις του CivilCvCAD!!
</translation>
    </message>
    <message>
...
Συνευθειακότητα: Αναγκάζει δύο ξεχωριστές γραμμές να βρίσκονται πάνω στην ίδια ακριβώς νοητή ευθεία</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Με αυτό το εργαλείο σχεδιάζετε ένα ορθογώνιο κάνοντας δύο κλικ: ένα για την πρώτη γωνία και ένα για την απέναντι διαγώνια γωνία. Το CivilCvCAD θα φτιάξει αυτόματα τις τέσσερις πλευρές και θα τις κρατήσει οριζόντιες και κατακόρυφες</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Με αυτό το εργαλείο σχεδιάζετε ένα ορθογώνιο επιλέγοντας τις δύο διαγώνιες γωνίες του, όπως και στο απλό ορθογώνιο. Η διαφορά είναι ότι το CivilCvCAD προσθέτει αυτόματα καμπύλες (τόξα) στις τέσσερις γωνίες του</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Αυτό το εργαλείο μεγαλώνει αυτόματα μια γραμμή. Αντί να τραβάτε τη γραμμή με το χέρι, απλώς κάνετε κλικ πάνω της και το CivilCvCAD την προεκτείνει με ακρίβεια μέχρι να συναντήσει το πλησιέστερο στοιχείο του σχεδίου σας</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Αυτό το εργαλείο παίρνει 2 ξεχωριστές καμπύλες και τις «κολλάει» μεταξύ τους για να γίνουν μία ενιαία. Πρέπει να επιλέξετε τις άκρες των δύο γραμμών που θέλετε να ενωθούν και το CivilCvCAD θα τις συνδέσει ομαλά, καταργώντας το κενό ανάμεσά τους</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Επιλογή Πλεοναζόντων Περιορισμών χρησιμοποιείται όταν έχετε δώσει περισσότερες πληροφορίες από όσες χρειάζεται το πρόγραμμα, συνήθως το CivilCvCAD εμφανίζει ένα μήνυμα σε πορτοκαλί φόντο που λέει "Redundant Constraints"</translation>
    </message>
  </context>
  <context>
...
Παράδειγμα: Αν θέλετε 10 τρύπες σε μια πλάκα, σχεδιάζετε μόνο την πρώτη και το CivilCvCAD δημιουργεί τις υπόλοιπες αυτόματα σε ίσες αποστάσεις</translation>
    </message>
  </context>
  <context>
