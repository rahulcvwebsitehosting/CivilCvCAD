                                                                   ...
                                                                   const Sketcher::Constraint* constraint)
{
    ...
    if (constraint->Second == Sketcher::GeoEnum::GeoUndef) {
        const auto* arc = civilcvcad_cast<const Part::GeomArcOfCircle*>(
        ...
        const auto* lineSegment = civilcvcad_cast<const Part::GeomLineSegment*>(
        ...
        const auto* firstLine =
            civilcvcad_cast<const Part::GeomLineSegment*>(sketch->getGeometry(constraint->First));
        const auto* secondLine =
            civilcvcad_cast<const Part::GeomLineSegment*>(sketch->getGeometry(constraint->Second));
...
private:
    struct ConstraintHintEntry {
        std::string commandName;    // CivilCvCAD command name (e.g., "Sketcher_ConstrainSymmetric")
