...
class TestSketchExpression(unittest.TestCase):
    def setUp(self):
        self.Doc = CivilCvCAD.newDocument("TestSketchExpr")

    # See https://forum.civilcvcad.org/viewtopic.php?f=3&t=64699
    # and https://forum.civilcvcad.org/viewtopic.php?f=10&t=64718
