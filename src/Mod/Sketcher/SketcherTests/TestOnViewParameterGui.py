...
class TestOnViewParameterGui(SketcherGuiTestCase):
    ...
    def setUp(self):
        ...
        self.doc = CivilCvCAD.newDocument("TestOnViewParameterGui")
    ...
    def active_task_dialog(self):
        return CivilCvCADGui.Control.activeTaskDialog()
    ...
    def assert_sketch_edit_inactive(self):
        self.assertIsNone(
            CivilCvCADGui.ActiveDocument.getInEdit(),
    ...
    def begin_rectangle_with_visible_ovp(self):
        ...
        CivilCvCADGui.runCommand("Sketcher_CreateRectangle")
        self.pump(250)
