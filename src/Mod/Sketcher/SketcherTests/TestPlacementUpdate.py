# test for CivilCvCAD issue https://github.com/civilcvcad/civilcvcad/issues/25893
...
from SketcherTests.GuiTestCase import CivilCvCADGui, SketcherGuiTestCase
...
class TestSketchPlacementUpdate(SketcherGuiTestCase):
    ...
    These tests require GUI and will be skipped with civilcvcadcmd.
    """
    ...
    def setUp(self):
        ...
        self.doc = CivilCvCAD.newDocument("TestPlacementUpdate")
    ...
    def test_attachment_offset_updates_in_edit_mode(self):
        ...
        initial_transform = CivilCvCADGui.ActiveDocument.EditingTransform
        ...
        updated_transform = CivilCvCADGui.ActiveDocument.EditingTransform
    ...
    def test_multiple_attachment_offset_updates(self):
        ...
        for i in range(1, 4):
            ...
            transform = CivilCvCADGui.ActiveDocument.EditingTransform
    ...
    def test_unattached_sketch_placement_updates(self):
        ...
        # enter edit mode
        CivilCvCADGui.ActiveDocument.setEdit(unattached.Name)
