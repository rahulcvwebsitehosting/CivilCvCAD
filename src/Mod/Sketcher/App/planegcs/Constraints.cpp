...
double ConstraintWeightedLinearCombination::error()
{
    ...
    // https://forum.civilcvcad.org/viewtopic.php?f=9&t=71130&start=120#p635538
...
{
    // DeepSOIC equation
    // https://forum.civilcvcad.org/viewtopic.php?f=10&t=7520&start=140
...
double ConstraintPointOnHyperbola::error()
{
    ...
    // https://forum.civilcvcad.org/viewtopic.php?f=10&t=8038&p=110447#p110447
    //
    // Err = |PF2| - |PF1| - 2*a
    // sage code:
    // C = vector([X_c,Y_c])
