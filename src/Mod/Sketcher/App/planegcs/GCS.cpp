...
// https://forum.civilcvcad.org/viewtopic.php?f=10&t=11341&p=92146#p92146, until Eigen library fixes
...
# endif
                           ...
                           // https://forum.civilcvcad.org/viewtopic.php?f=3&t=4651&start=40
                           // was solved in Eigen:
                           // https://forum.civilcvcad.org/viewtopic.php?f=10&t=12769&start=60#p106492
...
int System::solve_DL(SubSystem* subsys, bool isRedundantsolving)
{
    ...
    while (!stop) {
        ...
        // https://forum.civilcvcad.org/viewtopic.php?f=10&t=12769&start=50#p106220
...
int System::diagnose(Algorithm alg)
{
    ...
    // See: https://github.com/CivilCvCAD/CivilCvCAD/issues/10903
