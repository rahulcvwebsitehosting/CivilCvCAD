...
class Trajectory_Composite: public Trajectory
	{
		...
		double duration;    // total duration of the composed
				    // Trajectory
        Path_Composite* path; // CivilCvCAD change
	...
	public:
        ...
        virtual Path*      GetPath(); // CivilCvCAD change
		virtual VelocityProfile* GetProfile(); // CivilCvCAD change
        
        // access the single members
        Trajectory *Get(unsigned int n){return vt[n];} // CivilCvCAD change
