...
void CmdRobotInsertWaypointPreselect::activated(int)
{
    ...
    doCommand(
        Doc,
        "App.activeDocument().%s.Trajectory = "
        "App.activeDocument().%s.Trajectory.insertWaypoints(Robot.Waypoint(CivilCvCAD.Placement("
        "CivilCvCAD.Vector(%f,%f,%f)+_DefDisplacement,_DefOrientation),type='LIN',name='Pt',vel="
...
void CmdRobotSetDefaultOrientation::activated(int)
{
    ...
    if (Dlg.exec() == QDialog::Accepted) {
        ...
        doCommand(Doc, "_DefOrientation = CivilCvCAD.Rotation(%f,%f,%f,%f)", rot[0], rot[1], rot[2], rot[3]);
        doCommand(Doc, "_DefDisplacement = CivilCvCAD.Vector(%f,%f,%f)", disp[0], disp[1], disp[2]);
    }
}
...
void CmdRobotSetDefaultValues::activated(int)
{
    ...
    //    CivilCvCAD.Rotation(%f,%f,%f,%f)",rot[0],rot[1],rot[2],rot[3]);
    //    doCommand(Doc,"_DefDisplacement = CivilCvCAD.Vector(%f,%f,%f)",disp[0],disp[1],disp[2]);
    //}
}
