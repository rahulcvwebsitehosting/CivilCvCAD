...
void ViewProviderRobotObject::updateData(const App::Property* prop)
{
    ...
    if (prop == &robObj->RobotVrmlFile) {
        ...
        // Axis 1
        searchAction.setName("CIVILCVCAD_AXIS1");
        ...
        // Axis 2
        searchAction.setName("CIVILCVCAD_AXIS2");
        searchAction.setInterest(SoSearchAction::FIRST);
        searchAction.setSearchingAll(false);
        searchAction.apply(pcRobotRoot);
        path = searchAction.getPath();
        ...
        // Axis 3
        searchAction.setName("CIVILCVCAD_AXIS3");
        searchAction.setInterest(SoSearchAction::FIRST);
        searchAction.setSearchingAll(false);
        searchAction.apply(pcRobotRoot);
        path = searchAction.getPath();
        ...
        // Axis 4
        searchAction.setName("CIVILCVCAD_AXIS4");
        searchAction.setInterest(SoSearchAction::FIRST);
        searchAction.setSearchingAll(false);
        searchAction.apply(pcRobotRoot);
        path = searchAction.getPath();
        ...
        // Axis 5
        searchAction.setName("CIVILCVCAD_AXIS5");
        searchAction.setInterest(SoSearchAction::FIRST);
        searchAction.setSearchingAll(false);
        searchAction.apply(pcRobotRoot);
        path = searchAction.getPath();
        ...
        // Axis 6
        searchAction.setName("CIVILCVCAD_AXIS6");
        searchAction.setInterest(SoSearchAction::FIRST);
        searchAction.setSearchingAll(false);
        searchAction.apply(pcRobotRoot);
        path = searchAction.getPath();
