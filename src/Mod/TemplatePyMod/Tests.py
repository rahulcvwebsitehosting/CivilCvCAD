...
class ParameterTestCase(unittest.TestCase):
    ...
    def testGroup(self):
        #CivilCvCAD.PrintLog("Base::ParameterTestCase::testGroup\n")
    ...
    def testInt(self):
        #CivilCvCAD.PrintLog("Base::ParameterTestCase::testInt\n")
        #Temp = CivilCvCAD.ParamGet("System parameter:Test/44")
        # check on Int
    ...
    def testBool(self):
        #CivilCvCAD.PrintLog("Base::ParameterTestCase::testBool\n")
        # check on Int
    ...
    def testFloat(self):
        #CivilCvCAD.PrintLog("Base::ParameterTestCase::testFloat\n")
        #Temp = CivilCvCAD.ParamGet("System parameter:Test/44")
        # check on Int
    ...
    def testNesting(self):
        # Parameter testing
        #CivilCvCAD.PrintLog("Base::ParameterTestCase::testNesting\n")
        for i in range(50):
