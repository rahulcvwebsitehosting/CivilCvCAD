...
"""
Examples for customizing the CivilCvCAD application with PySide facilities.
...
import CivilCvCADGui, __main__

class MainWindow:
	def __init__(self):
		self.app = QtGui.qApp
		self.mw = CivilCvCADGui.getMainWindow()
		self.dock = {}
...
class PythonQtWorkbench (__main__.Workbench):
	...
	def Activated(self):
		...
		self.mw.setWindowTitle("CivilCvCAD -- PythonQt")
...
CivilCvCADGui.addWorkbench(PythonQtWorkbench)
