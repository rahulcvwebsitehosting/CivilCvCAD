...
class Box(PartFeature):
    ...
    def onChanged(self, fp, prop):
        ...
        CivilCvCAD.Console.PrintMessage("Change property: " + str(prop) + "\n")

    def execute(self, fp):
        ''' Print a short message when doing a recomputation, this method is mandatory '''
        CivilCvCAD.Console.PrintMessage("Recompute Python Box feature\n")
...
def makeBox():
    ...
    a=CivilCvCAD.ActiveDocument.addObject("Part::FeaturePython","Box")
    Box(a)
...
class Line:
    def __init__(self, obj):
        ...
        obj.addProperty("App::PropertyVector","p2","Line","End point", locked=True).p2=CivilCvCAD.Vector(1,0,0)
        obj.Proxy = self
...
def makeLine():
    doc=CivilCvCAD.newDocument()
    a=CivilCvCAD.ActiveDocument.addObject("Part::FeaturePython","Line")
    Line(a)
...
class Octahedron:
    ...
    def execute(self, fp):
        ...
        v2 = CivilCvCAD.Vector(fp.Length,0,0)
        v3 = CivilCvCAD.Vector(0,fp.Width,0)
        v4 = CivilCvCAD.Vector(fp.Length,fp.Width,0)
        v5 = CivilCvCAD.Vector(fp.Length/2,fp.Width/2,fp.Height/2)
        v6 = CivilCvCAD.Vector(fp.Length/2,fp.Width/2,-fp.Height/2)
...
def makeOctahedron():
    doc=CivilCvCAD.newDocument()
    a=CivilCvCAD.ActiveDocument.addObject("App::FeaturePython","Octahedron")
    Octahedron(a)
...
def makePoints():
    ...
    a=CivilCvCAD.ActiveDocument.addObject("Points::FeaturePython","Points")
    a.Points=p
    PointFeature(a)
...
def makeMesh():
    ...
    a=CivilCvCAD.ActiveDocument.addObject("Mesh::FeaturePython","Mesh")
...
class Molecule:
    def __init__(self, obj):
        ''' Add two point properties '''
        obj.addProperty("App::PropertyVector","p1","Line","Start point", locked=True)
        obj.addProperty("App::PropertyVector","p2","Line","End point", locked=True).p2=CivilCvCAD.Vector(5,0,0)
...
def makeMolecule():
    doc=CivilCvCAD.newDocument()
    a=CivilCvCAD.ActiveDocument.addObject("Part::FeaturePython","Molecule")
    Molecule(a)
...
def makeCircleSet():
    ...
    doc=CivilCvCAD.newDocument()
    a=CivilCvCAD.ActiveDocument.addObject("App::FeaturePython","Circles")
    CircleSet(a)
...
def makeEnumTest():
    CivilCvCAD.newDocument()
    a=CivilCvCAD.ActiveDocument.addObject("Part::FeaturePython","Enum")
    EnumTest(a)
...
def makeDistanceBolt():
    doc=CivilCvCAD.newDocument()
    bolt=CivilCvCAD.ActiveDocument.addObject("Part::FeaturePython","Distance_Bolt")
