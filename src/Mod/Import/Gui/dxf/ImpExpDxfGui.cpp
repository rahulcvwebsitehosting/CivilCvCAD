...
int ImpExpDxfReadGui::GetDrawStyle() const
{
    ...
    // neither of these is exposed at the CivilCvCAD level; line types are dumbed down to four choices:
    ...
    // CivilCvCAD should expose the line pattern (the 16-bit number) for more versatility.
