...
- Python imports should be grouped into groups:
    ...
    - Third-party imports
    - One empty line
    - non Gui CivilCvCAD specific imports
        - from module CivilCvCAD
        - One empty line
        ...
        - FEM specific imports
            ...
            - relative imports
        - One empty line
    - CivilCvCAD Gui imports:
        - The import of Gui modules should be guarded by a 'if CivilCvCAD.GuiUp:'
        - On Gui only modules the guard is not needed
        - Same as above but without a empty line
        - Standard library imports
        - Third-party Gui imports
        - CivilCvCAD-specific imports from module CivilCvCADGui
        - other CivilCvCAD Gui imports
        - FEM Gui imports
...
```
- [LGTM](https://lgtm.com/projects/g/CivilCvCAD/CivilCvCAD/latest/files/src/Mod/Fem/)
- TODO: check pylint
...
### Coding
- print() vs. CivilCvCAD.Console.PrintMessage()
    - `CivilCvCAD.Console.PrintMessage()` or Log or Error should be used
    - `print()` should be used for debugging only
    - [forum topic](https://forum.civilcvcad.org/viewtopic.php?f=10&t=39110)
...
- ActiveDocument
    - try to avoid the use of App.ActiveDocument or CivilCvCAD.ActiveDocument
    - instead try to use some_obj.Document instead
    - try to avoid the use of Gui.ActiveDocument or CivilCvCADGui.ActiveDocument
    ...
    - [forum topic](https://forum.civilcvcad.org/viewtopic.php?f=10&t=44133)
    - CivilCvCAD Python console
        - in code examples which will be copied in CivilCvCAD Python console
...
Python style is preferred over Doxygen style
    ...
    - see [forum topic](https://forum.civilcvcad.org/viewtopic.php?f=10&t=37094)
...
- slashes
    ...
    - see [PR with comment](https://github.com/CivilCvCAD/CivilCvCAD/pull/2757#discussion_r355218913)


## Icons
### Naming plicy
- Command icons use the command name.
- see [forum topic](https://forum.civilcvcad.org/viewtopic.php?f=18&t=43379)
