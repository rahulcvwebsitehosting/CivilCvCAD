...
__title__ = "CivilCvCAD FEM postprocessing line plot ViewProvider for the document object"
...
class EditViewWidget(QtGui.QWidget):
    ...
    def __init__(self, obj, post_dialog):
        ...
        self.widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/PostHistogramFieldViewEdit.ui"
        )
    ...
    def __init_widget(self):
        ...
        # setup the color buttons (don't use CivilCvCADs color button, as this does not work in popups!)
...
class EditFieldAppWidget(QtGui.QWidget):
    ...
    def __init__(self, obj, post_dialog):
        ...
        # load the ui and set it up
        self.widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/PostHistogramFieldAppEdit.ui"
        )
        layout = QtGui.QVBoxLayout()
        layout.addWidget(self.widget)
        self.setLayout(layout)
...
class EditIndexAppWidget(QtGui.QWidget):
    ...
    def __init__(self, obj, post_dialog):
        ...
        # load the ui and set it up
        self.widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/PostHistogramIndexAppEdit.ui"
        )
        layout = QtGui.QVBoxLayout()
        layout.addWidget(self.widget)
        self.setLayout(layout)
...
class VPPostHistogram(view_base_fempostvisualization.VPPostVisualization):
    ...
    def show_visualization(self):
        ...
        if not hasattr(self, "_plot") or not self._plot:
            main = CivilCvCADGui.getMainWindow()
