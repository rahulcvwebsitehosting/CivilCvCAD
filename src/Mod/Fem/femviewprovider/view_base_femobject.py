...
__title__ = "CivilCvCAD FEM base constraint ViewProvider"
...
class VPBaseFemObject:
    ...
    def getIcon(self):
        ...
        # https://forum.civilcvcad.org/viewtopic.php?f=18&t=44009
        if not hasattr(self.Object, "Proxy"):
            CivilCvCAD.Console.PrintMessage(f"{self.Object.Name}, has no Proxy.\n")
            return ""
        ...
        if isinstance(self.Object.Proxy.Type, str) and self.Object.Proxy.Type.startswith("Fem::"):
            ...
            CivilCvCAD.Console.PrintLog(f"{self.Object.Name} --> {icon_path}\n")
            return f":/{icon_path}"
        else:
            CivilCvCAD.Console.PrintError(f"No icon returned for {self.Object.Name}\n")
            CivilCvCAD.Console.PrintMessage(f"{self.Object.Proxy.Type}\n")
            return ""
    ...
    def setEdit(self, vobj, mode=0, TaskPanel=None, hide_mesh=True):
        if TaskPanel is None:
            ...
            # https://forum.civilcvcad.org/viewtopic.php?t=12139&start=10#p161062
            return False
        if hide_mesh:
    ...
    def doubleClicked(self, vobj):
        guidoc = CivilCvCADGui.getDocument(vobj.Object.Document)
        # check if another VP is in edit mode
        # https://forum.civilcvcad.org/viewtopic.php?t=13077#p104702
        if not guidoc.getInEdit():
            ...
            CivilCvCAD.Console.PrintError(message + "\n")
        return True

    # they are needed, see:
    # https://forum.civilcvcad.org/viewtopic.php?f=18&t=44021
    # https://forum.civilcvcad.org/viewtopic.php?f=18&t=44009
    def dumps(self):
        return None
