...
__title__ = "CivilCvCAD FEM mesh netgen ViewProvider for the document object"
...
class VPMeshNetgen(view_base_femobject.VPBaseFemObject):
    ...
    def doubleClicked(self, vobj):
        ...
        gui_doc = CivilCvCADGui.getDocument(vobj.Object.Document)
        if not gui_doc.getInEdit():
            ...
            if found_an_analysis:
                if FemGui.getActiveAnalysis() is not None:
                    if FemGui.getActiveAnalysis().Document is CivilCvCAD.ActiveDocument:
                        ...
                        CivilCvCAD.Console.PrintError("Active analysis is not in active document.\n")
                else:
                    CivilCvCAD.Console.PrintLog(
                ...
                CivilCvCAD.Console.PrintLog("No analysis in the active document.\n")
                gui_doc.setEdit(vobj.Object.Name)
        else:
