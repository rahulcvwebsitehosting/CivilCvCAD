...
__title__ = "CivilCvCAD FEM constant vacuum permittivity ViewProvider for the document object"
__author__ = "Bernd Hahnebach"
__url__ = ""
## @package view_constant_vacuumpermittivity
#  \ingroup FEM
#  \brief CivilCvCAD FEM Constant VacuumPermittivity ViewProvider
