...
__title__ = "CivilCvCAD FEM mesh manipulate ViewProvider for the document object"
...
class VPMeshManipulate(view_base_femmeshelement.VPBaseFemMeshElement):
    ...
    def dropObject(self, vp, obj):
        ...
        if self.Object.Refinement:
            ...
            if not gmsh:
                raise CivilCvCAD.CivilCvCADError("Manipulate object not within GMSH mesh object")
