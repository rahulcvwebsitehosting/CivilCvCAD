...
__title__ = "CivilCvCAD FEM postprocessing table ViewProvider for the document object"
...
class EditViewWidget(QtGui.QWidget):
    ...
    def __init__(self, obj, post_dialog):
        ...
        self.widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/PostTableFieldViewEdit.ui"
        )
