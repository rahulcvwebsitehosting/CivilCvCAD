...
https://forum.civilcvcad.org/viewtopic.php?f=18&t=20276
...
def setup(doc=None, solvertype="ccxtools"):
    ...
    bottom_box_obj.Placement = CivilCvCAD.Placement(
        Vector(186, 0, -247),
        Rotation(0, 0, 0),
        Vector(0, 0, 0),
    )
    ...
    # top half cylinder, https://forum.civilcvcad.org/viewtopic.php?f=18&t=43001#p366111
    ...
    top_halfcyl_obj.Placement = CivilCvCAD.Placement(
        Vector(0, -42, 0),
        Rotation(0, 90, 0),
        Vector(0, 0, 0),
    )
