...
def setup(doc=None, solver=None):
    ...
    # 4: Triangle strip
    triangle_2 = Part.makePolygon([CivilCvCAD.Vector(10,0,0),
                                   CivilCvCAD.Vector(10,7,0),
                                   CivilCvCAD.Vector(20,0,0),
                                   CivilCvCAD.Vector(10,0,0),])

    triangle_3 = Part.makePolygon([CivilCvCAD.Vector(10,7,0),
                                   CivilCvCAD.Vector(20,0,0),
                                   CivilCvCAD.Vector(20,7,0),
                                   CivilCvCAD.Vector(10,7,0)])
    ...
    part_obj.Shape = triangle_strip.copy().translate(CivilCvCAD.Vector(45, 0, 0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    ...
    part_obj.Shape = triangle_strip.copy().translate(CivilCvCAD.Vector(70, 0, 0))
    tf_curv = ObjectsFem.makeMeshTransfiniteCurve(doc, mesh_obj)
    ...
    part_obj.Shape = triangle_strip.copy().translate(CivilCvCAD.Vector(95, 0, 0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    ...
    part_obj.Shape = triangle_strip.copy().translate(CivilCvCAD.Vector(120, 0, 0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.References = [(part_obj, ["Face1", "Face2", "Face3", "Vertex3"])]
    tf_surf.Recombine = True
    tf_surf.UseAutomation = True
    ...
    quad1 = Part.makePolygon([CivilCvCAD.Vector(0,3,0),
                              CivilCvCAD.Vector(10,5,0),
                              CivilCvCAD.Vector(10,10,0),
                              CivilCvCAD.Vector(4,7,0),
                              CivilCvCAD.Vector(0,3,0)])

    triangle1 = Part.makePolygon([CivilCvCAD.Vector(0,3,0),
                                  CivilCvCAD.Vector(10,0,0),
                                  CivilCvCAD.Vector(10,5,0),
                                  CivilCvCAD.Vector(0,3,0)])

    quad2 = Part.makePolygon([CivilCvCAD.Vector(10,0,0),
                              CivilCvCAD.Vector(10,5,0),
                              CivilCvCAD.Vector(17,5,0),
                              CivilCvCAD.Vector(20,0,0),
                              CivilCvCAD.Vector(10,0,0)])

    triangle2 = Part.makePolygon([CivilCvCAD.Vector(10,5,0),
                                  CivilCvCAD.Vector(17,5,0),
                                  CivilCvCAD.Vector(10,10,0),
                                  CivilCvCAD.Vector(10,5,0)])
    ...
    part_obj.Shape = quad_strip.copy().translate(CivilCvCAD.Vector(20, -15, 0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    ...
    part_obj.Shape = quad_strip.copy().translate(CivilCvCAD.Vector(45, -15, 0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    ...
    part_obj.Shape = quad_strip.copy().translate(CivilCvCAD.Vector(70, -15, 0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.References = [(part_obj, [f"Face{i}" for i in range(1,5)] + ["Vertex2"])]
    tf_surf.Recombine = True
    tf_surf.UseAutomation = True
    ...
    part_obj.Shape = quad_strip.copy().translate(CivilCvCAD.Vector(95, -15, 0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    ...
    part_obj.Shape = wedge.copy().translate(CivilCvCAD.Vector(0, -30, 0))
    ...
    part_obj.Shape = wedge.copy().translate(CivilCvCAD.Vector(15, -30, 0))
    tf_vol = ObjectsFem.makeMeshTransfiniteVolume(doc, mesh_obj)
    tf_vol.References = [(part_obj, ["Solid1"])]
    tf_vol.UseAutomation = True
    tf_vol.Recombine = True
    ...
    part_obj.Shape = wedge.copy().translate(CivilCvCAD.Vector(30, -30, 0))
    tf_vol = ObjectsFem.makeMeshTransfiniteVolume(doc, mesh_obj)
    tf_vol.References = [(part_obj, ["Solid1"])]
    tf_vol.UseAutomation = True
    tf_vol.Recombine = True
