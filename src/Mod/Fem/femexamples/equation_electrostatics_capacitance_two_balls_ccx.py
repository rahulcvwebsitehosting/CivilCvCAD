...
def setup(doc=None, solvertype="calculix"):
    ...
    small_sphere1.Placement = CivilCvCAD.Placement(Vector(-300, 0, 0), Rotation(Vector(0, 0, 1), 0))
    small_sphere1.Radius = "100 mm"

    small_sphere2 = doc.addObject("Part::Sphere", "Small_Sphere2")
    small_sphere2.Placement = CivilCvCAD.Placement(Vector(300, 0, 0), Rotation(Vector(0, 0, 1), 0))
