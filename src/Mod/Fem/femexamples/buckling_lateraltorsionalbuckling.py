...
https://forum.civilcvcad.org/viewtopic.php?f=18&t=20217&start=110#p510526
...
def setup(doc=None, solvertype="ccxtools"):
    ...
    web.Length = 10000
    web.Width = 278.6
    web.Placement = CivilCvCAD.Placement(
        CivilCvCAD.Vector(0, 75, 0),
        CivilCvCAD.Rotation(0, 0, 90),
