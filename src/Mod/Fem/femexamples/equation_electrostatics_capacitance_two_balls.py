...
import sys
import CivilCvCAD
from CivilCvCAD import Rotation
...
https://forum.civilcvcad.org/viewtopic.php?f=18&t=41488&start=90#p412047

Electrostatics equation in CivilCvCAD FEM-Elmer
...
def setup(doc=None, solvertype="elmer"):
    ...
    small_sphere1.Placement = CivilCvCAD.Placement(Vector(-1000, 0, 0), Rotation(Vector(0, 0, 1), 0))
    small_sphere1.Radius = "500 mm"

    small_sphere2 = doc.addObject("Part::Sphere", "Small_Sphere2")
    small_sphere2.Placement = CivilCvCAD.Placement(Vector(1000, 0, 0), Rotation(Vector(0, 0, 1), 0))
