...
https://forum.civilcvcad.org/viewtopic.php?f=18&t=42228
based on https://forum.civilcvcad.org/viewtopic.php?f=18&t=42228#p359488
...
def setup(doc=None, solvertype="ccxtools"):
    ...
    sh_lower_tube = sh_lower_circle.extrude(CivilCvCAD.Vector(0, 0, tube_length))
    ...
    sh_upper_tube = sh_upper_circle.extrude(CivilCvCAD.Vector(0, 0, tube_length))
    sh_upper_tube.reverse()
    upper_tube = doc.addObject("Part::Feature", "Upper_tube")
    upper_tube.Shape = sh_upper_tube
    upper_tube.Placement = CivilCvCAD.Placement(
        CivilCvCAD.Vector(-25, 51, 475),
        CivilCvCAD.Rotation(90, 0, 90),
        CivilCvCAD.Vector(0, 0, 0),
    )

    # point for load
    v_force_pt = CivilCvCAD.Vector(0, 76, 475)
    ...
    sh_load_line = Part.makeLine(v_force_pt, CivilCvCAD.Vector(0, 150, 475))
