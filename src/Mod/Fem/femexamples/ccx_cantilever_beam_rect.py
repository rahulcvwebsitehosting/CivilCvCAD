...
https://forum.civilcvcad.org/viewtopic.php?f=18&t=16044
...
def setup(doc=None, solvertype="ccxtools"):
    ...
    cs_face.Placement = CivilCvCAD.Placement(
        CivilCvCAD.Vector(0, 500 - 0.5 * width, 500 + 0.5 * height),
        CivilCvCAD.Rotation(0, 90, 0),
