...
def setup(doc=None, solvertype="elmer"):
    ...
    p1 = CivilCvCAD.Vector(400, -50.000, 0)
    p2 = CivilCvCAD.Vector(400, -150.000, 0)
    p3 = CivilCvCAD.Vector(1200, -150.000, 0)
    p4 = CivilCvCAD.Vector(1200, 50.000, 0)
    p5 = CivilCvCAD.Vector(0, 50.000, 0)
    p6 = CivilCvCAD.Vector(0, -50.000, 0)
    wire = Part.makePolygon([p1, p2, p3, p4, p5, p6, p1])
    circ_center = CivilCvCAD.Vector(160, 0, 0)
