...
def setup(doc=None, solver=None):
    ...
    # init CivilCvCAD document
    if doc is None:
        doc = init_doc()

    triangle = Part.makePolygon([CivilCvCAD.Vector(0,0,0),
                                 CivilCvCAD.Vector(10,0,0),
                                 CivilCvCAD.Vector(5,8,0),
    ...
    part_obj.Shape = Part.makeFace(triangle).translate(CivilCvCAD.Vector(15,0,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.References = [(part_obj, ["Face1"])]
    ...
    part_obj.Shape = Part.makeFace(triangle).translate(CivilCvCAD.Vector(30,0,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.References = [(part_obj, ["Face1"])]
    tf_surf.Recombine = True
    ...
    part_obj.Shape = Part.makeFace(triangle).translate(CivilCvCAD.Vector(45,0,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.References = [(part_obj, ["Face1", "Vertex3", "Vertex2", "Vertex1"])]
    tf_surf.Recombine = True

    smalltriangle = Part.makePolygon([CivilCvCAD.Vector(0,0,0),
                                      CivilCvCAD.Vector(10,0,0),
                                      CivilCvCAD.Vector(5,5,0),
                                      CivilCvCAD.Vector(0,0,0)])
    ...
    part_obj.Shape = Part.makeFace(smalltriangle).translate(CivilCvCAD.Vector(60,0,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.References = [(part_obj, ["Face1"])]
    tf_surf.Recombine = True
    tf_curv = ObjectsFem.makeMeshTransfiniteCurve(doc, mesh_obj)
    ...
    part_obj.Shape = Part.makeFace(smalltriangle).translate(CivilCvCAD.Vector(75,0,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.References = [(part_obj, ["Face1", "Vertex3"])]
    tf_surf.Recombine = True

    quad = Part.makePolygon([CivilCvCAD.Vector(0,0,0),
                             CivilCvCAD.Vector(10,0,0),
                             CivilCvCAD.Vector(10,10,0),
                             CivilCvCAD.Vector(0,10,0),
                             CivilCvCAD.Vector(0,0,0)])
    ...
    part_obj.Shape = Part.makeFace(quad).translate(CivilCvCAD.Vector(0,-15,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.References = [(part_obj, ["Face1"])]
    ...
    part_obj.Shape = Part.makeFace(quad).translate(CivilCvCAD.Vector(15,-15,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.References = [(part_obj, ["Face1"])]
    tf_surf.Recombine = True
    ...
    part_obj.Shape = Part.makeFace(quad).translate(CivilCvCAD.Vector(30,-15,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.References = [(part_obj, ["Face1"])]
    tf_surf.Recombine = True
    tf_curv = ObjectsFem.makeMeshTransfiniteCurve(doc, mesh_obj)
    ...
    distorted_quad = Part.makePolygon([CivilCvCAD.Vector(0,0,0),
                                       CivilCvCAD.Vector(10,3,0),
                                       CivilCvCAD.Vector(7,10,0),
                                       CivilCvCAD.Vector(3,5,0),
                                       CivilCvCAD.Vector(0,0,0)])
    ...
    part_obj.Shape = Part.makeFace(distorted_quad).translate(CivilCvCAD.Vector(45,-15,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.References = [(part_obj, ["Face1"])]
    tf_surf.Recombine = True
    tf_curv = ObjectsFem.makeMeshTransfiniteCurve(doc, mesh_obj)
    ...
    bSpline1.interpolate([CivilCvCAD.Vector(0,0,0), CivilCvCAD.Vector(3.3,0.5,0),
                          CivilCvCAD.Vector(6.6,-0.5,0), CivilCvCAD.Vector(10,0,0)])
    bSpline2 = Part.BSplineCurve()
    bSpline2.interpolate([CivilCvCAD.Vector(10,0,0), CivilCvCAD.Vector(10.5,3.3,0),
                          CivilCvCAD.Vector(9.5,6.6,0), CivilCvCAD.Vector(10,10,0)])
    bSpline3 = Part.BSplineCurve()
    bSpline3.interpolate([CivilCvCAD.Vector(10,10,0), CivilCvCAD.Vector(6.6,10.5,0),
                          CivilCvCAD.Vector(3.3,9.5,0), CivilCvCAD.Vector(0,10,0)])
    bSpline4 = Part.BSplineCurve()
    bSpline4.interpolate([CivilCvCAD.Vector(0,10,0), CivilCvCAD.Vector(-0.5,7,0), CivilCvCAD.Vector(0.5,5,0),
                          CivilCvCAD.Vector(-0.5,3,0), CivilCvCAD.Vector(0,0,0)])
    ...
    part_obj.Shape = face.translate(CivilCvCAD.Vector(60,-15,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.References = [(part_obj, ["Face1"])]
    tf_surf.Recombine = True
    tf_curv = ObjectsFem.makeMeshTransfiniteCurve(doc, mesh_obj)
    ...
    bSpline1 = Part.BSplineCurve()
    bSpline1.interpolate([CivilCvCAD.Vector(0,0,0), CivilCvCAD.Vector(3.3,1,1),
                          CivilCvCAD.Vector(6.6,-1,-1), CivilCvCAD.Vector(10,0,1)])
    bSpline2 = Part.BSplineCurve()
    bSpline2.interpolate([CivilCvCAD.Vector(10,0,1), CivilCvCAD.Vector(10,3.3,0),
                          CivilCvCAD.Vector(10,6.6,2), CivilCvCAD.Vector(10,10,1)])
    bSpline3 = Part.BSplineCurve()
    bSpline3.interpolate([CivilCvCAD.Vector(10,10,1), CivilCvCAD.Vector(6.6,11,-1),
                          CivilCvCAD.Vector(3.3,9,1), CivilCvCAD.Vector(0,10,0)])
    bSpline4 = Part.BSplineCurve()
    bSpline4.interpolate([CivilCvCAD.Vector(0,10,0), CivilCvCAD.Vector(-1,7,-1), CivilCvCAD.Vector(1,5,1),
                          CivilCvCAD.Vector(-1,3,-1), CivilCvCAD.Vector(0,0,0)])
    ...
    part_obj.Shape = face.translate(CivilCvCAD.Vector(75,-15,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.References = [(part_obj, ["Face1"])]
    tf_surf.Recombine = True
    tf_curv = ObjectsFem.makeMeshTransfiniteCurve(doc, mesh_obj)
    ...
    for i in range(6):
        ...
        x = 5*math.cos(angle)
        y = 5*math.sin(angle)
        points.append(CivilCvCAD.Vector(x, y, 0))
    ...
    part_obj.Shape = Part.makeFace(hexagon).translate(CivilCvCAD.Vector(5,-25,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.Recombine = True
    ...
    part_obj.Shape = Part.makeFace(hexagon).translate(CivilCvCAD.Vector(20,-25,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.Recombine = True
    ...
    part_obj.Shape = Part.makeFace(hexagon).translate(CivilCvCAD.Vector(35,-25,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.Recombine = True
    ...
    part_obj.Shape = Part.makeFace(hexagon).translate(CivilCvCAD.Vector(50,-25,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.Recombine = True
    ...
    # 16: Two faces
    triangle_2f = Part.makePolygon([CivilCvCAD.Vector(0,5,0),
                                    CivilCvCAD.Vector(5,5,0),
                                    CivilCvCAD.Vector(2.5,9,0),
                                    CivilCvCAD.Vector(0,5,0)])
    quad_2f = Part.makePolygon([CivilCvCAD.Vector(0,0,0),
                                CivilCvCAD.Vector(5,0,0),
                                CivilCvCAD.Vector(5,5,0),
                                CivilCvCAD.Vector(0,5,0),
                                CivilCvCAD.Vector(0,0,0)])
    ...
    part_obj.Shape = combined.copy().translate(CivilCvCAD.Vector(2.5,-45,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.Recombine = True
    ...
    part_obj.Shape = combined.copy().translate(CivilCvCAD.Vector(17.5,-45,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.Recombine = True
    tf_surf.References = [(part_obj, ["Face1", "Vertex3", "Vertex2", "Vertex1"])]
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    ...
    part_obj.Shape = combined.copy().translate(CivilCvCAD.Vector(32.5,-45,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.Recombine = True
    tf_surf.References = [(part_obj, ["Face1", "Vertex3", "Vertex2", "Vertex1"])]
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    ...
    wedge = Part.makeFace(triangle).extrude(CivilCvCAD.Vector(2,0,10))
    ...
    part_obj.Shape = wedge.copy().translate(CivilCvCAD.Vector(0,-60,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    ...
    part_obj.Shape = wedge.copy().translate(CivilCvCAD.Vector(15,-60,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.Recombine = True
    tf_surf.References = [(part_obj, [f"Face{i}" for i in range(1,6)])]
    tf_vol = ObjectsFem.makeMeshTransfiniteVolume(doc, mesh_obj)
    ...
    part_obj.Shape = wedge.copy().translate(CivilCvCAD.Vector(30,-60,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.Recombine = True
    ...
    part_obj.Shape = wedge.copy().translate(CivilCvCAD.Vector(45,-60,0))
    tf_curv = ObjectsFem.makeMeshTransfiniteCurve(doc, mesh_obj)
    ...
    # point = Part.Vertex(CivilCvCAD.Vector(5,5,6))
    ...
    # part_obj.Shape = pyramid.copy().translate(CivilCvCAD.Vector(60,-60,0))
    # tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    # tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    # tf_surf.References = [(part_obj, [f"Face{i}" for i in range(1,6)])]
    # tf_vol = ObjectsFem.makeMeshTransfiniteVolume(doc, mesh_obj)
    ...
    rotation = Part.makeFace(triangle).revolve(CivilCvCAD.Vector(15,0,0), CivilCvCAD.Vector(-0.2,1,0), 120)
    ...
    part_obj.Shape = rotation.copy().translate(CivilCvCAD.Vector(60,-60,0))
    tf_curv = ObjectsFem.makeMeshTransfiniteCurve(doc, mesh_obj)
    tf_curv.References = [(part_obj, [f"Edge{i}" for i in range(1,10)])]
    tf_curv.Nodes = 7
    tf_curv.Distribution = "Bump"
    ...
    cube = Part.makeFace(quad).extrude(CivilCvCAD.Vector(2,0,10))
    explanation = ("")

    part_obj, mesh_obj = create_example(doc, "Cube Volume", explanation)
    part_obj.Shape = cube.copy().translate(CivilCvCAD.Vector(0,-75,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    ...
    part_obj.Shape = cube.copy().translate(CivilCvCAD.Vector(15,-75,0))
    tf_surf = ObjectsFem.makeMeshTransfiniteSurface(doc, mesh_obj)
    tf_surf.Recombine = True
    tf_surf.References = [(part_obj, [f"Face{i}" for i in range(1,7)])]
    tf_vol = ObjectsFem.makeMeshTransfiniteVolume(doc, mesh_obj)
    ...
    part_obj.Shape = cube.copy().translate(CivilCvCAD.Vector(30,-75,0))
    tf_curv = ObjectsFem.makeMeshTransfiniteCurve(doc, mesh_obj)
    ...
    wire = Part.Wire([Part.Edge(bSpline1), Part.Edge(bSpline2), Part.Edge(bSpline3), Part.Edge(bSpline4)])
    face = Part.makeFilledFace(wire)
    cube = face.revolve(CivilCvCAD.Vector(15,0,0), CivilCvCAD.Vector(-0.2,1,0), 120)

    explanation = ("And of course all transfinite settings works for 3D cuved faces as well")

    part_obj, mesh_obj = create_example(doc, "Cube Volume Curved Recombined Bumped", explanation)
    part_obj.Shape = cube.translate(CivilCvCAD.Vector(45,-75,0))
    tf_curv = ObjectsFem.makeMeshTransfiniteCurve(doc, mesh_obj)
    tf_curv.References = [(part_obj, [f"Edge{i}" for i in range(1,13)])]
    tf_curv.Distribution = "Bump"
    tf_curv.Coefficient = 5
