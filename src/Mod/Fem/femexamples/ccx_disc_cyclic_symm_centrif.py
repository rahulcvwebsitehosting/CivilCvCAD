...
def setup(doc=None, solvertype="ccxtools"):
    ...
    cylinder1.Placement = CivilCvCAD.Placement(Vector(0, 0, 0), Rotation(Vector(0, 0, 1), 0))
    ...
    cylinder2.Placement = CivilCvCAD.Placement(Vector(0, 0, 0), Rotation(Vector(0, 0, 1), 0))
    ...
    axis.Placement = CivilCvCAD.Placement(Vector(0, 0, 0), Rotation(Vector(0, 0, 1), 0))
    axis.X1 = "0.00 mm"
    axis.Y1 = "0.00 mm"
    axis.Z1 = "0.00 mm"
    axis.X2 = "0.00 mm"
