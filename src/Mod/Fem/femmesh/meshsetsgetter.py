...
__title__ = "CivilCvCAD FEM sets getter"
...
class MeshSetsGetter:
    def __init__(self, analysis_obj, solver_obj, mesh_obj, member):
        ...
        self.fc_ver = CivilCvCAD.Version()
        self.ccx_nall = "Nall"
        self.ccx_eall = "Eall"
    ...
    def get_mesh_sets(self):
        ...
        CivilCvCAD.Console.PrintMessage(f"Getting mesh data time: {setstime} seconds.\n")
    ...
    def get_constraints_fixed_nodes(self):
        ...
        for femobj in self.member.cons_fixed:
            # femobj --> dict, CivilCvCAD document object is femobj["Object"]
        ...
        if self.femmesh.Volumes and (
            ...
            CivilCvCAD.Console.PrintMessage("We need to find the solid nodes.\n")
    ...
    def get_constraints_force_nodeloads(self):
        ...
        for femobj in self.member.cons_force:
            ...
            if frc_obj.Force == 0:
                CivilCvCAD.Console.PrintMessage("  Warning --> Force = 0\n")
    ...
    # forum post: https://forum.civilcvcad.org/viewtopic.php?f=18&t=42783&p=370286#p366723
    ...
    def get_solid_element_sets(self, femobjs):
        ...
        if self.femmesh.GroupCount:
            ...
            CivilCvCAD.Console.PrintMessage(all_found)
            CivilCvCAD.Console.PrintMessage("\n")
    ...
    def get_element_geometry2D_elements(self):
        ...
        CivilCvCAD.Console.PrintMessage("Shell thicknesses\n")
    ...
    def get_element_geometry1D_elements(self):
        # get element ids and write them into the objects
        CivilCvCAD.Console.PrintMessage("Beam sections\n")
    ...
    def get_element_rotation1D_elements(self):
        ...
        CivilCvCAD.Console.PrintMessage("Beam rotations\n")
    ...
    def get_element_fluid1D_elements(self):
        # get element ids and write them into the objects
        CivilCvCAD.Console.PrintMessage("Fluid sections\n")
        if not self.femelement_edges_table:
            self.femelement_edges_table = meshtools.get_femelement_edges_table(self.femmesh)
        meshtools.get_femelement_sets(
    ...
    def get_material_elements(self):
        ...
        CivilCvCAD.Console.PrintMessage("Materials\n")
...
def print_obj_info(obj, log=False):
    if log is False:
        CivilCvCAD.Console.PrintMessage(f"{obj.Label}:\n")
        CivilCvCAD.Console.PrintMessage(f"    Type: {type_of_obj(obj)}, Name: {obj.Name}\n")
    else:
        CivilCvCAD.Console.PrintLog(f"{obj.Label}:\n")
        CivilCvCAD.Console.PrintLog(f"    Type: {type_of_obj(obj)}, Name: {obj.Name}\n")
