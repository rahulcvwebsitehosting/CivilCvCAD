...
#  \ingroup FEM
#  \brief CivilCvCAD Fenics Mesh reader and writer for FEM workbench
    ...
    class WriteXDMFTaskPanel:
        ...
        def __init__(self, fem_mesh_obj, fileString):
            self.form = CivilCvCADGui.PySideUic.loadUi(
                os.path.join(CivilCvCAD.getHomePath(), "Mod/Fem/Resources/ui/MeshGroupXDMFExport.ui")
            )
            self.result_dict = {}
