...
__title__ = "CivilCvCAD Fenics XDMF mesh writer"
__author__ = "Johannes Hartung"
__url__ = ""
## @package exportFenicsXDMF
#  \ingroup FEM
#  \brief CivilCvCAD Fenics Mesh XDMF writer for FEM workbench
...
CivilCvCAD_Group_Dimensions = {"Vertex": 0, "Edge": 1, "Face": 2, "Volume": 3}

CivilCvCAD_to_Fenics_XDMF_dict = {
    ("Node", 1): ("Polyvertex", 1),
    ("Edge", 1): ("Polyline", 2),
    ("Edge", 2): ("Edge_3", 3),
...
def write_fenics_mesh_codim_xdmf(
    ...
    topology_type, nodes_per_element = CivilCvCAD_to_Fenics_XDMF_dict[(name_topo, element_order)]
...
def write_fenics_mesh_xdmf(fem_mesh_obj, outputfile, group_values_dict={}, encoding=ENCODING_ASCII):
    ...
    for g in gmshgroups:
        ...
        mesh_function_codim = dim_cell - CivilCvCAD_Group_Dimensions[mesh_function_type]
