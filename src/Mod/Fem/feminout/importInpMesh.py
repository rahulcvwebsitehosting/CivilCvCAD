...
#  \ingroup FEM
#  \brief CivilCvCAD INP file reader for FEM workbench
...
def import_inp(filename):
    """read a FEM mesh from a Z88 mesh file and insert a CivilCvCAD FEM Mesh object in the ActiveDocument"""
...
def read_inp(file_name):
    ...
    # switch from the CalculiX node numbering to the CivilCvCAD node numbering
