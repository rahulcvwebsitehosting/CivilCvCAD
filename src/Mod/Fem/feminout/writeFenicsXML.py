...
__title__ = "CivilCvCAD Fenics XML mesh writer"
__author__ = "Johannes Hartung"
__url__ = ""
## @package exportFenicsXML
#  \ingroup FEM
#  \brief CivilCvCAD Fenics Mesh XML writer for FEM workbench
...
def write_fenics_mesh_xml(fem_mesh_obj, outputfile):
    ...
    cellname_fenics = CivilCvCAD_to_Fenics_dict[cellname_fc]
