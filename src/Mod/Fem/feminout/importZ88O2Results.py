...
#  \ingroup FEM
#  \brief CivilCvCAD Z88 Disp Reader for FEM workbench
...
def import_z88_disp(filename, analysis=None, result_name_prefix=None):
    """insert a CivilCvCAD FEM mechanical result object in the ActiveDocument
    pure usage:
    ...
    if len(disp_read["Nodes"]) > 0:
        ...
        if filename.endswith("z88o2.txt"):
            ...
            result_mesh_object = ObjectsFem.makeMeshResult(CivilCvCAD.ActiveDocument, "Result_mesh")
        ...
        for result_set in disp_read["Results"]:
            ...
            res_obj = ObjectsFem.makeResultMechanical(CivilCvCAD.ActiveDocument, results_name)
    ...
    for no, line in enumerate(z88_disp_file):
        ...
        if lno >= 6:
            ...
            if len(linelist) > 3:
                ...
                mode_disp_z = 0.0
            mode_disp[node_no] = CivilCvCAD.Vector(mode_disp_x, mode_disp_y, mode_disp_z)
