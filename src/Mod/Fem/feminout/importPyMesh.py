...
__title__ = "CivilCvCAD Python Mesh reader and writer"
__author__ = "Bernd Hahnebach"
__url__ = ""
## @package importPyMesh
#  \ingroup FEM
#  \brief CivilCvCAD Python Mesh reader and writer for FEM workbench
...
def export(objectslist, filename):
    ...
    if len(objectslist) != 1:
        CivilCvCAD.Console.PrintError("This exporter can only export one object.\n")
        return

    obj = objectslist[0]
    if not obj.isDerivedFrom("Fem::FemMeshObject"):
        CivilCvCAD.Console.PrintError("No FEM mesh object selected.\n")
        return
...
def write(fem_mesh, filename):
    ...
    if not fem_mesh.isDerivedFrom("Fem::FemMesh"):
        CivilCvCAD.Console.PrintError("Not a FemMesh was given as parameter.\n")
        return
    ...
    if meshtools.is_solid_femmesh(fem_mesh):
        ...
        CivilCvCAD.Console.PrintError("Export of this FEM mesh to Python not supported.\n")
        return
    f = open(filename, "w")
