...
#  \ingroup FEM
#  \brief CivilCvCAD pyNastran Mesh writer for FEM workbench

import CivilCvCAD

# we need to import CivilCvCAD before the non CivilCvCAD library because of the print
try:
...
# ************************************************************************************************
# ********* generic CivilCvCAD export methods *******************************************************
...
def write(fem_mesh, filename):
    ...
    pynasf.write("# written by CivilCvCAD\n\n\n")
...
def get_pynastran_mesh(
    ...
    # elements
    # Nastran seems to have the same node order as SMESH (CivilCvCAD) has
