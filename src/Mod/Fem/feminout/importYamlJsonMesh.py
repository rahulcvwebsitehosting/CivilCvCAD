...
__title__ = "CivilCvCAD YAML and JSON mesh reader and writer"
__author__ = "Johannes Hartung"
__url__ = ""
## @package importYAMLJSONMesh
#  \ingroup FEM
#  \brief CivilCvCAD YAML and JSON Mesh reader and writer for FEM workbench
...
def import_yaml_json_mesh(fileString):
    ...
    if femmesh:
        mesh_object = CivilCvCAD.ActiveDocument.addObject("Fem::FemMeshObject", mesh_name)
