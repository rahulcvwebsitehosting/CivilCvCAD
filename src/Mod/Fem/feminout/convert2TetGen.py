...
__title__ = "CivilCvCAD tetgen exporter"
...
App = CivilCvCAD  # shortcut
if CivilCvCAD.GuiUp:
    import CivilCvCADGui

    Gui = CivilCvCADGui  # shortcut
...
def exportMeshToTetGenPoly(meshToExport, filePath, beVerbose=1):
    ...
    f = open(filePath, "w")
    f.write("# This file was generated from CivilCvCAD geometry\n")
...
def export(objectslist, filename):
    """Called when civilcvcad exports a mesh to poly format"""
