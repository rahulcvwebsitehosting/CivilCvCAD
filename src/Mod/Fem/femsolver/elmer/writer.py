...
__title__ = "CivilCvCAD FEM solver Elmer writer"
...
from CivilCvCAD import ParamGet
...
class Writer:
    ...
    def _handleUnits(self):
        # Elmer solver writer no longer uses CivilCvCAD unit system
        # to retrieve units for writing the sif file
        #
        # ATM Elmer writer uses SI units only
        #
        # see forum topic: https://forum.civilcvcad.org/viewtopic.php?f=18&t=70150
        #
        # TODO: adapt method and comment
        # should be only one system for all solver and not in each solver
        # https://forum.civilcvcad.org/viewtopic.php?t=47895
        # https://forum.civilcvcad.org/viewtopic.php?t=48451
        # https://forum.civilcvcad.org/viewtopic.php?f=10&t=48642
        # The CivilCvCAD unit schema is only used to determine the schema number
        ...
        # TODO retrieve the seven base units from CivilCvCAD unit schema
        # instead of hard coding them here for a second once
        self.unit_schema = Units.Scheme.Internal
        self.unit_system = {  # standard CivilCvCAD Base units = unit schema 0
            "L": "m",
            "M": "kg",
            "T": "s",
            "I": "A",
        ...
        if self.unit_schema == Units.Scheme.Internal:
            Console.PrintMessage(
                "The CivilCvCAD standard unit schema mm/kg/s is used. "
            ...
            Console.PrintMessage(
                ...
                "The CivilCvCAD standard unit schema mm/kg/s is used. "
                "Elmer sif-file writing is done in Standard CivilCvCAD units.\n".format(
    ...
    def _addOutputSolver(self):
        s = sifio.createSection(sifio.SOLVER)
        # Since CivilCvCAD meshes are in mm we let Elmer scale it
        ...
        s["Output File Name"] = sifio.FileAttr("CivilCvCAD")
        s["Vtu Format"] = True
