...
__title__ = "CivilCvCAD FEM solver object Mystran"
...
class Proxy(solverbase.Proxy):
    ...
    def __init__(self, obj):
        ...
        # mystran_prefs = CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/Fem/Mystran")
    ...
    def edit(self, directory):
        ...
        CivilCvCAD.Console.PrintMessage(f"{pattern}\n")
