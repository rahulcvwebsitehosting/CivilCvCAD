...
__title__ = "CivilCvCAD FEM solver Mystran tasks"
...
try:
    ...
    CivilCvCAD.Console.PrintWarning("Module to read results not found.\n")
...
class Results(run.Results):
    ...
    def run(self):
        prefs = CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/Fem/General")
    ...
    def load_results(self):
        ...
        if os.path.isfile(neu_result_file):
            ...
            CivilCvCAD.Console.PrintError(f"FEM: No results found at {neu_result_file}!\n")
            self.fail()
