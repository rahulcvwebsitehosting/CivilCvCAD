...
__title__ = "CivilCvCAD FEM calculix write inpfile step equation"
...
def write_step_equation(f, ccxwriter):
    ...
    f.write("\n{}\n".format(59 * "*"))
    f.write("** At least one step is needed to run an CalculiX analysis of CivilCvCAD\n")
    ...
    # https://forum.civilcvcad.org/viewtopic.php?f=18&t=43178
