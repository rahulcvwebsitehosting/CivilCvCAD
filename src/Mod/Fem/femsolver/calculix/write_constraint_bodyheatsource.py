...
__title__ = "CivilCvCAD FEM calculix constraint body heat source"
...
def write_constraint(f, femobj, bodyheatsource_obj, ccxwriter):
    ...
    for index, (ref_feat, ref_sub_obj) in enumerate(ref_iter):
        ...
        density = CivilCvCAD.Units.Quantity(mat["Density"])
        ...
        if bodyheatsource_obj.Mode == "Dissipation Rate":
            ...
            heat = bodyheatsource_obj.TotalPower / CivilCvCAD.Units.Quantity(volume, "mm^3")
