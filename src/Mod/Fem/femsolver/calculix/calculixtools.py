...
class CalculiXTools(ObjectTools):
    ...
    def _load_vtk_results(self):
        ...
        if create and CivilCvCAD.GuiUp:
    ...
    def _generate_disp_mesh(self, mb):
        try:
            ...
            CivilCvCAD.Console.PrintWarning("Displaced mesh not generated\n")
            return mb
    ...
    def _generate_derived_result(self, mb):
        try:
            ...
            # return original data
            CivilCvCAD.Console.PrintWarning("Derived result not generated\n")
            return mb

    def _set_time_info(self, pipeline):
        match self.obj.AnalysisType:
            case "frequency":
                pipeline.setTimeInfo("Frequency", CivilCvCAD.Units.Frequency)
            case "buckling":
                pipeline.setTimeInfo("Buckling factor", CivilCvCAD.Units.Unit())
            case _:
                pipeline.setTimeInfo("TimeStep", CivilCvCAD.Units.TimeSpan)
