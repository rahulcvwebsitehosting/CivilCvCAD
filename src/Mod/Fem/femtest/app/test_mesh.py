...
class TestMeshCommon(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # new document
        self.document = CivilCvCAD.newDocument(self.__class__.__name__)

    # ********************************************************************************************
    def tearDown(self):
        # tearDown is executed after every test
        CivilCvCAD.closeDocument(self.document.Name)
    ...
    def test_mesh_seg2_python(self):
        ...
        expected_nodes = [
            3,
            {
                1: CivilCvCAD.Vector(0.0, 0.0, 0.0),
                2: CivilCvCAD.Vector(2.0, 0.0, 0.0),
                3: CivilCvCAD.Vector(4.0, 0.0, 0.0),
            },
        ]
    ...
    def test_mesh_seg3_python(self):
        ...
        expected_nodes = [
            ...
            {
                1: CivilCvCAD.Vector(0.0, 0.0, 0.0),
                2: CivilCvCAD.Vector(1.0, 0.0, 0.0),
                3: CivilCvCAD.Vector(2.0, 0.0, 0.0),
                4: CivilCvCAD.Vector(3.0, 0.0, 0.0),
                5: CivilCvCAD.Vector(4.0, 0.0, 0.0),
            },
        ]
...
class TestMeshEleTetra10(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.expected_nodes = {
            "count": 10,
            "nodes": {
                1: CivilCvCAD.Vector(6.0, 12.0, 18.0),
                2: CivilCvCAD.Vector(0.0, 0.0, 18.0),
                3: CivilCvCAD.Vector(12.0, 0.0, 18.0),
                4: CivilCvCAD.Vector(6.0, 6.0, 0.0),
                5: CivilCvCAD.Vector(3.0, 6.0, 18.0),
                6: CivilCvCAD.Vector(6.0, 0.0, 18.0),
                7: CivilCvCAD.Vector(9.0, 6.0, 18.0),
                8: CivilCvCAD.Vector(6.0, 9.0, 9.0),
                9: CivilCvCAD.Vector(3.0, 3.0, 9.0),
                10: CivilCvCAD.Vector(9.0, 3.0, 9.0),
            },
        }
        self.expected_elem = {
            "volcount": 1,
