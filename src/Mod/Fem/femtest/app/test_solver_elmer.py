...
class TestSolverElmer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # set Units
        # since in Elmer writer the CivilCvCAD pref is used, here we need to set the CivilCvCAD pref
        # the use of CivilCvCAD.Units.setScheme would not take affect because the pref is not changed
        # see https://forum.civilcvcad.org/viewtopic.php?t=48451
        param = CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/Units")
    ...
    def test_box_static_0_mm(self):
        ...
        # fcc_print("Save CivilCvCAD file to {}...".format(save_fc_file))
    ...
    def input_file_writing_test(self, base_name):
        ...
        # get analysis working directory and save CivilCvCAD file
