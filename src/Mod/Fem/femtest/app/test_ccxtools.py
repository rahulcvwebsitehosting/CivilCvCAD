...
class TestCcxTools(unittest.TestCase):
    ...
    def input_file_writing_test(
        ...
        fcc_print(f"Save CivilCvCAD file for {base_name} to {save_fc_file}...")
...
def create_test_results():
    ...
    doc_static_cube = CivilCvCAD.open(join(static_analysis_dir, "cube_static.FCStd"))
    ...
    doc_frequency_cube = CivilCvCAD.open(join(frequency_analysis_dir, "cube_frequency.FCStd"))
...
run make
start CivilCvCAD and run FEM unit test
