...
class TestObjectCreate(unittest.TestCase):
    ...
    def test_femobjects_make(self):
        ...
        vtk_objects_used = "BUILD_FEM_VTK" in CivilCvCAD.__cmake__
        ...
        # https://forum.civilcvcad.org/viewtopic.php?t=25283
        ...
        failed = 0
        if vtk_objects_used and not ("BUILD_FEM_VTK_PYTHON" in CivilCvCAD.__cmake__):
        ...
        fcc_print(f"Save CivilCvCAD all objects file to {save_fc_file} ...")
