...
__title__ = "CivilCvCAD FEM constraint body heat source document object"
...
class ConstraintBodyHeatSource(base_fempythonobject.BaseFemPythonObject):
    ...
    def onDocumentRestored(self, obj):
        ...
        for prop in self._get_properties():
            ...
            except CivilCvCAD.Base.PropertyError:
                prop.add_to_object(obj)

        # migrate old HeatSource property
        try:
            value = obj.getPropertyByName("HeatSource")
            obj.DissipationRate = CivilCvCAD.Units.Quantity(value, "W/kg")
