...
__title__ = "CivilCvCAD FEM constraint self weight document object"
...
class ConstraintSelfWeight(base_fempythonobject.BaseFemPythonObject):
    ...
    def __init__(self, obj):
        ...
        # https://wiki.civilcvcad.org/Scripted_objects#Property_Type
        # https://forum.civilcvcad.org/viewtopic.php?f=18&t=13460&start=20#p109709
        # https://forum.civilcvcad.org/viewtopic.php?t=25524
    ...
    def addProperty(self, obj):
        ...
        obj.GravityDirection = CivilCvCAD.Vector(0, 0, -1)
    ...
    def onDocumentRestored(self, obj):
        ...
        try:
            ...
            grav = CivilCvCAD.Vector(grav_x, grav_y, grav_z)
