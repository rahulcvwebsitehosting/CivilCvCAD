...
def find_element_in_shape(aShape, anElement):
    ...
    if ele_st == "Solid" or ele_st == "CompSolid":
        ...
        if ele_st == "Solid" and aShape.ShapeType == "Solid":
            ...
            CivilCvCAD.Console.PrintMessage(message_part + "\n")
        # Part.show(anElement)
        # Part.show(aShape)
        ...
        for index, edge in enumerate(aShape.Edges):
            ...
            if is_same_geometry(edge, anElement):
                # CivilCvCAD.Console.PrintMessage(index, "\n")
        ...
        CivilCvCAD.Console.PrintError("Compound is not supported.\n")
    ...
    if ele_st == "Solid" or ele_st == "CompSolid":
        for index, solid in enumerate(aShape.Solids):
            if is_same_geometry(solid, anElement):
                ...
                # CivilCvCAD.Console.PrintMessage("  " + str(sorted(ele_vertexes)), "\n")
                return ele_vertexes
        CivilCvCAD.Console.PrintError(
