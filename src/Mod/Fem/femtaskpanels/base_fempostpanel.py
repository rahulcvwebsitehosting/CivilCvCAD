...
__title__ = "CivilCvCAD task panel base for post object task panels"
...
class _BasePostTaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.__settings_grp = CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/Fem")
    ...
    def open(self):
        ...
        if CivilCvCAD.ActiveDocument.getBookedTransactionID() == 0:
