...
__title__ = "CivilCvCAD FEM constraint current density task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/CurrentDensity.ui"
        )
    ...
    def init_parameter_widget(self):
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_current_density_re_1).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_current_density_re_2).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_current_density_re_3).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_current_density_im_1).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_current_density_im_2).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_current_density_im_3).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_normal_current_density_re).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_normal_current_density_im).bind(
