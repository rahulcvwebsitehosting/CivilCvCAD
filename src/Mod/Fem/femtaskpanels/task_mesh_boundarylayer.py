...
__title__ = "CivilCvCAD FEM mesh boundary layer task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/MeshBoundaryLayer.ui"
        )
    ...
    def init_parameter_widget(self):
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_min_thickness).bind(
            self.obj, "MinimumThickness"
        )
        self.parameter_widget.qsb_min_thickness.setProperty("value", self.min_thickness)

        CivilCvCADGui.ExpressionBinding(self.parameter_widget.dsb_growth_rate).bind(
            self.obj, "GrowthRate"
        )
        self.parameter_widget.dsb_growth_rate.setProperty("value", self.growth_rate)

        CivilCvCADGui.ExpressionBinding(self.parameter_widget.isb_number_of_layers).bind(
