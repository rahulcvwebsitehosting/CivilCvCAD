...
__title__ = "CivilCvCAD FEM histogram plot task panel"
...
class _TaskPanel(base_fempostpanel._BasePostTaskPanel):
    ...
    def __init__(self, vobj):
        ...
        self.data_widget.setWindowIcon(CivilCvCADGui.getIcon(":/icons/FEM_PostHistogram.svg"))

        # histogram parameter widget
        self.view_widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/TaskPostHistogram.ui"
        )
        self.view_widget.setWindowTitle(translate("FEM", "Histogram View Settings"))
        self.view_widget.setWindowIcon(CivilCvCADGui.getIcon(":/icons/FEM_PostHistogram.svg"))
