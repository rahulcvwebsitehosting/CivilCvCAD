...
__title__ = "CivilCvCAD FEM solver calculix ccx tools task panel for the document object"
...
class _TaskPanel:
    ...
    def __init__(self, solver_object):
        self.form = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/SolverCcxTools.ui"
        )
        ...
        try:
            ...
            CivilCvCAD.Console.PrintWarning(e.args[0])
        ...
        # see https://github.com/CivilCvCAD/CivilCvCAD/issues/12448
    ...
    def printCalculiXstdout(self):
        ...
        # https://forum.civilcvcad.org/viewtopic.php?f=18&t=39195
    ...
    def calculixStarted(self):
        ...
        CivilCvCAD.Console.PrintLog(f"calculix state: {self.Calculix.state()}\n")
    ...
    def calculixFinished(self, exitCode, exitStatus):
        ...
        try:
            ...
            CivilCvCAD.Console.PrintError("loading results failed\n")
            CivilCvCAD.Console.PrintError(e)
    ...
    def editCalculixInputFile(self):
        ...
        gen_prefs = CivilCvCAD.ParamGet(self.PREFS_PATH).GetGroup("General")
    ...
    def runCalculix(self):
        if self.Calculix.state() == QtCore.QProcess.ProcessState.NotRunning:
            ...
            ccx_prefs = CivilCvCAD.ParamGet(self.PREFS_PATH).GetGroup("Ccx")
