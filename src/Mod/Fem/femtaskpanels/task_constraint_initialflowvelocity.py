...
__title__ = "CivilCvCAD FEM constraint initial flow velocity task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self._paramWidget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/InitialFlowVelocity.ui"
        )
    ...
    def _formulaXEnable(self, toggled):
        CivilCvCAD.Console.PrintMessage("_formulaXEnable\n")
        if self._paramWidget.velocityXBox.isChecked():
            CivilCvCAD.Console.PrintMessage("velocityXBox isChecked\n")
            return
        else:
            CivilCvCAD.Console.PrintMessage("velocityXBox not checked\n")
    ...
    def _initParamWidget(self):
        ...
        CivilCvCADGui.ExpressionBinding(self._paramWidget.velocityX).bind(self.obj, "VelocityX")
        ...
        CivilCvCADGui.ExpressionBinding(self._paramWidget.velocityY).bind(self.obj, "VelocityY")
        ...
        CivilCvCADGui.ExpressionBinding(self._paramWidget.velocityZ).bind(self.obj, "VelocityZ")
