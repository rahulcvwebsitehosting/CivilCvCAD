...
__title__ = "CivilCvCAD FEM constraint initial pressure task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self._paramWidget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/InitialPressure.ui"
        )
    ...
    def _initParamWidget(self):
        ...
        CivilCvCADGui.ExpressionBinding(self._paramWidget.pressureQSB).bind(self.obj, "Pressure")
