...
__title__ = "CivilCvCAD FEM element geometry 1D task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/ElementGeometry1D.ui"
        )
    ...
    def update_parameter_widget(self):
        "fills the widgets"
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_rec_height).bind(
            self.obj, "RectHeight"
        )
        self.parameter_widget.qsb_rec_height.setProperty("value", self.rect_height)
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_rec_width).bind(
            self.obj, "RectWidth"
        )
        self.parameter_widget.qsb_rec_width.setProperty("value", self.rect_width)

        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_circ_diameter).bind(
            self.obj, "CircDiameter"
        )
        self.parameter_widget.qsb_circ_diameter.setProperty("value", self.circ_diameter)

        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_pipe_diameter).bind(
            self.obj, "PipeDiameter"
        )
        self.parameter_widget.qsb_pipe_diameter.setProperty("value", self.pipe_diameter)
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_pipe_thickness).bind(
            self.obj, "PipeThickness"
        )
        self.parameter_widget.qsb_pipe_thickness.setProperty("value", self.pipe_thickness)

        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_elliptical_axis1).bind(
            self.obj, "Axis1Length"
        )
        self.parameter_widget.qsb_elliptical_axis1.setProperty("value", self.axis1_length)
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_elliptical_axis2).bind(
            self.obj, "Axis2Length"
        )
        self.parameter_widget.qsb_elliptical_axis2.setProperty("value", self.axis2_length)

        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_box_height).bind(
            self.obj, "BoxHeight"
        )
        self.parameter_widget.qsb_box_height.setProperty("value", self.box_height)
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_box_width).bind(self.obj, "BoxWidth")
        self.parameter_widget.qsb_box_width.setProperty("value", self.box_width)

        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_box_t1).bind(self.obj, "BoxT1")
        self.parameter_widget.qsb_box_t1.setProperty("value", self.box_t1)

        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_box_t2).bind(self.obj, "BoxT2")
        self.parameter_widget.qsb_box_t2.setProperty("value", self.box_t2)
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_box_t3).bind(self.obj, "BoxT3")
        self.parameter_widget.qsb_box_t3.setProperty("value", self.box_t3)
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_box_t4).bind(self.obj, "BoxT4")
