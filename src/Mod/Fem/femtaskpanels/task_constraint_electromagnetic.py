...
__title__ = "CivilCvCAD FEM constraint electromagnetic task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/Electromagnetic.ui"
        )
    ...
    def init_parameter_widget(self):
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_potential).bind(
            self.obj, "Potential"
        )
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_av_re).bind(self.obj, "AV_re")
        self.parameter_widget.qsb_av_im.setProperty("value", self.av_im)
        self.parameter_widget.qsb_av_im.setEnabled(self.av_enabled)
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_av_im).bind(self.obj, "AV_im")
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_av_re_1).bind(self.obj, "AV_re_1")
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_av_re_2).bind(self.obj, "AV_re_2")
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_av_re_3).bind(self.obj, "AV_re_3")
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_av_im_1).bind(self.obj, "AV_im_1")
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_av_im_2).bind(self.obj, "AV_im_2")
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_av_im_3).bind(self.obj, "AV_im_3")
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.spb_capacitance_body).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_electric_flux_density).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetic_re_1).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetic_re_2).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetic_re_3).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetic_im_1).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetic_im_2).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetic_im_3).bind(
