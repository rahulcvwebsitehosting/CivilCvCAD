...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel, base_fempreviewpanel._TaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/MeshManipulate.ui"
        )
        self.parameter_widget.setWindowTitle("Manipulation Settings")
        self.parameter_widget.setWindowIcon(CivilCvCADGui.getIcon(":icons/FEM_MeshManipulate.svg"))
        ...
        self.selection_widget.setWindowIcon(CivilCvCADGui.getIcon(":icons/FEM_MeshManipulate.svg"))
