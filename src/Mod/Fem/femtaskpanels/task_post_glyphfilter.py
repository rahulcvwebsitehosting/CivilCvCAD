...
__title__ = "CivilCvCAD FEM glyph filter task panel for the document object"
...
class _TaskPanel(base_fempostpanel._BasePostTaskPanel):
    ...
    def __init__(self, vobj):
        ...
        self.widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/TaskPostGlyph.ui"
        )
        self.widget.setWindowIcon(CivilCvCADGui.getIcon(":/icons/FEM_PostFilterGlyph.svg"))
        self.__init_widget()
