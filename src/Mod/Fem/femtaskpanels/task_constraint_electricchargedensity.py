...
__title__ = "CivilCvCAD FEM constraint electric charge density task panel"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/ElectricChargeDensity.ui"
        )
    ...
    def init_parameter_widget(self):
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_source_charge_density).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_interface_charge_density).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_total_charge).bind(
