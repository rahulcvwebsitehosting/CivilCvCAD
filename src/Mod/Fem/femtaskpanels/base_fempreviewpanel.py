...
__title__ = "CivilCvCAD FEM mesh gmsh refinement preview task panel"
...
class SettingsDialog(QtGui.QDialog):
    ...
    def __init__(self):
        ...
        self.widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/MeshPreviewSettings.ui"
        )

        auto = CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/Fem/Gmsh").GetBool(
    ...
    def accept(self):
        ...
        CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/Fem/Gmsh").SetBool(
            "previewAutoEnable", self.widget.AutoOpen.isChecked()
        )

        CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/Fem/Gmsh").SetInt(
...
class _TaskPanel:
    ...
    def __init__(self, obj):
        ...
        # setup ui
        self._preview_widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/MeshPreview.ui"
        )
        self._preview_widget.Preferences.setIcon(
            CivilCvCADGui.getIcon(":icons/preferences-general.svg")
        )
