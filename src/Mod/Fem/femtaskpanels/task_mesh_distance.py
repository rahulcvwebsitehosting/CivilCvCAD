...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel, base_fempreviewpanel._TaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/MeshDistance.ui"
        )
        self.parameter_widget.setWindowTitle("Distance Threshold Settings")
        self.parameter_widget.setWindowIcon(CivilCvCADGui.getIcon(":icons/FEM_MeshDistance.svg"))
        ...
        self.selection_widget.setWindowIcon(CivilCvCADGui.getIcon(":icons/FEM_MeshDistance.svg"))
    ...
    def _init_parameter_widget(self):
        ...
        CivilCvCADGui.ExpressionBinding(ui.DistMin).bind(self.obj, "DistanceMinimum")
        ui.DistMin.valueChanged.connect(self.distMinChanged)

        ui.DistMax.setProperty("value", self.obj.DistanceMaximum)
        CivilCvCADGui.ExpressionBinding(ui.DistMax).bind(self.obj, "DistanceMaximum")
        ui.DistMax.valueChanged.connect(self.distMaxChanged)

        ui.Sampling.setProperty("value", CivilCvCAD.Units.Quantity(self.obj.Sampling))
        CivilCvCADGui.ExpressionBinding(ui.Sampling).bind(self.obj, "Sampling")
