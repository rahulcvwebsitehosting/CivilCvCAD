...
__title__ = "CivilCvCAD FEM material task panel for the document object"
__author__ = "Juergen Riegel, Bernd Hahnebach, Qingfeng Xia"
__url__ = ""
## @package task_material_common
#  \ingroup FEM
#  \brief CivilCvCAD FEM _ViewProviderFemMaterial
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        # CivilCvCAD material dictionary of current material
        ...
        self.parameterWidget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/Material.ui"
        )
