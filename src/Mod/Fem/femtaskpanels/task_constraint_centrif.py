...
__title__ = "CivilCvCAD FEM constraint centrif task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/ConstraintCentrif.ui"
        )
    ...
    def accept(self):
        ...
        if items != 1:
            ...
            msgBox.setWindowTitle("CivilCvCAD FEM Constraint Centrif - Axis Selection")
    ...
    def init_parameter_widget(self):
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_rotation_frequency).bind(
