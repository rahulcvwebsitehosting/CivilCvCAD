...
__title__ = "CivilCvCAD FEM constraint tie task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/ConstraintTie.ui"
        )
    ...
    def accept(self):
        ...
        if items != 2:
            ...
            msgBox.setWindowTitle("CivilCvCAD FEM Constraint Tie")
    ...
    def init_parameter_widget(self):
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.spb_tolerance).bind(
            self.obj, "Tolerance"
        )
