...
__title__ = "CivilCvCAD FEM constraint magnetization task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/Magnetization.ui"
        )
    ...
    def init_parameter_widget(self):
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetization_re_1).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetization_re_2).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetization_re_3).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetization_im_1).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetization_im_2).bind(
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetization_im_3).bind(
