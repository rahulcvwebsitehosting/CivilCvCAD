...
__title__ = "CivilCvCAD FEM mesh gmsh task panel for the document object"
...
class _TaskPanel(base_femlogtaskpanel._BaseWorkerTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.form = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/MeshGmsh.ui"
        )
    ...
    def set_widgets(self):
        ...
        CivilCvCADGui.ExpressionBinding(self.form.qsb_max_size).bind(
            self.obj, "CharacteristicLengthMax"
        )
        self.form.qsb_min_size.setProperty("value", self.clmin)
        CivilCvCADGui.ExpressionBinding(self.form.qsb_min_size).bind(
