...
__title__ = "CivilCvCAD FEM element geometry 2D task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/ElementGeometry2D.ui"
        )
    ...
    def init_parameter_widget(self):
        ...
        CivilCvCADGui.ExpressionBinding(self.parameter_widget.qsb_thickness).bind(
            self.obj, "Thickness"
        )
