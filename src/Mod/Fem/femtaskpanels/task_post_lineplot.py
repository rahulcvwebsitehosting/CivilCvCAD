...
__title__ = "CivilCvCAD FEM lineplot plot task panel"
...
class _TaskPanel(base_fempostpanel._BasePostTaskPanel):
    ...
    def __init__(self, vobj):
        ...
        self.data_widget.setWindowIcon(CivilCvCADGui.getIcon(":/icons/FEM_PostLineplot.svg"))

        # lineplot parameter widget
        self.view_widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/TaskPostLineplot.ui"
        )
        self.view_widget.setWindowTitle(translate("FEM", "Lineplot View Settings"))
        self.view_widget.setWindowIcon(CivilCvCADGui.getIcon(":/icons/FEM_PostLineplot.svg"))
