...
__title__ = "CivilCvCAD FEM element fluid 1D task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        # parameter widget
        self.parameterWidget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/ElementFluid1D.ui"
        )
    ...
    def updateParameterWidget(self):
        ...
        self.parameterWidget.if_inletpressure.setText(
            CivilCvCAD.Units.Quantity(1000 * self.InletPressure, CivilCvCAD.Units.Pressure).UserString
        )
        self.parameterWidget.if_outletpressure.setText(
            CivilCvCAD.Units.Quantity(1000 * self.OutletPressure, CivilCvCAD.Units.Pressure).UserString
        )
