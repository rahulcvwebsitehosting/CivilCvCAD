...
__title__ = "CivilCvCAD FEM constraint section print task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameterWidget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/ConstraintSectionPrint.ui"
        )
    ...
    def accept(self):
        ...
        if items != 1:
            ...
            msgBox.setWindowTitle("CivilCvCAD FEM Constraint SectionPrint")
