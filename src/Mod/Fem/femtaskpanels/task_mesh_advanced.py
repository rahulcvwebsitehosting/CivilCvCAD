...
__title__ = "CivilCvCAD FEM mesh refinement task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel, base_fempreviewpanel._TaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/MeshAdvanced.ui"
        )
        self.parameter_widget.setWindowTitle("Advanced Refinement Settings")
        self.parameter_widget.setWindowIcon(CivilCvCADGui.getIcon(":icons/FEM_MeshAdvanced.svg"))
        ...
        self.selection_widget.setWindowIcon(CivilCvCADGui.getIcon(":icons/FEM_MeshAdvanced.svg"))
        ...
        CivilCvCAD.addDocumentObserver(self)
    ...
    def _init_parameter_widget(self):
        ...
        # AttractorAnisoCurve
        stylesheet = CivilCvCAD.ParamGet("User parameter:BaseApp/Preferences/MainWindow").GetString(
            "StyleSheet"
        )
        ...
        CivilCvCADGui.ExpressionBinding(ui.SizeMinNormal).bind(self.obj, "SizeMinNormal")
        ui.SizeMinNormal.valueChanged.connect(self.sizeMinNormalChanged)

        ui.SizeMaxNormal.setProperty("value", self.obj.SizeMaxNormal)
        CivilCvCADGui.ExpressionBinding(ui.SizeMaxNormal).bind(self.obj, "SizeMaxNormal")
        ...
        CivilCvCADGui.ExpressionBinding(ui.SizeMinTangent).bind(self.obj, "SizeMinTangent")
        ...
        CivilCvCADGui.ExpressionBinding(ui.SizeMaxTangent).bind(self.obj, "SizeMaxTangent")
        ui.SizeMaxTangent.valueChanged.connect(self.sizeMaxTangentChanged)

        ui.DistMin.setProperty("value", self.obj.DistanceMin)
        CivilCvCADGui.ExpressionBinding(ui.DistMin).bind(self.obj, "DistanceMin")
        ui.DistMin.valueChanged.connect(self.distMinChanged)

        ui.DistMax.setProperty("value", self.obj.DistanceMax)
        CivilCvCADGui.ExpressionBinding(ui.DistMax).bind(self.obj, "DistanceMax")
        ...
        CivilCvCADGui.ExpressionBinding(ui.Sampling_Aniso).bind(self.obj, "Sampling")
        ui.Sampling_Aniso.valueChanged.connect(self.samplingChanged)

        warning = CivilCvCADGui.getIcon("Warning.svg")
        ...
        info = CivilCvCADGui.getIcon("info.svg")
        ...
        CivilCvCADGui.ExpressionBinding(ui.Sampling_Dist).bind(self.obj, "Sampling")
        ui.Sampling_Dist.valueChanged.connect(self.samplingChanged)

        # Result

        # find all possible result objects
        ui.ResultObject.addItem(CivilCvCADGui.getIcon("button_invalid.svg"), "None selected", None)
        ...
        if self.obj.ResultObject:
            ...
            ui.ResultField.addItem(CivilCvCADGui.getIcon("button_invalid.svg"), "No object selected")
