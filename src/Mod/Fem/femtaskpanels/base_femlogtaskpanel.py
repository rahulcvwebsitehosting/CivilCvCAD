...
__title__ = "CivilCvCAD FEM base task panel with logging"
...
class _BaseLogTaskPanel(base_femtaskpanel._BaseTaskPanel, ABC):
    ...
    def accept(self):
        if (
            ...
            CivilCvCAD.Console.PrintWarning("Process still running\n")
            return None
    ...
    def reject(self):
        ...
        if self.tool.process.state() != QtCore.QProcess.ProcessState.NotRunning:
            ...
            CivilCvCAD.Console.PrintWarning("Process aborted\n")
        else:
            return super().reject()
    ...
    def clicked(self, button):
        if button == QtGui.QDialogButtonBox.Apply:
            if (
                ...
                CivilCvCAD.Console.PrintWarning("Process already running\n")
                return None
...
class _BaseWorkerTaskPanel(_BaseLogTaskPanel):
    ...
    def __init__(self, obj):
        ...
        CivilCvCAD.addDocumentObserver(self.observer)
    ...
    def setup_connections(self):
        ...
        QtCore.QObject.connect(
            ...
            lambda: CivilCvCAD.removeDocumentObserver(self.observer),
        )
