...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = CivilCvCADGui.PySideUic.loadUi(
            CivilCvCAD.getHomePath() + "Mod/Fem/Resources/ui/MeshTransfiniteCurve.ui"
        )
    ...
    def _init_parameter_widget(self):
        ...
        ui.Nodes.setProperty("value", CivilCvCAD.Units.Quantity(self.obj.Nodes))
        CivilCvCADGui.ExpressionBinding(ui.Nodes).bind(self.obj, "Nodes")
        ui.Nodes.valueChanged.connect(self.nodesChanged)

        ui.Coefficient.setProperty("value", CivilCvCAD.Units.Quantity(self.obj.Coefficient))
        CivilCvCADGui.ExpressionBinding(ui.Coefficient).bind(self.obj, "Coefficient")
