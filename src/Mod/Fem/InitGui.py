...
# few tests. - chennes
# CivilCvCAD.__unit_test__ += ["TestFemGui"]
...
class FemWorkbench(Workbench):
    ...
    def __init__(self):
        self.__class__.Icon = CivilCvCAD.getResourceDir() + "Mod/Fem/Resources/icons/FemWorkbench.svg"
    ...
    def Initialize(self):
        ...
        CivilCvCADGui.addPreferencePage(fempreferencepages.DlgSettingsNetgen, "FEM")
    ...
    def GetClassName(self):
        # see https://forum.civilcvcad.org/viewtopic.php?f=10&t=43300
        return "FemGui::Workbench"


CivilCvCADGui.addWorkbench(FemWorkbench())
