...
void CmdFemAddPart::activated(int)
{
    ...
    QMessageBox::warning(Gui::getMainWindow(), QObject::tr("Wrong selection"),
            QObject::tr("Your CivilCvCAD is built without NETGEN support. Meshing will not work…"));
    return;
#endif
...
CivilCvCAD.Console.PrintError('membrane stress = ')\n\
CivilCvCAD.Console.PrintError([str(round(membrane[0],2))])\n\
CivilCvCAD.Console.PrintError('membrane + bending min = ')\n\
CivilCvCAD.Console.PrintError([str(round(mb[0],2))])\n\
CivilCvCAD.Console.PrintError('membrane + bending  max = ')\n\
CivilCvCAD.Console.PrintError([str(round(mb[len(t_coords)-1],2))])\n\
CivilCvCAD.Console.PrintError('Total stress min = ')\n\
CivilCvCAD.Console.PrintError([str(round(peak[0],2))])\n\
CivilCvCAD.Console.PrintError('Total stress max = ')\n\
CivilCvCAD.Console.PrintError([str(round(peak[len(t_coords)-1],2))])\n\
plt.ioff()\n\
plt.legend([\""
