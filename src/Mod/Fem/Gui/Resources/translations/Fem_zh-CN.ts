...
Leave blank to use user home directory.</source>
    ...
    <message>
      ...
      <translation>留空以使用 CivilCvCAD 默认的内置编辑器</translation>
    </message>
    <message>
...
exported from CivilCvCAD.</source>
      <translation>VTK结果对象：将导入一个CivilCvCAD FEM VTK结果对象
（等同于导出的对象）。

FEM网格对象：VTK文件中的结果将被忽略，仅导入网格数据并创建一个CivilCvCAD FEM网格对象。

CivilCvCAD结果对象：导入的数据将被转换为
CivilCvCAD FEM结果对象。注意：此设置需要精确的结果组件名称，因此仅适用于从CivilCvCAD导出的VTK文件。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>CivilCvCAD 结果对象</translation>
    </message>
    <message>
...
normal vector of the face is used as direction</source>
  ...
  <context>
    ...
    <message>
      ...
      <translation>打开CivilCvCAD材质编辑器</translation>
    </message>
  </context>
  <context>
...
留空以使用默认 Python 可执行文件</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>FEM：CalculiX ccx 输出“{}”不包含预期短语“{}”。运行 ccx 二进制文件时存在一些问题。请检查 ccx 是否可以在不依赖 CivilCvCAD 的情况下独立运行。</translation>
    </message>
  </context>
  <context>
