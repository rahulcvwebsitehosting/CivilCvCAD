...
exported from CivilCvCAD.</source>
      <translation>VTK 結果オブジェクト: CivilCvCAD FEM VTK 結果オブジェクトをインポートします (エクスポートされるオブジェクトと同じもの)。

FEM メッシュオブジェクト: VTK ファイル内の結果は無視され、メッシュデータのみをインポートして CivilCvCAD FEM メッシュオブジェクトが作成されます。

CivilCvCAD 結果オブジェクト: インポートされたデータは CivilCvCAD FEM 結果オブジェクトに変換されます。注意 この設定では正確な結果コンポーネント名が必要となるので、CivilCvCAD からエクスポートされた VTK ファイルのプロパティーをのみにしか使用できません。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>CivilCvCAD結果オブジェクト</translation>
    </message>
    <message>
...
normal vector of the face is used as direction</source>
  ...
  <context>
    ...
    <message>
      ...
      <translation>CivilCvCAD 材料エディターを開く</translation>
    </message>
  </context>
  <context>
...
デフォルトのPython実行ファイルを使用する場合は空白のままにしてください。</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>FEM: CalculiX ccx '{}' 出力 '{}' に予測される語句 '{}' 含まれていません。 ccxバイナリーを実行する際に何か問題がありました。CivilCvCAD無しでccxがスタンドアローンで実行できるか確認してください。</translation>
    </message>
  </context>
  <context>
