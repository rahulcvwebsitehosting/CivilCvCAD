...
비워두면 사용자 홈 디렉터리를 사용합니다.</translation>
    ...
    <message>
      ...
      <translation>비워 두면 기본 CivilCvCAD 내부 편집기를 사용합니다</translation>
    </message>
    <message>
...
exported from CivilCvCAD.</source>
      <translation>VTK 결과 객체: CivilCvCAD FEM VTK 결과 객체를 가져옵니다
(내보낸 객체와 동일).

FEM 메시 객체: VTK 파일의 결과값은 무시되고 메시 데이터만 가져와 CivilCvCAD FEM 메시 객체를 만듭니다.

CivilCvCAD 결과 객체: 가져온 데이터는 CivilCvCAD FEM 결과 객체로 변환됩니다. 참고: 이 설정은 정확한 결과 구성 요소 이름이 필요하므로 CivilCvCAD에서 내보낸 VTK 파일에서만 제대로 작동합니다.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>CivilCvCAD 결과 객체</translation>
    </message>
    <message>
...
normal vector of the face is used as direction</source>
  ...
  <context>
    ...
    <message>
      ...
      <translation>CivilCvCAD 재질 편집기를 엽니다</translation>
    </message>
  </context>
  <context>
...
비워 두면 기본 Python 실행파일을 사용합니다</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>FEM: CalculiX ccx '{}' 출력 '{}'에 예상 문구 '{}'가 포함되어 있지 않습니다. ccx 바이너리 실행 중 문제가 있습니다. CivilCvCAD 없이 ccx가 단독으로 실행되는지 확인하세요.</translation>
    </message>
  </context>
  <context>
