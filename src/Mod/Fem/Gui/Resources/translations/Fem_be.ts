...
Пакіньце поле пустым, каб ужываць хатні каталог карыстальніка.</translation>
    ...
    <message>
      ...
      <translation>Пакіньце поле пустым, каб ужыць першапачатковы ўнутраны сродак праўкі CivilCvCAD</translation>
    </message>
    <message>
...
exported from CivilCvCAD.</source>
      <translation>Аб'ект выніку VTK: будзе імпартаваны аб'ект выніку CivilCvCAD
МКЭ VTK (аднолькавы з аб'ектам, які быў экспартаваны).

Аб'ект паліганальнай сеткі МКЭ: вынікі ў файле VTK будуць апушчаныя, будуць імпартаваныя толькі дадзеныя паліганальнай сеткі і будзе створаны аб'ект паліганальнай сеткі CivilCvCAD МКЭ.

Аб'ект выніку CivilCvCAD: імпартаваныя дадзеныя будуць пераўтвораныя ў выніковы аб'ект CivilCvCAD МКЭ.
Заўвага: для гэтай налады патрабуюцца дакладныя назвы кампанентаў выніку, і таму яна карэктна працуе толькі з файламі VTK, якія экспартаваныя з CivilCvCAD.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Аб'ект выніку CivilCvCAD</translation>
    </message>
    <message>
...
normal vector of the face is used as direction</source>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Адчыняе сродак праўкі матэрыялу CivilCvCAD</translation>
    </message>
  </context>
  <context>
...
Праверце, ці працуе ccx аўтаномна без CivilCvCAD.</translation>
    </message>
  </context>
  <context>
