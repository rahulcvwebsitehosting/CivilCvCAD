...
__title__ = "CivilCvCAD table view widget to visualize vtkTable"
...
class VtkTableView(QtGui.QWidget):
    ...
    def __init__(self, model):
        ...
        csv_action.setIcon(CivilCvCADGui.getIcon("Std_Export"))
        ...
        copy_action.setIcon(CivilCvCADGui.getIcon("edit-copy"))
