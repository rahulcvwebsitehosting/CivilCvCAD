...
{
public:
    // extract data from vtkUnstructuredGrid instance and fill a CivilCvCAD FEM mesh object with that
    // data
    ...
    // extract data from vtkUnstructuredGrid object and fill a CivilCvCAD FEM result object with that
    // data (needed by readResult)
    static void importCivilCvCADResult(vtkSmartPointer<vtkDataSet> dataset, App::DocumentObject* result);

    // extract data from a CivilCvCAD FEM result object and fill a vtkUnstructuredGrid object with that
    // data (needed by writeResult)
    static void exportCivilCvCADResult(const App::DocumentObject* result, vtkSmartPointer<vtkDataSet> grid);
