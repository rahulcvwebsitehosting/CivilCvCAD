...
std::set<int> FemMesh::getNodesByFace(const TopoDS_Face& face) const
{
    ...
    BRepBndLib::Add(
        ...
        box,
        Standard_False
    );  // https://forum.civilcvcad.org/viewtopic.php?f=18&t=21571&start=70#p221591
...
void FemMesh::readAbaqus(const std::string& FileName)
{
    ...
    femmesh = read_inp(CivilCvCAD.ConfigGet("AppHomePath") +
    ...
    try {
        ...
        if (PyObject_TypeCheck(mesh.ptr(), &FemMeshPy::Type)) {
            ...
            *this = *fem;  // the deep copy should be avoided, a pointer swap method could be
                           // implemented see
                           // https://forum.civilcvcad.org/viewtopic.php?f=10&t=31999&start=10#p274241
        }
        else {
...
void FemMesh::readZ88(const std::string& FileName)
{
    ...
    femmesh = read_z88(CivilCvCAD.ConfigGet("AppHomePath") +
...
) const
{
    ...
    // dimension 1
    //
    // seg2 CivilCvCAD --> B31, B31R, T3D2 CalculiX
    // N1, N2
    std::vector<int> seg2 = boost::assign::list_of(0)(1);
    //
    // seg3 CivilCvCAD --> B32, B32R, T3D3 D CalculiX
    // N1, N3, N2
    ...
    // dimension 2
    //
    // tria3 CivilCvCAD --> S3, M3D3, CPS3, CPE3, CAX3 CalculiX
    // N1, N2, N3
    std::vector<int> tria3 = boost::assign::list_of(0)(1)(2);
    //
    // tria6 CivilCvCAD --> S6 M3D6, CPS6, CPE6, CAX6 CalculiX
    // N1, N2, N3, N4, N5, N6
    std::vector<int> tria6 = boost::assign::list_of(0)(1)(2)(3)(4)(5);
    //
    // quad4 CivilCvCAD --> S4, S4R, M3D4, M3D4R, CPS4, CPS4R, CPE4, CPE4R, CAX4, CAX4R CalculiX
    // N1, N2, N3, N4
    std::vector<int> quad4 = boost::assign::list_of(0)(1)(2)(3);
    //
    // quad8 CivilCvCAD --> S8, S8R, M3D8, M3D8R, CPS8, CPS8R, CPE8, CPE8R, CAX8, CAX8R CalculiX
    ...
    // dimension 3
    //
    // tetra4 CivilCvCAD --> C3D4, F3D4 CalculiX
    // N2, N1, N3, N4
    std::vector<int> tetra4 = boost::assign::list_of(1)(0)(2)(3);
    // tetra10: CivilCvCAD --> C3D10, C3D10T CalculiX
    ...
    // hexa8 CivilCvCAD --> C3D8, C3D8R, C3D8I, F3D8 CalculiX
    // N6, N7, N8, N5, N2, N3, N4, N1
    std::vector<int> hexa8 = boost::assign::list_of(5)(6)(7)(4)(1)(2)(3)(0);
    //
    // hexa20 CivilCvCAD --> C3D20, C3D20R CalculiX
    ...
    //
    // penta6 CivilCvCAD --> C3D6, F3D6 CalculiX
    // N5, N6, N4, N2, N3, N1
    std::vector<int> penta6 = boost::assign::list_of(4)(5)(3)(1)(2)(0);
    //
    // penta15 CivilCvCAD --> C3D15 CalculiX
    ...
    // https://forum.civilcvcad.org/viewtopic.php?f=10&t=37436
    Base::FileInfo fi(Filename);
    Base::ofstream anABAQUS_Output(fi);
    // https://forum.civilcvcad.org/viewtopic.php?f=18&t=22759#p176669
    anABAQUS_Output.precision(13);

    // add some text and make sure one of the known elemParam values is used
    anABAQUS_Output << "** written by CivilCvCAD inp file writer for CalculiX,Abaqus meshes"
                    << std::endl;
    switch (elemParam) {
        case 0:
    ...
    // See https://forum.civilcvcad.org/viewtopic.php?f=18&t=12646&start=40#p103004
