...
public:
        ...
        : Py::ExtensionModule<Module>("Fem")
    {
        ...
        add_varargs_method(
            ...
            "Returns the VTK version CivilCvCAD is linked against"
        );
        add_varargs_method(
            "getVtkVersionNumber",
            &Module::getVtkVersionNumber,
            "Returns the VTK version CivilCvCAD is linked against as a number"
        );
        add_varargs_method(
            "vtkVersionCheck",
...
# ifdef FC_USE_VTK_PYTHON
        add_varargs_method(
            ...
            "Checks if the passed vtkObject is compatible with the c++ VTK version CivilCvCAD uses"
        );
# endif
#endif
        add_varargs_method(
...
# ifdef FC_USE_VTK_PYTHON
    Py::Object isVtkCompatible(const Py::Tuple& args)
    {
        ...
        // python api used to create it cannot be used with CivilCvCAD
