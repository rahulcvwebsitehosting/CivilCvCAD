...
class PartDesignWorkbench(Workbench):
    ...
    def __init__(self):
        self.__class__.Icon = (
            CivilCvCAD.getResourceDir() + "Mod/PartDesign/Resources/icons/PartDesignWorkbench.svg"
        )
    ...
    def Initialize(self):
        ...
        CivilCvCADGui.addCommand("PartDesign_Sprocket", CommandSprocket())
...
CivilCvCAD.__unit_test__ += ["TestPartDesignGui"]
