...
class TaskWizardShaft:
    ...
    def __init__(self, doc):
        ...
        mdi = CivilCvCADGui.getMainWindow().findChild(QtGui.QMdiArea)
...
class WizardShaftGui:
    def Activated(self):
        ...
        WizardShaftDlg = TaskWizardShaft(CivilCvCAD.ActiveDocument)
        CivilCvCADGui.Control.showDialog(WizardShaftDlg)

    def GetResources(self):
        IconPath = CivilCvCAD.ConfigGet("AppHomePath") + "Mod/PartDesign/WizardShaft/WizardShaft.svg"
...
CivilCvCADGui.addCommand("PartDesign_WizardShaft", WizardShaftGui())
CivilCvCADGui.addCommand("PartDesign_WizardShaftCallBack", WizardShaftGuiCallback())
