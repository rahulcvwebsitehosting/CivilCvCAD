...
void Chamfer::migrateFlippedProperties(const Base::XMLReader& reader)
{
    ...
    Base::Console().warning(
        ...
        "the same geometry in this CivilCvCAD version. If the re-saved file is later opened "
        "in CivilCvCAD 0.21.x the chamfer result may differ due to the changed parameter "
        "interpretation.\n",
        getFullName()
    );
