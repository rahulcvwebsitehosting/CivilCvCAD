...
Although you will be able to migrate any moment later with 'Part Design -&gt; Migrate'.</source>
      <translation>Примечание: Если вы решите выполнить миграцию, вы не сможете редактировать файл в более старой версии CivilCvCAD. Если вы откажетесь от миграции, вы не сможете использовать новые функции верстака Проектная Деталь, такие как Тело и Деталь. В результате вы также не сможете использовать свои детали в верстаке Сборка.
