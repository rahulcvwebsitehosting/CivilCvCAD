...
Quantity = CivilCvCAD.Units.Quantity  # FIXME from CivilCvCAD.Units import Quantity doesn't work
...
class TestInvoluteGear(unittest.TestCase):
    def setUp(self):
        self.Doc = CivilCvCAD.newDocument("PartDesignTestInvoluteGear")
    ...
    def testUsagePocketInternalGearProfile(self):
        ...
        default_dedendum = 1.25
        rim_width = 3 * CivilCvCAD.Units.MilliMetre
    ...
    def testRecomputeExternalGearFromV020(self):
        CivilCvCAD.closeDocument(self.Doc.Name)  # this was created in setUp(self)
        self.Doc = CivilCvCAD.openDocument(str(FIXTURE_PATH / "InvoluteGear_v0-20.FCStd"))
    ...
    def testRecomputeInternalGearFromV020(self):
        CivilCvCAD.closeDocument(self.Doc.Name)  # this was created in setUp(self)
        self.Doc = CivilCvCAD.openDocument(str(FIXTURE_PATH / "InternalInvoluteGear_v0-20.FCStd"))
        created_with = f"created with {self.Doc.getProgramVersion()}"
        gear = self.Doc.InvoluteGear  # from fixture
