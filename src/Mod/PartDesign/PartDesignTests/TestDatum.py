...
class TestDatumPoint(unittest.TestCase):
    def setUp(self):
        self.Doc = CivilCvCAD.newDocument("PartDesignTestDatumPoint")
    ...
    def tearDown(self):
        # closing doc
        CivilCvCAD.closeDocument("PartDesignTestDatumPoint")
        # print ("omit closing document for debugging")


class TestDatumLine(unittest.TestCase):
    def setUp(self):
        self.Doc = CivilCvCAD.newDocument("PartDesignTestDatumLine")
    ...
    def tearDown(self):
        # closing doc
        CivilCvCAD.closeDocument("PartDesignTestDatumLine")
        # print ("omit closing document for debugging")
...
class TestDatumPlane(unittest.TestCase):
    ...
    def tearDown(self):
        # closing doc
        CivilCvCAD.closeDocument("PartDesignTestDatumPlane")
        # print ("omit closing document for debugging")
