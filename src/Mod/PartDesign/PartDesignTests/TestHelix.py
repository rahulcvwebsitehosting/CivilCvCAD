...
class TestHelix(unittest.TestCase):
    ...
    def setUp(self):
        self.Doc = CivilCvCAD.newDocument("PartDesignTestHelix")
    ...
    def testCircleQ1(self):
        ...
        helix.Placement = CivilCvCAD.Placement(
            CivilCvCAD.Vector(0, 0, 0),
            CivilCvCAD.Rotation(CivilCvCAD.Vector(0, 0, 1), 0),
            CivilCvCAD.Vector(0, 0, 0),
        )
        helix.Pitch = 3
        helix.Height = 9
        ...
        profileSketch.addGeometry(
            Part.Circle(CivilCvCAD.Vector(2, 0, 0), CivilCvCAD.Vector(0, 0, 1), 0.5)
        )
        self.Doc.recompute()
    ...
    def testCone(self):
        ...
        geoList = []
        geoList.append(Part.LineSegment(CivilCvCAD.Vector(-5, -5, 0), CivilCvCAD.Vector(-3, 0, 0)))
        geoList.append(Part.LineSegment(CivilCvCAD.Vector(-3, 0, 0), CivilCvCAD.Vector(-2, 0, 0)))
        geoList.append(Part.LineSegment(CivilCvCAD.Vector(-2, 0, 0), CivilCvCAD.Vector(-4, -5, 0)))
        geoList.append(Part.LineSegment(CivilCvCAD.Vector(-4, -5, 0), CivilCvCAD.Vector(-5, -5, 0)))
        ...
        conList.append(
            Sketcher.Constraint("Angle", l3, 1, -2, 2, CivilCvCAD.Units.Quantity("30.000000 deg"))
        )
    ...
    def testNegativeCone(self):
        ...
        conList.append(Sketcher.Constraint("Coincident", 3, 2, 0, 1))
        conList.append(Sketcher.Constraint("Horizontal", 1))
        conList.append(Sketcher.Constraint("Angle", l3, 1, -2, 2, CivilCvCAD.Units.Quantity("30 deg")))
    ...
    def tearDown(self):
        CivilCvCAD.closeDocument("PartDesignTestHelix")
