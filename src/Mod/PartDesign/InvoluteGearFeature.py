...
class CommandInvoluteGear:
    ...
    def Activated(self):
        CivilCvCAD.ActiveDocument.openTransaction("Create involute gear")
        CivilCvCADGui.addModule("InvoluteGearFeature")
        CivilCvCADGui.doCommand("InvoluteGearFeature.makeInvoluteGear('InvoluteGear')")
...
class _InvoluteGear:
    ...
    def _ensure_properties(self, obj, is_restore):
        ...
        # see https://tracker.civilcvcad.org/view.php?id=2524
        ensure_property(
            "App::PropertyInteger",
            "NumberOfTeeth",
...
class _InvoluteGearTaskPanel:
    ...
    def __init__(self, obj, mode):
        ...
        self.form = CivilCvCADGui.PySideUic.loadUi(str(pathlib.Path(__file__).with_suffix(".ui")))
