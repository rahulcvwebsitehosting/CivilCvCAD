...
def compute():
    ...
    try:
        ...
        CivilCvCAD.Console.PrintError("Wrong input! Only numbers allowed.\n")
    ...
    # Base circle
    baseCircle = CivilCvCAD.ActiveDocument.addObject("Part::FeaturePython", "BaseCircle")
    ...
    # Root circle
    rootCircle = CivilCvCAD.ActiveDocument.addObject("Part::FeaturePython", "RootCircle")
    ...
    # Addendum circle
    addendumCircle = CivilCvCAD.ActiveDocument.addObject("Part::FeaturePython", "AddendumCircle")
    ...
    # Pitch circle
    pitchCircle = CivilCvCAD.ActiveDocument.addObject("Part::FeaturePython", "PitchCircle")
    ...
    for angle in range(1, N + 1, 1):
        involuteobj = CivilCvCAD.ActiveDocument.addObject("Part::Feature", "InvoluteL" + str(angle))
    ...
    #    CivilCvCAD.ActiveDocument.addObject("Part::Feature","CutInv").Shape=cut
    ...
    for angle in range(1, N + 1, 1):
        involuteobj = CivilCvCAD.ActiveDocument.addObject("Part::Feature", "InvoluteR" + str(angle))
        involutee.insert(0, (0, 0, 0))
        involuteshape = Part.makePolygon(involutee)
        involuteobj.Shape = involuteshape
        involutee = []
    ...
    cutCircle = CivilCvCAD.ActiveDocument.addObject("Part::FeaturePython", "CutCircle")
