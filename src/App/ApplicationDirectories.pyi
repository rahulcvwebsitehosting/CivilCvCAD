...
class ApplicationDirectories(PyObjectBase):
    ...
    def migrateAllPaths(paths: list[str], /) -> list[str]:
        ...
        Examples:
            Running CivilCvCAD 1.1, /usr/share/CivilCvCAD/Config/ -> /usr/share/CivilCvCAD/Config/v1-1/
            Running CivilCvCAD 1.1, /usr/share/CivilCvCAD/Config/v1-1 -> raises exception, path exists
            Running CivilCvCAD 1.2, /usr/share/CivilCvCAD/Config/v1-1/ -> /usr/share/CivilCvCAD/Config/v1-2/
        """
        ...
    ...
    def isVersionedPath(startingPath: str, /) -> bool:
        ...
        Returns:
            True for any path that the *current* version of CivilCvCAD would recognize as versioned,
            and False for either something that is not versioned, or something that is versioned
            but for a later version of CivilCvCAD.
        """
        ...
