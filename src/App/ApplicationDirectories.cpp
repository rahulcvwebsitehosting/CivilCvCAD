 ...
 *                                                                                                 *
 *   CivilCvCAD is free software: you can redistribute it and/or modify it under the terms of the     *
 *   GNU Lesser General Public License as published by the Free Software Foundation, either        *
 *   version 2.1 of the License, or (at your option) any later version.                            *
 *                                                                                                 *
 *   CivilCvCAD is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without  *
 *   even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the     *
 *   GNU Lesser General Public License for more details.                                           *
 *                                                                                                 *
 *   You should have received a copy of the GNU Lesser General Public License along with CivilCvCAD.  *
...
fs::path ApplicationDirectories::mostRecentConfigFromBase(const fs::path &startingPath) const {
    // Starting in CivilCvCAD v1.1, we switched to using a versioned config path for the three configuration
    // directories:
    // UserAppData
    // UserConfigPath
    // UserMacroPath
...
fs::path ApplicationDirectories::findHomePath(const char* sCall)
{
    ...
    // fixes #0001638 to avoid loading DLLs from Windows' system directories before CivilCvCAD's bin folder
