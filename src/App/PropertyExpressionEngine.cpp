...
{
    DocumentObject* docObj = civilcvcad_cast<DocumentObject*>(getContainer());
                                                                 ...
                                                                 bool* touched)
{
    ...
    for (; it != evaluationOrder.end(); ++it) {
        ...
        DocumentObject* parent = civilcvcad_cast<DocumentObject*>(prop->getContainer());
...
{
    DocumentObject* owner = civilcvcad_cast<DocumentObject*>(getContainer());
