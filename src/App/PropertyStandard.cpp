...
void PropertyString::setValue(const char* newValue)
{
    ...
    auto obj = civilcvcad_cast<DocumentObject*>(getContainer());
    bool commit = false;
...
void PropertyMap::setValue()
{
    ...
    auto docObj = civilcvcad_cast<DocumentObject*>(getContainer());
    if (docObj) {
...
namespace
{
/// The definition of "alpha" was corrected in CivilCvCAD 1.1 -- returns true if the reader is working
