...
void deliverConsoleMessage(
    Base::ConsoleSingleton::CivilCvCAD_ConsoleMsgType type,
...
bool tryMapTypeToLogStyle(Base::ConsoleSingleton::CivilCvCAD_ConsoleMsgType type, Base::LogStyle& out)
{
    using MsgType = Base::ConsoleSingleton::CivilCvCAD_ConsoleMsgType;
...
void deliverConsoleMessage(
    const Base::ConsoleSingleton::CivilCvCAD_ConsoleMsgType type,
