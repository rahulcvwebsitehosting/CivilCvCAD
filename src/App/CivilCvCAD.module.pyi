...
"""Typed public signatures for the ``CivilCvCAD`` application module.
...
def Version() -> list[str]:
    """Return the CivilCvCAD version components as strings."""
    ...
...
def getResourceDir() -> str:
    """Return the root resource directory shipped with CivilCvCAD."""
    ...

def getLibraryDir() -> str:
    """Return the directory that contains CivilCvCAD shared libraries."""
    ...

def getTempPath() -> str:
    """Return the temporary directory used by CivilCvCAD."""
    ...

def getUserCachePath() -> str:
    """Return the user cache directory used by CivilCvCAD."""
    ...
...
def getHomePath() -> str:
    """Return the current CivilCvCAD home directory."""
    ...
...
def loadFile(path: str, doc: str = "", module: str = "", /) -> None:
    ...
    When ``module`` is empty, CivilCvCAD chooses an importer from the file extension.
...
def isRestoring() -> bool:
    """Return whether CivilCvCAD is currently restoring document state."""
    ...

def checkAbort() -> None:
    """Raise ``Base.CivilCvCADAbort`` when the current operation was aborted.
