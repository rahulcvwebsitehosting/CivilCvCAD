...
class Metadata(PyObjectBase):
    ...
    * condition
    ...
    CivilCvCADMin: str = ""
    """
    String representing the minimum version of CivilCvCAD needed for this item.
    If unset it will be 0.0.0.
    """

    CivilCvCADMax: str = ""
    """
    String representing the maximum version of CivilCvCAD needed for this item.
    If unset it will be 0.0.0.
    """
    ...
    def getLastSupportedCivilCvCADVersion(self) -> Optional[str]:
        """
        Search through all content package items, and determine if a maximum supported
        version of CivilCvCAD is set.
    ...
    def getFirstSupportedCivilCvCADVersion(self) -> Optional[str]:
        """
    ...
    def supportsCurrentCivilCvCAD(self) -> bool:
        """
        Returns False if this metadata object directly indicates that it does not
        support the current version of CivilCvCAD, or True if it makes no indication, or
