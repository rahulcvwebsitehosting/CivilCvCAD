...
#    (delete the folder ~\Documents and Settings\username\Application Data\CivilCvCAD for all users), uses:
#    un.GetParentA
#    un.GetUsers
#    un.StrPoint
#    StrPointer
...
Function ValidateInstallDir
  # if the $INSTDIR does not contain "CivilCvCAD" we must add a subfolder to avoid that CivilCvCAD will e.g.
