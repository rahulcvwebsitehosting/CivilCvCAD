...
Configuration and variables of CivilCvCAD installer
*/
...
# For the proposed install folder we use the scheme "CivilCvCAD x.x"
# however for the Registry, we need the scheme "CivilCvCAD x.x.x" in order
...
!define APP_COPYRIGHT "Copyright 2001-${COPYRIGHT_YEAR}, original and subsequent contributors; see LICENSE and NOTICE"

!define APP_RUN "bin\${APP_NAME}.exe"
!define BIN_CIVILCVCAD "${APP_NAME}.exe"
!define BIN_CIVILCVCADCMD "${APP_NAME}cmd.exe"

!define APP_REGKEY "SOFTWARE\${APP_NAME}${APP_SERIES_KEY}" # like "CivilCvCAD0180"
...
!define SETUP_ICON "icons\CivilCvCAD.ico"
