...
Settings for CivilCvCAD installer

These typically need to be modified for each CivilCvCAD release
...
!define APP_VERSION_EMERGENCY "" # use "1" for an emergency release of CivilCvCAD otherwise ""
	# alternatively you can use APP_VERSION_EMERGENCY for a custom suffix of the version number
!define APP_EMERGENCY_DOT "" # use "." for an emergency release of CivilCvCAD otherwise ""
...
#--------------------------------
# Installer file name
# Typical names for the release are "CivilCvCAD-020-Installer-1.exe" etc.
...
#--------------------------------
# installer bit type - CivilCvCAD is only provided as 64bit build
