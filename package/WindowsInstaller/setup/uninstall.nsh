...
Section "un.CivilCvCAD" un.SecUnProgramFiles
  ...
  DeleteRegKey HKCR "Applications\${BIN_CIVILCVCAD}"
...
#---------------------------------
# user preferences
Section /o "un.$(UnCivilCvCADPreferencesTitle)" un.SecUnPreferences
 ...
 MessageBox MB_YESNO|MB_DEFBUTTON2|MB_ICONEXCLAMATION $(DialogUnPreferences) /SD IDYES IDYES +2 # continue if yes
  Goto NotPreferences
 # remove CivilCvCAD's config files
