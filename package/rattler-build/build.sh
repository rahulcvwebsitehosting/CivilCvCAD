...
if [[ ${HOST} =~ .*darwin.* ]]; then
    ...
    CMAKE_PLATFORM_FLAGS+=(-DCIVILCVCAD_USE_3DCONNEXION:BOOL=ON)
...
mv ${PREFIX}/bin/CivilCvCAD ${PREFIX}/bin/civilcvcad || true
mv ${PREFIX}/bin/CivilCvCADCmd ${PREFIX}/bin/civilcvcadcmd || true
