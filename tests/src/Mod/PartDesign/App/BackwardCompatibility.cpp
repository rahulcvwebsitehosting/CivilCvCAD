...
{
    // Regression test for https://github.com/CivilCvCAD/CivilCvCAD/issues/28690 -- a v1.0.2 file with a
...
{
    // Regression test for https://github.com/CivilCvCAD/CivilCvCAD/issues/29233 -- a v1.0 file where
