...
TEST_F(RenameProperty, renamePropertyChain)
{
    ...
    // Act 2
    auto prop1 = civilcvcad_cast<App::PropertyInteger*>(varSet->getDynamicPropertyByName("Name1"));
...
{
    // Arrange
    const auto* prop2 = civilcvcad_cast<App::PropertyInteger*>(
...
{
    // Arrange
    auto* varSet2 = civilcvcad_cast<App::VarSet*>(_doc->addObject("App::VarSet", "VarSet2"));
    const auto* prop2 = civilcvcad_cast<App::PropertyInteger*>(
...
TEST_F(RenameProperty, updateExpressionDifferentDocument)
{
    ...
    auto* varSet2 = civilcvcad_cast<App::VarSet*>(doc->addObject("App::VarSet", "VarSet2"));
    const auto* prop2 = civilcvcad_cast<App::PropertyInteger*>(
        varSet2->addDynamicProperty("App::PropertyInteger", "Variable2", "Variables")
    );
...
{
    // Arrange
    auto* prop2 = civilcvcad_cast<App::PropertyInteger*>(
        varSet->addDynamicProperty("App::PropertyInteger", "Variable2", "Variables")
    );
