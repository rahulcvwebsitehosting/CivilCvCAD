...
TEST_F(ReaderTest, readNextStartEndElement)
{
    ...
    enum class TimesIGoToBed
    {
        ...
        Later,
        VeryLate,
        CivilCvCADDevLate  // https://user-images.githubusercontent.com/12400097/235325792-606bffd6-6607-4542-a7d9-a04f12120666.png
    };
...
<node11 attr='11'/>
    ...
    EXPECT_EQ(xml.Reader()->getAttribute<TimesIGoToBed>("attr"), TimesIGoToBed::CivilCvCADDevLate);
...
TEST_F(ReaderTest, charStreamBase64Encoded)
{
    ...
    EXPECT_EQ(std::string("CivilCvCAD rocks! 🪨🪨🪨"), std::string(buffer.data()));
}
