...
set(ENV{CMAKE_PREFIX_PATH} ${CIVILCVCAD_LIBPACK_DIR})

set(Boost_INCLUDE_DIR ${CIVILCVCAD_LIBPACK_DIR}/include CACHE PATH "" FORCE)

set(OCE_DIR ${CIVILCVCAD_LIBPACK_DIR}/lib/cmake CACHE PATH "" FORCE)

set(SWIG_EXECUTABLE ${CIVILCVCAD_LIBPACK_DIR}/bin/swig/swig.exe CACHE FILEPATH "Swig" FORCE)


# Set paths to cmake config files for each Qt module
set(Qt5_ROOT_DIR ${CIVILCVCAD_LIBPACK_DIR} CACHE PATH "")
...
find_library(XercesC_LIBRARY_RELEASE xerces-c_3 "${CIVILCVCAD_LIBPACK_DIR}/lib")
find_library(XercesC_LIBRARY_DEBUG xerces-c_3D "${CIVILCVCAD_LIBPACK_DIR}/lib")
set (XercesC_LIBRARIES debug ${XercesC_LIBRARY_DEBUG} optimized ${XercesC_LIBRARY_RELEASE})
set(XercesC_FOUND TRUE)

find_library(COIN3D_LIBRARY_RELEASE coin4 "${CIVILCVCAD_LIBPACK_DIR}/lib")
find_library(COIN3D_LIBRARY_DEBUG coin4d "${CIVILCVCAD_LIBPACK_DIR}/lib")
...
if(CIVILCVCAD_USE_FREETYPE)
    set(FREETYPE_INCLUDE_DIR_freetype2 ${CIVILCVCAD_LIBPACK_DIR}/include/freetype2)
