macro(ConfigureCMakeVariables)
    ...
    if(MSVC)
        ...
        # Don't set it without manual adoption of LibDir variable in src/App/CivilCvCADInit.py
        set(CMAKE_INSTALL_LIBDIR lib CACHE PATH "Output directory for libraries")
    else()
        set(CMAKE_INSTALL_PREFIX "/usr/lib${LIB_SUFFIX}/civilcvcad" CACHE PATH "Installation root directory")
        include(GNUInstallDirs)
    endif()

    if (NOT CIVILCVCAD_USE_EXTERNAL_PYCXX)
