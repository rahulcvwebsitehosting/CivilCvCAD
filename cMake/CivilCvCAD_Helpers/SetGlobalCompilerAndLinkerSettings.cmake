macro(SetGlobalCompilerAndLinkerSettings)
    ...
    if(MSVC)
        ...
        if(CIVILCVCAD_RELEASE_PDB)
            set (CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} /Zi")
            set (CMAKE_SHARED_LINKER_FLAGS_RELEASE "${CMAKE_SHARED_LINKER_FLAGS_RELEASE} /DEBUG")
            set (CMAKE_EXE_LINKER_FLAGS_RELEASE "${CMAKE_EXE_LINKER_FLAGS_RELEASE} /DEBUG")
        endif(CIVILCVCAD_RELEASE_PDB)
        if(CIVILCVCAD_RELEASE_SEH)
        ...
        option(CIVILCVCAD_USE_MP_COMPILE_FLAG "Add /MP flag to the compiler definitions. Speeds up the compile on multi processor machines" ON)
        if(CIVILCVCAD_USE_MP_COMPILE_FLAG)
