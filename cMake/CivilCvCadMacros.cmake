...
MACRO(SET_BIN_DIR ProjectName OutputName)
    ...
    if(WIN32)
        ...
        # CivilCvCADBase, SMDS, Driver and MEFISTO2 libs don't depend on parts from CMAKE_INSTALL_LIBDIR
        if(NOT ${ProjectName} MATCHES "^(CivilCvCADBase|SMDS|Driver|MEFISTO2)$")
            if(${ARGC} STREQUAL 4)
