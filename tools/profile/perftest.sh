...
notnp=<Path to your first executable to profile goes here>  #<dir>/bin/CivilCvCAD${cmd}
tnp=<Path to your second executable to profile goes here>   #<dir/bin/CivilCvCAD${cmd}
